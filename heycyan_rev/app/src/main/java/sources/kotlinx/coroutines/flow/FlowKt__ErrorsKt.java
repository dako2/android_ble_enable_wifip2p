...
final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    /* compiled from: Errors.kt */
    @Metadata(m606d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u0003\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u00020\u0004H\u008a@"}, m607d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "it", ""}, m608k = 3, m609mv = {1, 8, 0}, m611xi = 48)
    @DebugMetadata(m619c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt$retry$1", m620f = "Errors.kt", m621i = {}, m622l = {}, m623m = "invokeSuspend", m624n = {}, m625s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ErrorsKt$retry$1 */
    static final class C28121 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
        int label;

        C28121(Continuation<? super C28121> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C28121(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Throwable th, Continuation<? super Boolean> continuation) {
            return ((C28121) create(th, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* compiled from: Errors.kt */
    @Metadata(m606d1 = {"\u0000\u0018\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0003\n\u0000\n\u0002\u0010\t\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007H\u008a@"}, m607d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "Lkotlinx/coroutines/flow/FlowCollector;", "cause", "", "attempt", ""}, m608k = 3, m609mv = {1, 8, 0}, m611xi = 48)
    @DebugMetadata(m619c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt$retry$3", m620f = "Errors.kt", m621i = {}, m622l = {EMachine.EM_VIDEOCORE}, m623m = "invokeSuspend", m624n = {}, m625s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ErrorsKt$retry$3 */
    static final class C28133<T> extends SuspendLambda implements Function4<FlowCollector<? super T>, Throwable, Long, Continuation<? super Boolean>, Object> {
        ...
        C28133(long j, Function2<? super Throwable, ? super Continuation<? super Boolean>, ? extends Object> function2, Continuation<? super C28133> continuation) {
        ...
        public final Object invoke(FlowCollector<? super T> flowCollector, Throwable th, long j, Continuation<? super Boolean> continuation) {
            C28133 c28133 = new C28133(this.$retries, this.$predicate, continuation);
            c28133.L$0 = th;
            c28133.J$0 = j;
            return c28133.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Flow<T> retry(Flow<? extends T> flow, long j, Function2<? super Throwable, ? super Continuation<? super Boolean>, ? extends Object> function2) {
        ...
        return FlowKt.retryWhen(flow, new C28133(j, function2, null));
    }
    ...
    */
    public static final <T> Object catchImpl(Flow<? extends T> flow, FlowCollector<? super T> flowCollector, Continuation<? super Throwable> continuation) throws Throwable {
        ...
        if (continuation instanceof C28101) {
            c28101 = (C28101) continuation;
            if ((c28101.label & Integer.MIN_VALUE) != 0) {
                c28101.label -= Integer.MIN_VALUE;
            } else {
                c28101 = new C28101(continuation);
            }
        }
        Object obj = c28101.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c28101.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            try {
                FlowCollector<? super Object> c28112 = new C28112<>(flowCollector, objectRef2);
                c28101.L$0 = objectRef2;
                c28101.label = 1;
                if (flow.collect(c28112, c28101) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                return null;
            } catch (Throwable th) {
            ...
            objectRef = (Ref.ObjectRef) c28101.L$0;
            try {
                ResultKt.throwOnFailure(obj);
                return null;
            } catch (Throwable th2) {
        ...
        if (isSameExceptionAs$FlowKt__ErrorsKt(th, th3) || isCancellationCause$FlowKt__ErrorsKt(th, c28101.get$context())) {
            throw th;
        }
        if (th3 == null) {
            return th;
    ...
    /* compiled from: Errors.kt */
    @Metadata(m606d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0004\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@¢\u0006\u0004\b\u0004\u0010\u0005"}, m607d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "it", "emit", "(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, m608k = 3, m609mv = {1, 8, 0}, m611xi = 48)
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ErrorsKt$catchImpl$2 */
    static final class C28112<T> implements FlowCollector {
        final /* synthetic */ FlowCollector<T> $collector;
        final /* synthetic */ Ref.ObjectRef<Throwable> $fromDownstream;

        /* JADX WARN: Multi-variable type inference failed */
        C28112(FlowCollector<? super T> flowCollector, Ref.ObjectRef<Throwable> objectRef) {
        ...
        */
        public final Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
            ...
            if (i != 0) {
                ...
                c28112 = (C28112) flowKt__ErrorsKt$catchImpl$2$emit$1.L$0;
                try {
                    ResultKt.throwOnFailure(obj);
                ...
                L19:
                    ...
                    kotlinx.coroutines.flow.FlowKt__ErrorsKt$catchImpl$2 r5 = (kotlinx.coroutines.flow.FlowKt__ErrorsKt.C28112) r5
                ...
                L4d:
                    ...
                    throw r6
                */
                throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__ErrorsKt.C28112.emit(java.lang.Object, kotlin.coroutines.Continuation):java.lang.Object");
            }
        }
        ...
        public static final <T> Flow<T> m2445catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
