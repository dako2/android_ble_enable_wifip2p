...
public final class InterruptibleKt {
    ...
    @DebugMetadata(m619c = "kotlinx.coroutines.InterruptibleKt$runInterruptible$2", m620f = "Interruptible.kt", m621i = {}, m622l = {}, m623m = "invokeSuspend", m624n = {}, m625s = {})
    /* renamed from: kotlinx.coroutines.InterruptibleKt$runInterruptible$2 */
    static final class C27032<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
        ...
        C27032(Function0<? extends T> function0, Continuation<? super C27032> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C27032 c27032 = new C27032(this.$block, continuation);
            c27032.L$0 = obj;
            return c27032;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super T> continuation) {
            return ((C27032) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Object runInterruptible(CoroutineContext coroutineContext, Function0<? extends T> function0, Continuation<? super T> continuation) {
        return BuildersKt.withContext(coroutineContext, new C27032(function0, null), continuation);
    }
