...
public abstract class ConcurrentLinkedListNode<N extends ConcurrentLinkedListNode<N>> {
    ...
    public final boolean trySetNext(N value) {
        return C0134xc40028dd.m5m(_next$FU, this, null, value);
    }
    ...
    public final boolean markAsClosed() {
        return C0134xc40028dd.m5m(_next$FU, this, null, ConcurrentLinkedListKt.CLOSED);
    }
    ...
    public final void remove() {
        ...
        while (true) {
            ...
            } while (!C0134xc40028dd.m5m(atomicReferenceFieldUpdater, aliveSegmentRight, obj, ((ConcurrentLinkedListNode) obj) == null ? null : aliveSegmentLeft));
