...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM903constructorimpl = Result.m903constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM903constructorimpl = Result.m903constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m909isFailureimpl(objM903constructorimpl) ? null : objM903constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo2461dispatch(cancellableContinuationImpl2.getContext(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
