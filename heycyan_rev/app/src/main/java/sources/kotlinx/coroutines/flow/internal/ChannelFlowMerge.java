...
public final class ChannelFlowMerge<T> extends ChannelFlow<T> {
    ...
    protected Object collectTo(ProducerScope<? super T> producerScope, Continuation<? super Unit> continuation) {
        Object objCollect = this.flow.collect(new C28852((Job) continuation.getContext().get(Job.INSTANCE), SemaphoreKt.Semaphore$default(this.concurrency, 0, 2, null), producerScope, new SendingCollector(producerScope)), continuation);
        return objCollect == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCollect : Unit.INSTANCE;
    }

    /* compiled from: Merge.kt */
    @Metadata(m606d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0004H\u008a@¢\u0006\u0004\b\u0005\u0010\u0006"}, m607d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "inner", "Lkotlinx/coroutines/flow/Flow;", "emit", "(Lkotlinx/coroutines/flow/Flow;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, m608k = 3, m609mv = {1, 8, 0}, m611xi = 48)
    /* renamed from: kotlinx.coroutines.flow.internal.ChannelFlowMerge$collectTo$2 */
    static final class C28852<T> implements FlowCollector {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C28852(Job job, Semaphore semaphore, ProducerScope<? super T> producerScope, SendingCollector<T> sendingCollector) {
            this.$job = job;
        ...
        */
        public final Object emit(Flow<? extends T> flow, Continuation<? super Unit> continuation) {
            ...
            if (i == 0) {
                ...
                c28852 = (C28852) channelFlowMerge$collectTo$2$emit$1.L$0;
                ResultKt.throwOnFailure(obj);
            }
            BuildersKt__Builders_commonKt.launch$default(c28852.$scope, null, null, new AnonymousClass1(flow, c28852.$collector, c28852.$semaphore, null), 3, null);
        ...
        @DebugMetadata(m619c = "kotlinx.coroutines.flow.internal.ChannelFlowMerge$collectTo$2$1", m620f = "Merge.kt", m621i = {}, m622l = {69}, m623m = "invokeSuspend", m624n = {}, m625s = {})
