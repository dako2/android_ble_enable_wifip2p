...
final class CallbackFlowBuilder<T> extends ChannelFlowBuilder<T> {
    ...
    @DebugMetadata(m619c = "kotlinx.coroutines.flow.CallbackFlowBuilder", m620f = "Builders.kt", m621i = {0}, m622l = {334}, m623m = "collectTo", m624n = {"scope"}, m625s = {"L$0"})
    /* renamed from: kotlinx.coroutines.flow.CallbackFlowBuilder$collectTo$1 */
    static final class C27751 extends ContinuationImpl {
        Object L$0;
        int label;
        ...
        C27751(CallbackFlowBuilder<T> callbackFlowBuilder, Continuation<? super C27751> continuation) {
            super(continuation);
    ...
    */
    protected Object collectTo(ProducerScope<? super T> producerScope, Continuation<? super Unit> continuation) {
        C27751 c27751;
        if (continuation instanceof C27751) {
            c27751 = (C27751) continuation;
            if ((c27751.label & Integer.MIN_VALUE) != 0) {
                c27751.label -= Integer.MIN_VALUE;
            } else {
                c27751 = new C27751(this, continuation);
            }
        }
        Object obj = c27751.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c27751.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            c27751.L$0 = producerScope;
            c27751.label = 1;
            if (super.collectTo(producerScope, c27751) == coroutine_suspended) {
            ...
            producerScope = (ProducerScope) c27751.L$0;
            ResultKt.throwOnFailure(obj);
        }
