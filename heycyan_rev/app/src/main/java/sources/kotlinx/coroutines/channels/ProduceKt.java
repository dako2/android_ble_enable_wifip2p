...
public final class ProduceKt {
    ...
    */
    public static final Object awaitClose(ProducerScope<?> producerScope, Function0<Unit> function0, Continuation<? super Unit> continuation) {
        C27611 c27611;
        if (continuation instanceof C27611) {
            c27611 = (C27611) continuation;
            if ((c27611.label & Integer.MIN_VALUE) != 0) {
                c27611.label -= Integer.MIN_VALUE;
            } else {
                c27611 = new C27611(continuation);
            }
        }
        Object obj = c27611.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c27611.label;
        try {
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                if (c27611.getContext().get(Job.INSTANCE) != producerScope) {
                    throw new IllegalStateException("awaitClose() can only be invoked from the producer context".toString());
                }
                c27611.L$0 = producerScope;
                c27611.L$1 = function0;
                c27611.label = 1;
                CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(IntrinsicsKt.intercepted(c27611), 1);
                ...
                if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    DebugProbesKt.probeCoroutineSuspended(c27611);
                }
                ...
                function0 = (Function0) c27611.L$1;
                ResultKt.throwOnFailure(obj);
            }
            function0.invoke();
            return Unit.INSTANCE;
