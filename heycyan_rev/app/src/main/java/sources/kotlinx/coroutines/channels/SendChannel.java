...
public interface SendChannel<E> {
    ...
    Object mo2405trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m2425isSuccessimpl(objMo2405trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2419exceptionOrNullimpl = ChannelResult.m2419exceptionOrNullimpl(objMo2405trySendJP2dKIU);
