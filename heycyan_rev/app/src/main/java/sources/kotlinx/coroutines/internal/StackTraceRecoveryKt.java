...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM903constructorimpl = Result.m903constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM903constructorimpl = Result.m903constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m906exceptionOrNullimpl(objM903constructorimpl) == null) {
            obj2 = objM903constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM903constructorimpl2 = Result.m903constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM903constructorimpl2 = Result.m903constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m906exceptionOrNullimpl(objM903constructorimpl2) == null) {
            obj = objM903constructorimpl2;
        }
        ...
        if (cause != null && Intrinsics.areEqual(cause.getClass(), e.getClass())) {
            ...
            for (StackTraceElement stackTraceElement : stackTrace) {
                if (isArtificial(stackTraceElement)) {
                    return TuplesKt.m614to(cause, stackTrace);
                }
            }
            return TuplesKt.m614to(e, new StackTraceElement[0]);
        }
        return TuplesKt.m614to(e, new StackTraceElement[0]);
    }
