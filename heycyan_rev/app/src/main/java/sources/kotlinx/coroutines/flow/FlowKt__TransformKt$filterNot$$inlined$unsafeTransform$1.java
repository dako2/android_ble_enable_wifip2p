...
public final class FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1<T> implements Flow<T> {
    ...
    public static final class C28542<T> implements FlowCollector {
        final /* synthetic */ Function2 $predicate$inlined;
        final /* synthetic */ FlowCollector $this_unsafeFlow;

        /* compiled from: Emitters.kt */
        @Metadata(m608k = 3, m609mv = {1, 8, 0}, m611xi = EMachine.EM_ECOG16)
        @DebugMetadata(m619c = "kotlinx.coroutines.flow.FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1$2", m620f = "Transform.kt", m621i = {0, 0}, m622l = {223, 223}, m623m = "emit", m624n = {"value", "$this$filterNot_u24lambda_u241"}, m625s = {"L$0", "L$1"})
        ...
        public static final class AnonymousClass1 extends ContinuationImpl {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                return C28542.this.emit(null, this);
            }
        }

        public C28542(FlowCollector flowCollector, Function2 function2) {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object objCollect = this.$this_unsafeTransform$inlined.collect(new C28542(flowCollector, this.$predicate$inlined), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        C28542 c28542 = new C28542(flowCollector, this.$predicate$inlined);
        InlineMarker.mark(0);
        flow.collect(c28542, continuation);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
