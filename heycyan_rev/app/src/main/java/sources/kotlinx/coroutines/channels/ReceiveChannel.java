...
public interface ReceiveChannel<E> {
    ...
    Object mo2409receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo2410tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo2410tryReceivePtdJZtk = receiveChannel.mo2410tryReceivePtdJZtk();
            if (ChannelResult.m2425isSuccessimpl(objMo2410tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2421getOrThrowimpl(objMo2410tryReceivePtdJZtk);
            }
            Throwable thM2419exceptionOrNullimpl = ChannelResult.m2419exceptionOrNullimpl(objMo2410tryReceivePtdJZtk);
            if (thM2419exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM2419exceptionOrNullimpl);
        }
        ...
        */
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) {
            ...
            if (continuation instanceof C27631) {
                c27631 = (C27631) continuation;
                if ((c27631.label & Integer.MIN_VALUE) != 0) {
                    c27631.label -= Integer.MIN_VALUE;
                } else {
                    c27631 = new C27631(continuation);
                }
            }
            Object obj = c27631.result;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = c27631.label;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                c27631.label = 1;
                objMo2409receiveCatchingJP2dKIU = receiveChannel.mo2409receiveCatchingJP2dKIU(c27631);
            ...
            return ChannelResult.m2420getOrNullimpl(objMo2409receiveCatchingJP2dKIU);
        }
