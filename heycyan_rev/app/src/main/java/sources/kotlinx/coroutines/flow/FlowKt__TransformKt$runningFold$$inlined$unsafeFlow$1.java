...
public final class FlowKt__TransformKt$runningFold$$inlined$unsafeFlow$1<R> implements Flow<R> {
    ...
    @DebugMetadata(m619c = "kotlinx.coroutines.flow.FlowKt__TransformKt$runningFold$$inlined$unsafeFlow$1", m620f = "Transform.kt", m621i = {0, 0, 0}, m622l = {EMachine.EM_XGATE, EMachine.EM_C166}, m623m = "collect", m624n = {"this", "$this$runningFold_u24lambda_u249", "accumulator"}, m625s = {"L$0", "L$1", "L$2"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__TransformKt$runningFold$$inlined$unsafeFlow$1$1 */
    public static final class C28611 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        int label;
        ...
        public C28611(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public Object collect(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof C28611) {
            ...
            if ((c28611.label & Integer.MIN_VALUE) != 0) {
                c28611.label -= Integer.MIN_VALUE;
            } else {
                c28611 = new C28611(continuation);
            }
        }
        Object obj = c28611.result;
        ...
        if (i == 0) {
            ...
            c28611.L$0 = this;
            c28611.L$1 = flowCollector;
            c28611.L$2 = objectRef2;
            c28611.label = 1;
            if (flowCollector.emit(t, c28611) == coroutine_suspended) {
            ...
            objectRef = (Ref.ObjectRef) c28611.L$2;
            flowCollector2 = (FlowCollector) c28611.L$1;
            flowKt__TransformKt$runningFold$$inlined$unsafeFlow$1 = (FlowKt__TransformKt$runningFold$$inlined$unsafeFlow$1) c28611.L$0;
            ResultKt.throwOnFailure(obj);
        }
        ...
        c28611.L$2 = null;
        c28611.label = 2;
        if (flow.collect(flowKt__TransformKt$runningFold$1$1, c28611) == coroutine_suspended) {
            return coroutine_suspended;
        }
        return Unit.INSTANCE;
    }
