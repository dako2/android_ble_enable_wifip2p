...
public class ExperimentalCoroutineDispatcher extends ExecutorCoroutineDispatcher {
    ...
    public void mo2461dispatch(CoroutineContext context, Runnable block) {
        try {
            ...
            DefaultExecutor.INSTANCE.mo2461dispatch(context, block);
        }
    }
