...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$5<T> implements Flow<T> {
    ...
    @DebugMetadata(m619c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$5", m620f = "Builders.kt", m621i = {0}, m622l = {EMachine.EM_C166}, m623m = "collect", m624n = {"$this$asFlow_u24lambda_u247"}, m625s = {"L$0"})
    ...
    */
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        ...
        Iterator<T> it;
        if (continuation instanceof C27821) {
            c27821 = (C27821) continuation;
            if ((c27821.label & Integer.MIN_VALUE) != 0) {
                c27821.label -= Integer.MIN_VALUE;
            } else {
                c27821 = new C27821(continuation);
            }
        }
        Object obj = c27821.result;
        ...
        if (i == 0) {
            ...
            it = (Iterator) c27821.L$1;
            FlowCollector flowCollector3 = (FlowCollector) c27821.L$0;
            ResultKt.throwOnFailure(obj);
            flowCollector2 = flowCollector3;
        }
        while (it.hasNext()) {
            T next = it.next();
            c27821.L$0 = flowCollector2;
            c27821.L$1 = it;
            c27821.label = 1;
            if (flowCollector2.emit(next, c27821) == coroutine_suspended) {
