...
@DebugMetadata(m619c = "kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1", m620f = "Delay.kt", m621i = {}, m622l = {279}, m623m = "invokeSuspend", m624n = {}, m625s = {})
...
final class FlowKt__DelayKt$sample$2$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    static final class C28021<T> implements FlowCollector {
        final /* synthetic */ ProducerScope<Object> $$this$produce;

        C28021(ProducerScope<Object> producerScope) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (this.$this_sample.collect(new C28021(producerScope), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i != 1) {
