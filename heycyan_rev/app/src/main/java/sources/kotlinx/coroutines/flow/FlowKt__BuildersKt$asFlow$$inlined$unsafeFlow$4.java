...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$4<T> implements Flow<T> {
    ...
    @DebugMetadata(m619c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$4", m620f = "Builders.kt", m621i = {0}, m622l = {EMachine.EM_C166}, m623m = "collect", m624n = {"$this$asFlow_u24lambda_u245"}, m625s = {"L$0"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$4$1 */
    public static final class C27811 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        public C27811(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        ...
        Iterator it;
        if (continuation instanceof C27811) {
            c27811 = (C27811) continuation;
            if ((c27811.label & Integer.MIN_VALUE) != 0) {
                c27811.label -= Integer.MIN_VALUE;
            } else {
                c27811 = new C27811(continuation);
            }
        }
        Object obj = c27811.result;
        ...
        if (i == 0) {
            ...
            it = (Iterator) c27811.L$1;
            FlowCollector flowCollector3 = (FlowCollector) c27811.L$0;
            ResultKt.throwOnFailure(obj);
            flowCollector2 = flowCollector3;
        }
        while (it.hasNext()) {
            Object next = it.next();
            c27811.L$0 = flowCollector2;
            c27811.L$1 = it;
            c27811.label = 1;
            if (flowCollector2.emit(next, c27811) == coroutine_suspended) {
