...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame, Waiter {
    ...
    public void cancelCompletedResult$kotlinx_coroutines_core(Object takenState, Throwable cause) {
        ...
        while (true) {
            ...
            if (obj instanceof CompletedContinuation) {
                ...
                if (C0134xc40028dd.m5m(_state$FU, this, obj, CompletedContinuation.copy$default(completedContinuation, null, null, null, null, cause, 15, null))) {
                    completedContinuation.invokeHandlers(this, cause);
                    return;
                }
            } else if (C0134xc40028dd.m5m(_state$FU, this, obj, new CompletedContinuation(obj, null, null, null, cause, 14, null))) {
                return;
            }
        }
    }
    ...
    public boolean cancel(Throwable cause) {
        ...
        } while (!C0134xc40028dd.m5m(_state$FU, this, obj, new CancelledContinuation(this, cause, (obj instanceof CancelHandler) || (obj instanceof Segment))));
    ...
    private final DisposableHandle installParentHandle() {
        ...
        C0134xc40028dd.m5m(_parentHandle$FU, this, null, disposableHandleInvokeOnCompletion$default);
    ...
    private final void invokeOnCancellationImpl(Object handler) {
        ...
        while (true) {
            ...
            if (obj instanceof Active) {
                if (C0134xc40028dd.m5m(_state$FU, this, obj, handler)) {
                    return;
                }
            } else {
                if (obj instanceof CancelHandler ? true : obj instanceof Segment) {
                    ...
                    if (obj instanceof CompletedContinuation) {
                        ...
                        if (completedContinuation.getCancelled()) {
                            ...
                            if (C0134xc40028dd.m5m(_state$FU, this, obj, CompletedContinuation.copy$default(completedContinuation, null, cancelHandler, null, null, null, 29, null))) {
                                return;
                            }
                        }
                    } else {
                        ...
                        Intrinsics.checkNotNull(handler, "null cannot be cast to non-null type kotlinx.coroutines.CancelHandler");
                        if (C0134xc40028dd.m5m(_state$FU, this, obj, new CompletedContinuation(obj, (CancelHandler) handler, null, null, null, 28, null))) {
                            return;
                        }
                    }
                }
    ...
    private final void resumeImpl(Object proposedUpdate, int resumeMode, Function1<? super Throwable, Unit> onCancellation) {
        ...
        } while (!C0134xc40028dd.m5m(_state$FU, this, obj, resumedState((NotCompleted) obj, proposedUpdate, resumeMode, onCancellation, null)));
        detachChildIfNonResuable();
    ...
    private final Symbol tryResumeImpl(Object proposedUpdate, Object idempotent, Function1<? super Throwable, Unit> onCancellation) {
        ...
        } while (!C0134xc40028dd.m5m(_state$FU, this, obj, resumedState((NotCompleted) obj, proposedUpdate, this.resumeMode, onCancellation, idempotent)));
        detachChildIfNonResuable();
        return CancellableContinuationImplKt.RESUME_TOKEN;
    }
