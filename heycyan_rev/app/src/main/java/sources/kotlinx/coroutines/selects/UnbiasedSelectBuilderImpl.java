...
public final class UnbiasedSelectBuilderImpl<R> extends UnbiasedSelectImplementation<R> {
    ...
    @DebugMetadata(m619c = "kotlinx.coroutines.selects.UnbiasedSelectBuilderImpl$initSelectResult$1", m620f = "SelectOld.kt", m621i = {}, m622l = {71}, m623m = "invokeSuspend", m624n = {}, m625s = {})
    /* renamed from: kotlinx.coroutines.selects.UnbiasedSelectBuilderImpl$initSelectResult$1 */
    static final class C29031 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        int label;
        final /* synthetic */ UnbiasedSelectBuilderImpl<R> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C29031(UnbiasedSelectBuilderImpl<R> unbiasedSelectBuilderImpl, Continuation<? super C29031> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C29031(this.this$0, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C29031) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object initSelectResult() {
        ...
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(getContext()), null, CoroutineStart.UNDISPATCHED, new C29031(this, null), 1, null);
        return this.cont.getResult();
    }
