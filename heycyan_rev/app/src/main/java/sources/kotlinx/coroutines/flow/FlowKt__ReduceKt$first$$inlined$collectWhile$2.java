...
public final class FlowKt__ReduceKt$first$$inlined$collectWhile$2<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(m619c = "kotlinx.coroutines.flow.FlowKt__ReduceKt$first$$inlined$collectWhile$2", m620f = "Reduce.kt", m621i = {0, 0}, m622l = {EMachine.EM_TI_C5500}, m623m = "emit", m624n = {"this", "it"}, m625s = {"L$0", "L$1"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ReduceKt$first$$inlined$collectWhile$2$1 */
    public static final class C28281 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        public C28281(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public Object emit(T t, Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof C28281) {
            c28281 = (C28281) continuation;
            if ((c28281.label & Integer.MIN_VALUE) != 0) {
                c28281.label -= Integer.MIN_VALUE;
            } else {
                c28281 = new C28281(continuation);
            }
        }
        Object objInvoke = c28281.result;
        ...
        if (i == 0) {
            ...
            c28281.label = 1;
            InlineMarker.mark(6);
            objInvoke = function2.invoke(t, c28281);
            InlineMarker.mark(7);
            ...
            t = (T) c28281.L$1;
            flowKt__ReduceKt$first$$inlined$collectWhile$2 = (FlowKt__ReduceKt$first$$inlined$collectWhile$2) c28281.L$0;
            ResultKt.throwOnFailure(objInvoke);
        }
