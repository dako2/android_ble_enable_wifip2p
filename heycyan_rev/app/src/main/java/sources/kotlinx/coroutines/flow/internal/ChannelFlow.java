...
public abstract class ChannelFlow<T> implements FusibleFlow<T> {
    ...
    */
    ...
    @DebugMetadata(m619c = "kotlinx.coroutines.flow.internal.ChannelFlow$collect$2", m620f = "ChannelFlow.kt", m621i = {}, m622l = {123}, m623m = "invokeSuspend", m624n = {}, m625s = {})
    /* renamed from: kotlinx.coroutines.flow.internal.ChannelFlow$collect$2 */
    static final class C28842 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C28842(FlowCollector<? super T> flowCollector, ChannelFlow<T> channelFlow, Continuation<? super C28842> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C28842 c28842 = new C28842(this.$collector, this.this$0, continuation);
            c28842.L$0 = obj;
            return c28842;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C28842) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    static /* synthetic */ <T> Object collect$suspendImpl(ChannelFlow<T> channelFlow, FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C28842(flowCollector, channelFlow, null), continuation);
