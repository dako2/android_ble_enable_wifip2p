...
public final class FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1<R> implements Flow<R> {
    ...
    public static final class C28592<T> implements FlowCollector {
        final /* synthetic */ FlowCollector $this_unsafeFlow;
        final /* synthetic */ Function2 $transform$inlined;

        /* compiled from: Emitters.kt */
        @Metadata(m608k = 3, m609mv = {1, 8, 0}, m611xi = EMachine.EM_ECOG16)
        @DebugMetadata(m619c = "kotlinx.coroutines.flow.FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1$2", m620f = "Transform.kt", m621i = {0}, m622l = {223, 224}, m623m = "emit", m624n = {"$this$mapNotNull_u24lambda_u246"}, m625s = {"L$0"})
        ...
        public static final class AnonymousClass1 extends ContinuationImpl {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                return C28592.this.emit(null, this);
            }
        }

        public C28592(FlowCollector flowCollector, Function2 function2) {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object objCollect = this.$this_unsafeTransform$inlined.collect(new C28592(flowCollector, this.$transform$inlined$1), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        C28592 c28592 = new C28592(flowCollector, this.$transform$inlined$1);
        InlineMarker.mark(0);
        flow.collect(c28592, continuation);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
