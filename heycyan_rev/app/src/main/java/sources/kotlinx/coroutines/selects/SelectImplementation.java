...
public class SelectImplementation<R> extends CancelHandler implements SelectBuilder<R>, SelectInstanceInternal<R> {
    ...
    @DebugMetadata(m619c = "kotlinx.coroutines.selects.SelectImplementation", m620f = "Select.kt", m621i = {0}, m622l = {431, 434}, m623m = "doSelectSuspend", m624n = {"this"}, m625s = {"L$0"})
    /* renamed from: kotlinx.coroutines.selects.SelectImplementation$doSelectSuspend$1 */
    static final class C29011 extends ContinuationImpl {
        Object L$0;
        int label;
        ...
        C29011(SelectImplementation<R> selectImplementation, Continuation<? super C29011> continuation) {
            super(continuation);
    ...
    /* compiled from: Select.kt */
    @Metadata(m608k = 3, m609mv = {1, 8, 0}, m611xi = 48)
    @DebugMetadata(m619c = "kotlinx.coroutines.selects.SelectImplementation", m620f = "Select.kt", m621i = {}, m622l = {TypedValues.TransitionType.TYPE_STAGGERED}, m623m = "processResultAndInvokeBlockRecoveringException", m624n = {}, m625s = {})
    /* renamed from: kotlinx.coroutines.selects.SelectImplementation$processResultAndInvokeBlockRecoveringException$1 */
    static final class C29021 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;
        final /* synthetic */ SelectImplementation<R> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C29021(SelectImplementation<R> selectImplementation, Continuation<? super C29021> continuation) {
            super(continuation);
            this.this$0 = selectImplementation;
        }
    ...
    */
    public final Object doSelectSuspend(Continuation<? super R> continuation) {
        ...
        if (continuation instanceof C29011) {
            ...
            if ((c29011.label & Integer.MIN_VALUE) != 0) {
                c29011.label -= Integer.MIN_VALUE;
            } else {
                c29011 = new C29011(this, continuation);
            }
        }
        Object objComplete = c29011.result;
        ...
        if (i == 0) {
            ...
            c29011.L$0 = this;
            c29011.label = 1;
            if (waitUntilSelected(c29011) == coroutine_suspended) {
            ...
            selectImplementation = (SelectImplementation) c29011.L$0;
            ResultKt.throwOnFailure(objComplete);
        }
        c29011.L$0 = null;
        c29011.label = 2;
        objComplete = selectImplementation.complete(c29011);
        ...
        while (true) {
            ...
            if (!(obj instanceof CancellableContinuation)) {
                ...
                if (Intrinsics.areEqual(obj, SelectKt.STATE_REG)) {
                    if (C0134xc40028dd.m5m(atomicReferenceFieldUpdater, this, obj, CollectionsKt.listOf(clauseObject))) {
                        return 1;
                    }
                } else {
                    ...
                    if (C0134xc40028dd.m5m(atomicReferenceFieldUpdater, this, obj, CollectionsKt.plus((Collection<? extends Object>) obj, clauseObject))) {
                        return 1;
                    }
                }
            } else {
                ...
                if (clauseDataFindClause == null) {
                    ...
                    if (C0134xc40028dd.m5m(atomicReferenceFieldUpdater, this, obj, clauseDataFindClause)) {
                        this.internalResult = internalResult;
    ...
    */
    public final Object processResultAndInvokeBlockRecoveringException(SelectImplementation<R>.ClauseData clauseData, Object obj, Continuation<? super R> continuation) throws Throwable {
        C29021 c29021;
        if (continuation instanceof C29021) {
            c29021 = (C29021) continuation;
            if ((c29021.label & Integer.MIN_VALUE) != 0) {
                c29021.label -= Integer.MIN_VALUE;
            } else {
                c29021 = new C29021(this, continuation);
            }
        }
        Object objInvokeBlock = c29021.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c29021.label;
        try {
            if (i == 0) {
                ...
                c29021.label = 1;
                objInvokeBlock = clauseData.invokeBlock(objProcessResult, c29021);
            ...
            if (DebugKt.getRECOVER_STACK_TRACES() && (c29021 instanceof CoroutineStackFrame)) {
                throw StackTraceRecoveryKt.recoverFromStackFrame(th, c29021);
            }
            throw th;
        }
    }
    ...
    public void invoke2(Throwable cause) {
        ...
        } while (!C0134xc40028dd.m5m(atomicReferenceFieldUpdater, this, obj, SelectKt.STATE_CANCELLED));
        List<SelectImplementation<R>.ClauseData> list = this.clauses;
        if (list == null) {
            return;
        }
    ...
    public final Object waitUntilSelected(Continuation<? super Unit> continuation) {
        ...
        while (true) {
            ...
            if (obj == SelectKt.STATE_REG) {
                if (C0134xc40028dd.m5m(state$FU, this, obj, cancellableContinuationImpl2)) {
                    cancellableContinuationImpl2.invokeOnCancellation(this);
                    break;
                }
            } else if (obj instanceof List) {
                if (C0134xc40028dd.m5m(state$FU, this, obj, SelectKt.STATE_REG)) {
