...
public class CollectionsKt__CollectionsKt extends CollectionsKt__CollectionsJVMKt {
    ...
    public static /* synthetic */ int binarySearchBy$default(List list, Comparable comparable, int i, int i2, Function1 selector, int i3, Object obj) {
        ...
        return CollectionsKt.binarySearch(list, i, i2, new C25871(selector, comparable));
    }

    /* JADX INFO: Add missing generic type declarations: [T] */
    /* compiled from: Collections.kt */
    @Metadata(m606d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000f\n\u0002\b\u0003\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u000e\b\u0001\u0010\u0003*\b\u0012\u0004\u0012\u0002H\u00030\u00042\u0006\u0010\u0005\u001a\u0002H\u0002H\n¢\u0006\u0004\b\u0006\u0010\u0007"}, m607d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "K", "", "it", "invoke", "(Ljava/lang/Object;)Ljava/lang/Integer;"}, m608k = 3, m609mv = {1, 9, 0}, m611xi = EMachine.EM_ECOG16)
    /* renamed from: kotlin.collections.CollectionsKt__CollectionsKt$binarySearchBy$1 */
    public static final class C25871<T> extends Lambda implements Function1<T, Integer> {
        ...
        public C25871(Function1 function1, Comparable comparable) {
            super(1);
    ...
    public static final <T, K extends Comparable<? super K>> int binarySearchBy(List<? extends T> list, K k, int i, int i2, Function1<? super T, ? extends K> selector) {
        Intrinsics.checkNotNullParameter(list, "<this>");
        Intrinsics.checkNotNullParameter(selector, "selector");
        return CollectionsKt.binarySearch(list, i, i2, new C25871(selector, k));
    }
