...
public final class HexExtensionsKt {
    ...
    */
    ...
    public static final int formattedStringLength(int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        ...
        throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m1123toStringimpl(ULong.m1077constructorimpl(j))));
    }
    ...
    private static final void checkHexLength(String str, int i, int i2, int i3, boolean z) {
        ...
        String strSubstring = str.substring(i, i2);
        Intrinsics.checkNotNullExpressionValue(strSubstring, "substring(...)");
        throw new NumberFormatException("Expected " + str2 + TokenParser.f390SP + i3 + " hexadecimal digits at index " + i + ", but was " + strSubstring + " of length " + i4);
    }
