...
public abstract class FragmentTransaction {
    ...
    static final class C0403Op {
        ...
        C0403Op(int i, Fragment fragment) {
            this.mCmd = i;
        ...
        C0403Op(int i, Fragment fragment, boolean z) {
            this.mCmd = i;
            this.mFragment = fragment;
        ...
        C0403Op(int i, Fragment fragment, Lifecycle.State state) {
            this.mCmd = i;
            this.mFragment = fragment;
            this.mFromExpandedOp = false;
        ...
        C0403Op(C0403Op c0403Op) {
            this.mCmd = c0403Op.mCmd;
            this.mFragment = c0403Op.mFragment;
            this.mFromExpandedOp = c0403Op.mFromExpandedOp;
            this.mEnterAnim = c0403Op.mEnterAnim;
            this.mExitAnim = c0403Op.mExitAnim;
            this.mPopEnterAnim = c0403Op.mPopEnterAnim;
            this.mPopExitAnim = c0403Op.mPopExitAnim;
            this.mOldMaxState = c0403Op.mOldMaxState;
            this.mCurrentMaxState = c0403Op.mCurrentMaxState;
        }
    }
    ...
    FragmentTransaction(FragmentFactory fragmentFactory, ClassLoader classLoader, FragmentTransaction fragmentTransaction) {
        ...
        Iterator<C0403Op> it = fragmentTransaction.mOps.iterator();
        while (it.hasNext()) {
            this.mOps.add(new C0403Op(it.next()));
        }
    ...
    void addOp(C0403Op c0403Op) {
        this.mOps.add(c0403Op);
        c0403Op.mEnterAnim = this.mEnterAnim;
        c0403Op.mExitAnim = this.mExitAnim;
        c0403Op.mPopEnterAnim = this.mPopEnterAnim;
        c0403Op.mPopExitAnim = this.mPopExitAnim;
    }
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C0403Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C0403Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C0403Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0403Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0403Op(7, fragment));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
        addOp(new C0403Op(8, fragment));
        return this;
    }

    public FragmentTransaction setMaxLifecycle(Fragment fragment, Lifecycle.State state) {
        addOp(new C0403Op(10, fragment, state));
        return this;
    }
