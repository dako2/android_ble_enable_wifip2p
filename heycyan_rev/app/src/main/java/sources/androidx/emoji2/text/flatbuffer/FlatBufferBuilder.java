...
public class FlatBufferBuilder {
    ...
    public FlatBufferBuilder(int i, ByteBufferFactory byteBufferFactory, ByteBuffer byteBuffer, Utf8 utf8) {
        ...
        if (byteBuffer != null) {
            ...
            this.f74bb = byteBufferFactory.newByteBuffer(i);
        }
        this.utf8 = utf8;
    ...
    public ByteBuffer createUnintializedVector(int i, int i2, int i3) {
        ...
        ByteBuffer byteBufferOrder = this.f74bb.slice().order(ByteOrder.LITTLE_ENDIAN);
    ...
    public int createString(CharSequence charSequence) {
        ...
        this.utf8.encodeUtf8(charSequence, this.f74bb);
        return endVector();
    }
    ...
    public int endTable() {
        ...
        loop2: while (true) {
            ...
            int iCapacity = this.f74bb.capacity() - this.vtables[i5];
            int i6 = this.space;
            short s = this.f74bb.getShort(iCapacity);
            if (s == this.f74bb.getShort(i6)) {
                for (int i7 = 2; i7 < s; i7 += 2) {
                    if (this.f74bb.getShort(iCapacity + i7) != this.f74bb.getShort(i6 + i7)) {
                        break;
                    }
                }
                i = this.vtables[i5];
        ...
        if (i != 0) {
            int iCapacity2 = this.f74bb.capacity() - iOffset;
            this.space = iCapacity2;
            this.f74bb.putInt(iCapacity2, i - iOffset);
        } else {
    ...
    public void required(int i, int i2) {
        int iCapacity = this.f74bb.capacity() - i;
        if (this.f74bb.getShort((iCapacity - this.f74bb.getInt(iCapacity)) + i2) == 0) {
    ...
    public InputStream sizedInputStream() {
        finished();
        ByteBuffer byteBufferDuplicate = this.f74bb.duplicate();
        byteBufferDuplicate.position(this.space);
        byteBufferDuplicate.limit(this.f74bb.capacity());
