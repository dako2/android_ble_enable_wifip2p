...
public class FlexBuffers {
    ...
    public static class Reference {
        ...
        public String asString() {
            if (isString()) {
                int iIndirect = FlexBuffers.indirect(this.f76bb, this.end, this.parentWidth);
                ReadBuf readBuf = this.f76bb;
                int i = this.byteWidth;
                return this.f76bb.getString(iIndirect, (int) FlexBuffers.readUInt(readBuf, iIndirect - i, i));
            }
            if (isKey()) {
                int iIndirect2 = FlexBuffers.indirect(this.f76bb, this.end, this.byteWidth);
                int i2 = iIndirect2;
                while (this.f76bb.get(i2) != 0) {
                    i2++;
                }
                return this.f76bb.getString(iIndirect2, i2 - iIndirect2);
            }
            return "";
        }
    ...
    private static abstract class Sized extends Object {
        ...
        Sized(ReadBuf readBuf, int i, int i2) {
            super(readBuf, i, i2);
            this.size = FlexBuffers.readInt(this.f75bb, i - i2, i2);
        }
    ...
    public static class Blob extends Sized {
        ...
        public ByteBuffer data() {
            ByteBuffer byteBufferWrap = ByteBuffer.wrap(this.f75bb.data());
        ...
        public byte[] getBytes() {
            ...
            for (int i = 0; i < size; i++) {
                bArr[i] = this.f75bb.get(this.end + i);
            }
            return bArr;
        }

        public byte get(int i) {
            return this.f75bb.get(this.end + i);
        }
    ...
    public static class Key extends Object {
        ...
        public String toString() {
            ...
            return this.f75bb.getString(this.end, i - this.end);
        }
    ...
    public static class Map extends Vector {
        ...
        public KeyVector keys() {
            ...
            return new KeyVector(new TypedVector(this.f75bb, FlexBuffers.indirect(this.f75bb, i, this.byteWidth), FlexBuffers.readInt(this.f75bb, i + this.byteWidth, this.byteWidth), 4));
        }
    ...
    public static class Vector extends Sized {
        ...
        public Reference get(int i) {
            ...
            return new Reference(this.f75bb, this.end + (i * this.byteWidth), this.byteWidth, Unsigned.byteToUnsignedInt(this.f75bb.get((int) (this.end + (size * this.byteWidth) + j))));
        }
    }
    ...
    public static class TypedVector extends Vector {
        ...
        public Reference get(int i) {
            ...
            return new Reference(this.f75bb, this.end + (i * this.byteWidth), this.byteWidth, 1, this.elemType);
        }
    }
    ...
    public static class KeyVector {
        ...
        public Key get(int i) {
            ...
            return new Key(this.vec.f75bb, FlexBuffers.indirect(this.vec.f75bb, this.vec.end + (i * this.vec.byteWidth), this.vec.byteWidth), 1);
        }
