...
public final class PausingDispatcherKt {
    ...
    /* compiled from: PausingDispatcher.jvm.kt */
    @Metadata(m606d1 = {"\u0000\b\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u0002H\u0001\"\u0004\b\u0000\u0010\u0001*\u00020\u0002H\u008a@"}, m607d2 = {"<anonymous>", ExifInterface.GPS_DIRECTION_TRUE, "Lkotlinx/coroutines/CoroutineScope;"}, m608k = 3, m609mv = {1, 8, 0}, m611xi = 48)
    @DebugMetadata(m619c = "androidx.lifecycle.PausingDispatcherKt$whenStateAtLeast$2", m620f = "PausingDispatcher.jvm.kt", m621i = {0}, m622l = {205}, m623m = "invokeSuspend", m624n = {"controller"}, m625s = {"L$0"})
    /* renamed from: androidx.lifecycle.PausingDispatcherKt$whenStateAtLeast$2 */
    static final class C04362<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
        ...
        C04362(Lifecycle lifecycle, Lifecycle.State state, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super C04362> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04362 c04362 = new C04362(this.$this_whenStateAtLeast, this.$minState, this.$block, continuation);
            c04362.L$0 = obj;
            return c04362;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super T> continuation) {
            return ((C04362) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Object whenStateAtLeast(Lifecycle lifecycle, Lifecycle.State state, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return BuildersKt.withContext(Dispatchers.getMain().getImmediate(), new C04362(lifecycle, state, function2, null), continuation);
    }
}
