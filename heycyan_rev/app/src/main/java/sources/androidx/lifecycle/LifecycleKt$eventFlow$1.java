...
@Metadata(m606d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00030\u0002H\u008a@"}, m607d2 = {"<anonymous>", "", "Lkotlinx/coroutines/channels/ProducerScope;", "Landroidx/lifecycle/Lifecycle$Event;"}, m608k = 3, m609mv = {1, 8, 0}, m611xi = 48)
@DebugMetadata(m619c = "androidx.lifecycle.LifecycleKt$eventFlow$1", m620f = "Lifecycle.kt", m621i = {}, m622l = {388}, m623m = "invokeSuspend", m624n = {}, m625s = {})
        ...
        if (i == 0) {
            ...
            final LifecycleEventObserver lifecycleEventObserver = new LifecycleEventObserver() { // from class: androidx.lifecycle.LifecycleKt$eventFlow$1$$ExternalSyntheticLambda0
                ...
                public final void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
                    producerScope.mo2405trySendJP2dKIU(event);
                }
            };
