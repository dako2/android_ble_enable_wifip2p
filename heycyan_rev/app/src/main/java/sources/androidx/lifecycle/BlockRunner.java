...
public final class BlockRunner<T> {
    ...
    public final void maybeRun() {
        ...
        this.runningJob = BuildersKt__Builders_commonKt.launch$default(this.scope, null, null, new C04191(this, null), 3, null);
    }
    ...
    @DebugMetadata(m619c = "androidx.lifecycle.BlockRunner$maybeRun$1", m620f = "CoroutineLiveData.kt", m621i = {}, m622l = {EMachine.EM_CR16}, m623m = "invokeSuspend", m624n = {}, m625s = {})
    ...
    static final class C04191 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C04191(BlockRunner<T> blockRunner, Continuation<? super C04191> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04191 c04191 = new C04191(this.this$0, continuation);
            c04191.L$0 = obj;
            return c04191;
        }
    ...
    public final void cancel() {
        if (this.cancellationJob == null) {
            this.cancellationJob = BuildersKt__Builders_commonKt.launch$default(this.scope, Dispatchers.getMain().getImmediate(), null, new C04181(this, null), 2, null);
            return;
        }
    ...
    /* compiled from: CoroutineLiveData.kt */
    @Metadata(m606d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u0003H\u008a@"}, m607d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "Lkotlinx/coroutines/CoroutineScope;"}, m608k = 3, m609mv = {1, 8, 0}, m611xi = 48)
    @DebugMetadata(m619c = "androidx.lifecycle.BlockRunner$cancel$1", m620f = "CoroutineLiveData.kt", m621i = {}, m622l = {EMachine.EM_TILEPRO}, m623m = "invokeSuspend", m624n = {}, m625s = {})
    ...
    static final class C04181 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04181(BlockRunner<T> blockRunner, Continuation<? super C04181> continuation) {
            super(2, continuation);
            this.this$0 = blockRunner;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C04181(this.this$0, continuation);
        }
