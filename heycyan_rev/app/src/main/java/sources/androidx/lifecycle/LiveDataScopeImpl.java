...
public final class LiveDataScopeImpl<T> implements LiveDataScope<T> {
    ...
    /* compiled from: CoroutineLiveData.kt */
    @Metadata(m606d1 = {"\u0000\f\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u0003H\u008a@"}, m607d2 = {"<anonymous>", "Lkotlinx/coroutines/DisposableHandle;", ExifInterface.GPS_DIRECTION_TRUE, "Lkotlinx/coroutines/CoroutineScope;"}, m608k = 3, m609mv = {1, 8, 0}, m611xi = 48)
    @DebugMetadata(m619c = "androidx.lifecycle.LiveDataScopeImpl$emitSource$2", m620f = "CoroutineLiveData.kt", m621i = {}, m622l = {EMachine.EM_XTENSA}, m623m = "invokeSuspend", m624n = {}, m625s = {})
    /* renamed from: androidx.lifecycle.LiveDataScopeImpl$emitSource$2 */
    static final class C04352 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super DisposableHandle>, Object> {
        final /* synthetic */ LiveData<T> $source;
        int label;
        final /* synthetic */ LiveDataScopeImpl<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04352(LiveDataScopeImpl<T> liveDataScopeImpl, LiveData<T> liveData, Continuation<? super C04352> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C04352(this.this$0, this.$source, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super DisposableHandle> continuation) {
            return ((C04352) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public Object emitSource(LiveData<T> liveData, Continuation<? super DisposableHandle> continuation) {
        return BuildersKt.withContext(this.coroutineContext, new C04352(this, liveData, null), continuation);
    }
    ...
    @DebugMetadata(m619c = "androidx.lifecycle.LiveDataScopeImpl$emit$2", m620f = "CoroutineLiveData.kt", m621i = {}, m622l = {EMachine.EM_SNP1K}, m623m = "invokeSuspend", m624n = {}, m625s = {})
    /* renamed from: androidx.lifecycle.LiveDataScopeImpl$emit$2 */
    static final class C04342 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ T $value;
        int label;
        final /* synthetic */ LiveDataScopeImpl<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04342(LiveDataScopeImpl<T> liveDataScopeImpl, T t, Continuation<? super C04342> continuation) {
            super(2, continuation);
            this.this$0 = liveDataScopeImpl;
            this.$value = t;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C04342(this.this$0, this.$value, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C04342) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
        Object objWithContext = BuildersKt.withContext(this.coroutineContext, new C04342(this, t, null), continuation);
