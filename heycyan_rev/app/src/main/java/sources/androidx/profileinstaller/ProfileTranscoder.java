...
class ProfileTranscoder {
    ...
    static final byte[] MAGIC_PROF = {Constants.CMD_ECG_MEASURE_TIME, 114, Constants.CMD_ECG_STATUS_DATA, 0};
    static final byte[] MAGIC_PROFM = {Constants.CMD_ECG_MEASURE_TIME, 114, Constants.CMD_HEALTH_ECG_DATA, 0};
