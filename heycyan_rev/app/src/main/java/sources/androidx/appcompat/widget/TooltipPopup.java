...
class TooltipPopup {
    ...
    TooltipPopup(Context context) {
        ...
        View viewInflate = LayoutInflater.from(context).inflate(C0035R.layout.abc_tooltip, (ViewGroup) null);
        this.mContentView = viewInflate;
        this.mMessageView = (TextView) viewInflate.findViewById(C0035R.id.message);
