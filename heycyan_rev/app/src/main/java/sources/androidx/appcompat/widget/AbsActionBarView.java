...
abstract class AbsActionBarView extends ViewGroup {
    ...
    protected void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(null, C0035R.styleable.ActionBar, C0035R.attr.actionBarStyle, 0);
        setContentHeight(typedArrayObtainStyledAttributes.getLayoutDimension(C0035R.styleable.ActionBar_height, 0));
