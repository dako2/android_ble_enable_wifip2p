...
@DebugMetadata(m619c = "androidx.room.RoomDatabaseKt$invalidationTrackerFlow$1$job$1", m620f = "RoomDatabaseExt.kt", m621i = {}, m622l = {230}, m623m = "invokeSuspend", m624n = {}, m625s = {})
        ...
        try {
            if (i == 0) {
                ...
                if (this.$emitInitialState) {
                    this.$$this$callbackFlow.mo2405trySendJP2dKIU(ArraysKt.toSet(this.$tables));
                }
