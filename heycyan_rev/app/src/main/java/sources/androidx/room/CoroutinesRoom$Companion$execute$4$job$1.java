...
@DebugMetadata(m619c = "androidx.room.CoroutinesRoom$Companion$execute$4$job$1", m620f = "CoroutinesRoom.kt", m621i = {}, m622l = {}, m623m = "invokeSuspend", m624n = {}, m625s = {})
...
final class CoroutinesRoom$Companion$execute$4$job$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            ...
            continuation.resumeWith(Result.m903constructorimpl(objCall));
        } catch (Throwable th) {
            Continuation continuation2 = this.$continuation;
            Result.Companion companion2 = Result.INSTANCE;
            continuation2.resumeWith(Result.m903constructorimpl(ResultKt.createFailure(th)));
        }
