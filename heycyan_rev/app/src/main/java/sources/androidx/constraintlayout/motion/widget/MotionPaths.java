...
class MotionPaths implements Comparable<MotionPaths> {
    ...
    void initCartesian(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths.f48mX;
        float f9 = motionPaths.f49mY;
        float f10 = (motionPaths2.f48mX + (f4 / 2.0f)) - ((f5 / 2.0f) + f8);
        float f11 = (motionPaths2.f49mY + (f6 / 2.0f)) - (f9 + (f7 / 2.0f));
        float f12 = ((f4 - f5) * f2) / 2.0f;
        this.f48mX = (int) ((f8 + (f10 * f)) - f12);
        float f13 = ((f6 - f7) * f3) / 2.0f;
        this.f49mY = (int) ((f9 + (f11 * f)) - f13);
        ...
        this.mMode = 0;
        this.f48mX = (int) (((motionPaths.f48mX + (f14 * f10)) + (f16 * f11)) - f12);
        this.f49mY = (int) (((motionPaths.f49mY + (f10 * f15)) + (f11 * f)) - f13);
    ...
    void initAxis(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f9 = f7 - f8;
        this.mPosition = this.mTime;
        float f10 = (f5 / 2.0f) + motionPaths.f48mX;
        float f11 = motionPaths.f49mY + (f8 / 2.0f);
        float f12 = motionPaths2.f48mX + (f4 / 2.0f);
        float f13 = motionPaths2.f49mY + (f7 / 2.0f);
        if (f10 > f12) {
            f10 = f12;
            f12 = f10;
        }
        ...
        this.f48mX = (int) ((r13 + (f14 * f)) - f16);
        float f17 = (f9 * f3) / 2.0f;
        this.f49mY = (int) ((r1 + (f15 * f)) - f17);
        this.mWidth = (int) (f5 + r9);
        ...
        this.mMode = 0;
        this.f48mX = (int) (((motionPaths.f48mX + (f18 * f14)) + (f20 * f15)) - f16);
        this.f49mY = (int) (((motionPaths.f49mY + (f14 * f19)) + (f15 * f)) - f17);
        this.mKeyFrameEasing = Easing.getInterpolator(keyPosition.mTransitionEasing);
        this.mPathMotionArc = keyPosition.mPathMotionArc;
    }
    ...
    void initPolar(int i, int i2, KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        if (keyPosition.mPositionType == 2) {
            if (Float.isNaN(keyPosition.mPercentX)) {
                float f9 = motionPaths2.f48mX;
                float f10 = motionPaths.f48mX;
                fMin = ((f9 - f10) * f2) + f10;
            } else {
            ...
            this.f48mX = fMin;
            if (Float.isNaN(keyPosition.mPercentY)) {
                float f11 = motionPaths2.f49mY;
                float f12 = motionPaths.f49mY;
                f = (f2 * (f11 - f12)) + f12;
            } else {
                f = keyPosition.mPercentY;
            }
            ...
            float f14 = motionPaths2.f48mX;
            float f15 = motionPaths.f48mX;
            this.f48mX = (f13 * (f14 - f15)) + f15;
            if (!Float.isNaN(keyPosition.mPercentY)) {
                f2 = keyPosition.mPercentY;
            }
            float f16 = motionPaths2.f49mY;
            float f17 = motionPaths.f49mY;
            this.f49mY = (f2 * (f16 - f17)) + f17;
        }
    ...
    public void setupRelative(MotionController motionController, MotionPaths motionPaths) {
        double d = ((this.f48mX + (this.mWidth / 2.0f)) - motionPaths.f48mX) - (motionPaths.mWidth / 2.0f);
        double d2 = ((this.f49mY + (this.mHeight / 2.0f)) - motionPaths.f49mY) - (motionPaths.mHeight / 2.0f);
        this.mRelativeToController = motionController;
        this.f48mX = (float) Math.hypot(d2, d);
        if (Float.isNaN(this.mRelativeAngle)) {
            this.f49mY = (float) (Math.atan2(d2, d) + 1.5707963267948966d);
        } else {
            this.f49mY = (float) Math.toRadians(this.mRelativeAngle);
        }
    }
    ...
    void initScreen(int i, int i2, KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths.f48mX;
        float f9 = motionPaths.f49mY;
        float f10 = motionPaths2.f48mX + (f4 / 2.0f);
        float f11 = motionPaths2.f49mY + (f6 / 2.0f);
        float f12 = (f4 - f5) * f2;
        this.f48mX = (int) ((f8 + ((f10 - ((f5 / 2.0f) + f8)) * f)) - (f12 / 2.0f));
        float f13 = (f6 - f7) * f3;
        this.f49mY = (int) ((f9 + ((f11 - (f9 + (f7 / 2.0f))) * f)) - (f13 / 2.0f));
        this.mWidth = (int) (f5 + f12);
        this.mHeight = (int) (f7 + f13);
        this.mMode = 2;
        if (!Float.isNaN(keyPosition.mPercentX)) {
            this.f48mX = (int) (keyPosition.mPercentX * (i - ((int) this.mWidth)));
        }
        if (!Float.isNaN(keyPosition.mPercentY)) {
            this.f49mY = (int) (keyPosition.mPercentY * (i2 - ((int) this.mHeight)));
        }
    ...
    void initPath(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f6 = motionPaths.f48mX;
        float f7 = motionPaths.mWidth;
        float f8 = motionPaths.f49mY;
        float f9 = motionPaths.mHeight;
        float f10 = (motionPaths2.f48mX + (motionPaths2.mWidth / 2.0f)) - ((f7 / 2.0f) + f6);
        float f11 = (motionPaths2.f49mY + (motionPaths2.mHeight / 2.0f)) - ((f9 / 2.0f) + f8);
        float f12 = f10 * f;
        float f13 = (f4 * f2) / 2.0f;
        this.f48mX = (int) ((f6 + f12) - f13);
        float f14 = f * f11;
        float f15 = (f5 * f3) / 2.0f;
        this.f49mY = (int) ((f8 + f14) - f15);
        this.mWidth = (int) (f7 + r7);
        this.mHeight = (int) (f9 + r8);
        float f16 = Float.isNaN(keyPosition.mPercentY) ? 0.0f : keyPosition.mPercentY;
        this.mMode = 1;
        float f17 = (int) ((motionPaths.f48mX + f12) - f13);
        this.f48mX = f17;
        float f18 = (int) ((motionPaths.f49mY + f14) - f15);
        this.f48mX = f17 + ((-f11) * f16);
        this.f49mY = f18 + (f10 * f16);
        this.mAnimateRelativeTo = this.mAnimateRelativeTo;
        this.mKeyFrameEasing = Easing.getInterpolator(keyPosition.mTransitionEasing);
        this.mPathMotionArc = keyPosition.mPathMotionArc;
    }
    ...
    void different(MotionPaths motionPaths, boolean[] zArr, String[] strArr, boolean z) {
        boolean zDiff = diff(this.f48mX, motionPaths.f48mX);
        boolean zDiff2 = diff(this.f49mY, motionPaths.f49mY);
    ...
    void getCenter(double d, int[] iArr, double[] dArr, float[] fArr, int i) {
        float fSin = this.f48mX;
        float fCos = this.f49mY;
        float f = this.mWidth;
    ...
    void fillStandard(double[] dArr, int[] iArr) {
        float[] fArr = {this.mPosition, this.f48mX, this.f49mY, this.mWidth, this.mHeight, this.mPathRotate};
        int i = 0;
        for (int i2 : iArr) {
            if (i2 < 6) {
                dArr[i] = fArr[r1];
