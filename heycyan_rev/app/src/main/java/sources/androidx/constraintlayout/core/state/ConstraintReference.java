...
public class ConstraintReference implements Reference {
    ...
    public ConstraintReference margin(int i) {
        if (this.mLast != null) {
            switch (C01411.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[this.mLast.ordinal()]) {
                case 1:
                case 2:
                    this.mMarginLeft = i;
                    break;
    ...
    */
    public ConstraintReference bias(float f) {
        ...
        int i = C01411.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[this.mLast.ordinal()];
        if (i == 19) {
            this.mHorizontalBias = f;
        } else if (i != 20) {
            switch (i) {
    ...
    private void applyConnection(ConstraintWidget constraintWidget, Object obj, State.Constraint constraint) {
        ...
        int i = C01411.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[constraint.ordinal()];
        switch (C01411.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[constraint.ordinal()]) {
            case 1:
