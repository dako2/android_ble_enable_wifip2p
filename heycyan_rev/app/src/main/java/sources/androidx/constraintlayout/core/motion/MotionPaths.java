...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    void initCartesian(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths.f21mX;
        float f9 = motionPaths.f22mY;
        float f10 = (motionPaths2.f21mX + (f4 / 2.0f)) - ((f5 / 2.0f) + f8);
        float f11 = (motionPaths2.f22mY + (f6 / 2.0f)) - (f9 + (f7 / 2.0f));
        float f12 = ((f4 - f5) * f2) / 2.0f;
        this.f21mX = (int) ((f8 + (f10 * f)) - f12);
        float f13 = ((f6 - f7) * f3) / 2.0f;
        this.f22mY = (int) ((f9 + (f11 * f)) - f13);
        ...
        this.mMode = 0;
        this.f21mX = (int) (((motionPaths.f21mX + (f14 * f10)) + (f16 * f11)) - f12);
        this.f22mY = (int) (((motionPaths.f22mY + (f10 * f15)) + (f11 * f)) - f13);
    ...
    void initPolar(int i, int i2, MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        if (i3 == 1) {
            ...
            float f10 = motionPaths2.f21mX;
            float f11 = motionPaths.f21mX;
            this.f21mX = (f9 * (f10 - f11)) + f11;
            if (!Float.isNaN(motionKeyPosition.mPercentY)) {
                f2 = motionKeyPosition.mPercentY;
            }
            float f12 = motionPaths2.f22mY;
            float f13 = motionPaths.f22mY;
            this.f22mY = (f2 * (f12 - f13)) + f13;
        } else if (i3 == 2) {
            if (Float.isNaN(motionKeyPosition.mPercentX)) {
                float f14 = motionPaths2.f21mX;
                float f15 = motionPaths.f21mX;
                fMin = ((f14 - f15) * f2) + f15;
            } else {
            ...
            this.f21mX = fMin;
            if (Float.isNaN(motionKeyPosition.mPercentY)) {
                float f16 = motionPaths2.f22mY;
                float f17 = motionPaths.f22mY;
                f = (f2 * (f16 - f17)) + f17;
            } else {
                f = motionKeyPosition.mPercentY;
            }
            ...
            float f19 = motionPaths2.f21mX;
            float f20 = motionPaths.f21mX;
            this.f21mX = (f18 * (f19 - f20)) + f20;
            if (!Float.isNaN(motionKeyPosition.mPercentY)) {
                f2 = motionKeyPosition.mPercentY;
            }
            float f21 = motionPaths2.f22mY;
            float f22 = motionPaths.f22mY;
            this.f22mY = (f2 * (f21 - f22)) + f22;
        }
    ...
    public void setupRelative(Motion motion, MotionPaths motionPaths) {
        double d = ((this.f21mX + (this.mWidth / 2.0f)) - motionPaths.f21mX) - (motionPaths.mWidth / 2.0f);
        double d2 = ((this.f22mY + (this.mHeight / 2.0f)) - motionPaths.f22mY) - (motionPaths.mHeight / 2.0f);
        this.mRelativeToController = motion;
        this.f21mX = (float) Math.hypot(d2, d);
        if (Float.isNaN(this.mRelativeAngle)) {
            this.f22mY = (float) (Math.atan2(d2, d) + 1.5707963267948966d);
        } else {
            this.f22mY = (float) Math.toRadians(this.mRelativeAngle);
        }
    }
    ...
    void initScreen(int i, int i2, MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths.f21mX;
        float f9 = motionPaths.f22mY;
        float f10 = motionPaths2.f21mX + (f4 / 2.0f);
        float f11 = motionPaths2.f22mY + (f6 / 2.0f);
        float f12 = (f4 - f5) * f2;
        this.f21mX = (int) ((f8 + ((f10 - ((f5 / 2.0f) + f8)) * f)) - (f12 / 2.0f));
        float f13 = (f6 - f7) * f3;
        this.f22mY = (int) ((f9 + ((f11 - (f9 + (f7 / 2.0f))) * f)) - (f13 / 2.0f));
        this.mWidth = (int) (f5 + f12);
        this.mHeight = (int) (f7 + f13);
        this.mMode = 2;
        if (!Float.isNaN(motionKeyPosition.mPercentX)) {
            this.f21mX = (int) (motionKeyPosition.mPercentX * (i - ((int) this.mWidth)));
        }
        if (!Float.isNaN(motionKeyPosition.mPercentY)) {
            this.f22mY = (int) (motionKeyPosition.mPercentY * (i2 - ((int) this.mHeight)));
        }
    ...
    void initPath(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f6 = motionPaths.f21mX;
        float f7 = motionPaths.mWidth;
        float f8 = motionPaths.f22mY;
        float f9 = motionPaths.mHeight;
        float f10 = (motionPaths2.f21mX + (motionPaths2.mWidth / 2.0f)) - ((f7 / 2.0f) + f6);
        float f11 = (motionPaths2.f22mY + (motionPaths2.mHeight / 2.0f)) - ((f9 / 2.0f) + f8);
        float f12 = f10 * f;
        float f13 = (f4 * f2) / 2.0f;
        this.f21mX = (int) ((f6 + f12) - f13);
        float f14 = f * f11;
        float f15 = (f5 * f3) / 2.0f;
        this.f22mY = (int) ((f8 + f14) - f15);
        ...
        this.mMode = 1;
        float f17 = (int) ((motionPaths.f21mX + f12) - f13);
        this.f21mX = f17;
        float f18 = (int) ((motionPaths.f22mY + f14) - f15);
        this.f21mX = f17 + ((-f11) * f16);
        this.f22mY = f18 + (f10 * f16);
        this.mAnimateRelativeTo = this.mAnimateRelativeTo;
        this.mKeyFrameEasing = Easing.getInterpolator(motionKeyPosition.mTransitionEasing);
        this.mPathMotionArc = motionKeyPosition.mPathMotionArc;
    }
    ...
    void different(MotionPaths motionPaths, boolean[] zArr, String[] strArr, boolean z) {
        boolean zDiff = diff(this.f21mX, motionPaths.f21mX);
        boolean zDiff2 = diff(this.f22mY, motionPaths.f22mY);
    ...
    void getCenter(double d, int[] iArr, double[] dArr, float[] fArr, int i) {
        float fSin = this.f21mX;
        float fCos = this.f22mY;
        float f = this.mWidth;
    ...
    void fillStandard(double[] dArr, int[] iArr) {
        float[] fArr = {this.mPosition, this.f21mX, this.f22mY, this.mWidth, this.mHeight, this.mPathRotate};
        int i = 0;
        for (int i2 : iArr) {
            if (i2 < 6) {
                dArr[i] = fArr[r1];
