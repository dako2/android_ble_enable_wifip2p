...
public class WidgetFrame {
    ...
    public static void interpolate(int i, int i2, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f) {
        ...
        if (widgetFrame.widget == null || !transition.hasPositionKeyframes()) {
            ...
            if (keyPositionFindPreviousPosition != null) {
                i5 = (int) (keyPositionFindPreviousPosition.f34mX * i);
                i10 = i16;
                i9 = i2;
                i6 = (int) (keyPositionFindPreviousPosition.f35mY * i9);
            ...
            if (keyPositionFindNextPosition != null) {
                int i22 = (int) (keyPositionFindNextPosition.f34mX * i);
                int i23 = (int) (keyPositionFindNextPosition.f35mY * i9);
    ...
    void printCustomAttributes() {
        ...
        String str2 = (".(" + stackTraceElement.getFileName() + ":" + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName()) + HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR + (hashCode() % 1000);
        if (this.widget != null) {
            str = str2 + "/" + (this.widget.hashCode() % 1000) + HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR;
        } else {
            str = str2 + "/NULL ";
        }
    ...
    void logv(String str) {
        String str2;
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        String str3 = (".(" + stackTraceElement.getFileName() + ":" + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName()) + HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR + (hashCode() % 1000);
        if (this.widget != null) {
