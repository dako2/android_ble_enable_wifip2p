...
public class Motion implements TypedValues {
    ...
    public float getStartX() {
        return this.mStartMotionPath.f21mX;
    }

    public float getStartY() {
        return this.mStartMotionPath.f22mY;
    }

    public float getFinalX() {
        return this.mEndMotionPath.f21mX;
    }

    public float getFinalY() {
        return this.mEndMotionPath.f22mY;
    }
    ...
    MotionKeyPosition getPositionKeyframe(int i, int i2, float f, float f2) {
        ...
        floatRect.left = this.mStartMotionPath.f21mX;
        floatRect.top = this.mStartMotionPath.f22mY;
        ...
        floatRect2.left = this.mEndMotionPath.f21mX;
        floatRect2.top = this.mEndMotionPath.f22mY;
    ...
    float getKeyFrameParameter(int i, float f, float f2) {
        float f3 = this.mEndMotionPath.f21mX - this.mStartMotionPath.f21mX;
        float f4 = this.mEndMotionPath.f22mY - this.mStartMotionPath.f22mY;
        float f5 = this.mStartMotionPath.f21mX + (this.mStartMotionPath.mWidth / 2.0f);
        float f6 = this.mStartMotionPath.f22mY + (this.mStartMotionPath.mHeight / 2.0f);
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        if (motionPathsArr[0].mPathMotionArc != -1) {
            ...
            for (int i18 = 0; i18 < i3; i18++) {
                ...
                dArr6[i18][0] = motionPathsArr[i18].f21mX;
                dArr6[i18][1] = motionPathsArr[i18].f22mY;
            }
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f21mX + " y: " + this.mStartMotionPath.f22mY + " end: x: " + this.mEndMotionPath.f21mX + " y: " + this.mEndMotionPath.f22mY;
    }
    ...
    public boolean interpolate(MotionWidget motionWidget, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            float f5 = this.mStartMotionPath.f21mX + ((this.mEndMotionPath.f21mX - this.mStartMotionPath.f21mX) * f4) + 0.5f;
            float f6 = this.mStartMotionPath.f22mY + ((this.mEndMotionPath.f22mY - this.mStartMotionPath.f22mY) * f4) + 0.5f;
    ...
    public void getDpDt(float f, float f2, float f3, float[] fArr) {
        ...
        float f5 = this.mEndMotionPath.f21mX - this.mStartMotionPath.f21mX;
        float f6 = this.mEndMotionPath.f22mY - this.mStartMotionPath.f22mY;
