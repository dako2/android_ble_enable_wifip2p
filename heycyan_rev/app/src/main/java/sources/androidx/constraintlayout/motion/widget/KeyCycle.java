...
public class KeyCycle extends Key {
    ...
    public void load(Context context, AttributeSet attributeSet) {
        Loader.read(this, context.obtainStyledAttributes(attributeSet, C0171R.styleable.KeyCycle));
    }
    ...
    private static class Loader {
        ...
        static {
            ...
            sparseIntArray.append(C0171R.styleable.KeyCycle_motionTarget, 1);
            sAttrMap.append(C0171R.styleable.KeyCycle_framePosition, 2);
            sAttrMap.append(C0171R.styleable.KeyCycle_transitionEasing, 3);
            sAttrMap.append(C0171R.styleable.KeyCycle_curveFit, 4);
            sAttrMap.append(C0171R.styleable.KeyCycle_waveShape, 5);
            sAttrMap.append(C0171R.styleable.KeyCycle_wavePeriod, 6);
            sAttrMap.append(C0171R.styleable.KeyCycle_waveOffset, 7);
            sAttrMap.append(C0171R.styleable.KeyCycle_waveVariesBy, 8);
            sAttrMap.append(C0171R.styleable.KeyCycle_android_alpha, 9);
            sAttrMap.append(C0171R.styleable.KeyCycle_android_elevation, 10);
            sAttrMap.append(C0171R.styleable.KeyCycle_android_rotation, 11);
            sAttrMap.append(C0171R.styleable.KeyCycle_android_rotationX, 12);
            sAttrMap.append(C0171R.styleable.KeyCycle_android_rotationY, 13);
            sAttrMap.append(C0171R.styleable.KeyCycle_transitionPathRotate, 14);
            sAttrMap.append(C0171R.styleable.KeyCycle_android_scaleX, 15);
            sAttrMap.append(C0171R.styleable.KeyCycle_android_scaleY, 16);
            sAttrMap.append(C0171R.styleable.KeyCycle_android_translationX, 17);
            sAttrMap.append(C0171R.styleable.KeyCycle_android_translationY, 18);
            sAttrMap.append(C0171R.styleable.KeyCycle_android_translationZ, 19);
            sAttrMap.append(C0171R.styleable.KeyCycle_motionProgress, 20);
            sAttrMap.append(C0171R.styleable.KeyCycle_wavePhase, 21);
        }
