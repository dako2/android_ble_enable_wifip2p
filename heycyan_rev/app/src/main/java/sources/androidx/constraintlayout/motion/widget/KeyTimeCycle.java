...
public class KeyTimeCycle extends Key {
    ...
    public void load(Context context, AttributeSet attributeSet) {
        Loader.read(this, context.obtainStyledAttributes(attributeSet, C0171R.styleable.KeyTimeCycle));
    }
    ...
    */
    ...
    private static class Loader {
        ...
        static {
            ...
            sparseIntArray.append(C0171R.styleable.KeyTimeCycle_android_alpha, 1);
            sAttrMap.append(C0171R.styleable.KeyTimeCycle_android_elevation, 2);
            sAttrMap.append(C0171R.styleable.KeyTimeCycle_android_rotation, 4);
            sAttrMap.append(C0171R.styleable.KeyTimeCycle_android_rotationX, 5);
            sAttrMap.append(C0171R.styleable.KeyTimeCycle_android_rotationY, 6);
            sAttrMap.append(C0171R.styleable.KeyTimeCycle_android_scaleX, 7);
            sAttrMap.append(C0171R.styleable.KeyTimeCycle_transitionPathRotate, 8);
            sAttrMap.append(C0171R.styleable.KeyTimeCycle_transitionEasing, 9);
            sAttrMap.append(C0171R.styleable.KeyTimeCycle_motionTarget, 10);
            sAttrMap.append(C0171R.styleable.KeyTimeCycle_framePosition, 12);
            sAttrMap.append(C0171R.styleable.KeyTimeCycle_curveFit, 13);
            sAttrMap.append(C0171R.styleable.KeyTimeCycle_android_scaleY, 14);
            sAttrMap.append(C0171R.styleable.KeyTimeCycle_android_translationX, 15);
            sAttrMap.append(C0171R.styleable.KeyTimeCycle_android_translationY, 16);
            sAttrMap.append(C0171R.styleable.KeyTimeCycle_android_translationZ, 17);
            sAttrMap.append(C0171R.styleable.KeyTimeCycle_motionProgress, 18);
            sAttrMap.append(C0171R.styleable.KeyTimeCycle_wavePeriod, 20);
            sAttrMap.append(C0171R.styleable.KeyTimeCycle_waveOffset, 21);
            sAttrMap.append(C0171R.styleable.KeyTimeCycle_waveShape, 19);
        }
