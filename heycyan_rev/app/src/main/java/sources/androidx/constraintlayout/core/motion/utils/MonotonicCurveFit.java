    ...
    public void getPos(double d, double[] dArr) {
        ...
        if (this.mExtrapolate) {
            ...
            if (d <= d2) {
                ...
                for (int i2 = 0; i2 < length2; i2++) {
                    dArr[i2] = this.f30mY[0][i2] + ((d - this.f29mT[0]) * this.mSlopeTemp[i2]);
                }
                return;
            }
            int i3 = length - 1;
            ...
            if (d >= d3) {
                ...
                while (i < length2) {
                    dArr[i] = this.f30mY[i3][i] + ((d - this.f29mT[i3]) * this.mSlopeTemp[i]);
                    i++;
                }
                return;
            }
    ...
    public void getPos(double d, float[] fArr) {
        ...
        if (this.mExtrapolate) {
            ...
            if (d <= d2) {
                getSlope(d2, this.mSlopeTemp);
                for (int i2 = 0; i2 < length2; i2++) {
                    fArr[i2] = (float) (this.f30mY[0][i2] + ((d - this.f29mT[0]) * this.mSlopeTemp[i2]));
                }
                return;
            }
            int i3 = length - 1;
            ...
            if (d >= d3) {
                getSlope(d3, this.mSlopeTemp);
                while (i < length2) {
                    fArr[i] = (float) (this.f30mY[i3][i] + ((d - this.f29mT[i3]) * this.mSlopeTemp[i]));
                    i++;
                }
                return;
            }
        ...
        while (i6 < length - 1) {
            if (d == this.f29mT[i6]) {
                for (int i7 = 0; i7 < length2; i7++) {
                    fArr[i7] = (float) this.f30mY[i6][i7];
                }
            }
            double[] dArr2 = this.f29mT;
            int i8 = i6 + 1;
