...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    String exceptionLabel() {
        return HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR + super.toString() + ", adapter:" + this.mAdapter + ", layout:" + this.mLayout + ", context:" + getContext();
    }
    ...
    */
    ...
    public View focusSearch(View view, int i) {
        ...
        if (z2 && (i == 2 || i == 1)) {
            if (this.mLayout.canScrollVertically()) {
                int i2 = i == 2 ? WatermarkGenerator.WATERMARK_HEIGHT_DP : 33;
    ...
    */
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        boolean canRestoreState() {
            int i = C05187.f89x3d106619[this.mStateRestorationPolicy.ordinal()];
            if (i != 1) {
    ...
    static /* synthetic */ class C05187 {
        ...
        static {
            ...
            try {
                f89x3d106619[Adapter.StateRestorationPolicy.PREVENT_WHEN_EMPTY.ordinal()] = 2;
