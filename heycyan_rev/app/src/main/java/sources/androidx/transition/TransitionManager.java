...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo719clone = transition.mo719clone();
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo719clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo719clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo719clone);
    }
    ...
    public static TransitionSeekController createSeekController(Scene scene, Transition transition) {
        ...
        transitionSet.addTransition(transitionMo719clone);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo719clone = transition.mo719clone();
        sceneChangeSetup(viewGroup, transitionMo719clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo719clone);
    }
