...
public class WindowInsetsCompat {
    ...
    private static class Impl20 extends Impl {
        ...
        protected Insets getInsetsForType(int i, boolean z) {
            ...
            if (i == 2) {
                ...
                return Insets.m13of(systemWindowInsets.left, 0, systemWindowInsets.right, iMin);
            }
            if (i == 8) {
    ...
    static Insets insetInsets(Insets insets, int i, int i2, int i3, int i4) {
        ...
        return (iMax == i && iMax2 == i2 && iMax3 == i3 && iMax4 == i4) ? insets : Insets.m13of(iMax, iMax2, iMax3, iMax4);
    }
                ...
                try {
                    ...
                    if (obj != null) {
                        ...
                        if (rect != null && rect2 != null) {
                            WindowInsetsCompat windowInsetsCompatBuild = new Builder().setStableInsets(Insets.m14of(rect)).setSystemWindowInsets(Insets.m14of(rect2)).build();
