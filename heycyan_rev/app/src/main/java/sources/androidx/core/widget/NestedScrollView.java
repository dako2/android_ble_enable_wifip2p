...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public NestedScrollView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0175R.attr.nestedScrollViewStyle);
    }
    ...
    public boolean executeKeyEvent(KeyEvent keyEvent) {
        ...
        int i = WatermarkGenerator.WATERMARK_HEIGHT_DP;
        if (!zCanScroll) {
            ...
            View viewFindNextFocus = FocusFinder.getInstance().findNextFocus(this, viewFindFocus, WatermarkGenerator.WATERMARK_HEIGHT_DP);
            return (viewFindNextFocus == null || viewFindNextFocus == this || !viewFindNextFocus.requestFocus(WatermarkGenerator.WATERMARK_HEIGHT_DP)) ? false : true;
        }
        ...
        if (keyCode == 20) {
            if (keyEvent.isAltPressed()) {
                return fullScroll(WatermarkGenerator.WATERMARK_HEIGHT_DP);
            }
            return arrowScroll(WatermarkGenerator.WATERMARK_HEIGHT_DP);
        }
        if (keyCode == 62) {
        ...
        pageScroll(WatermarkGenerator.WATERMARK_HEIGHT_DP);
        return false;
    }
    ...
    */
    ...
    protected boolean onRequestFocusInDescendants(int i, Rect rect) {
        ...
        if (i == 2) {
            i = WatermarkGenerator.WATERMARK_HEIGHT_DP;
        } else if (i == 1) {
            i = 33;
        }
        if (rect == null) {
