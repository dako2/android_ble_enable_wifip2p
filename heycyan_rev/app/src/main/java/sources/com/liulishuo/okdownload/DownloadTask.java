...
public class DownloadTask extends IdentifiedTask implements Comparable<DownloadTask> {
    ...
    public DownloadTask(String str, Uri uri, int i, int i2, int i3, int i4, int i5, boolean z, int i6, Map<String, List<String>> map, String str2, boolean z2, boolean z3, Boolean bool, Integer num, Boolean bool2) {
            ...
            if (bool != null) {
                if (bool.booleanValue()) {
                    ...
                    if (!Util.isEmpty(str2)) {
                        Util.m586w("DownloadTask", "Discard filename[" + name + "] because you set filenameFromResponse=true");
                        name = null;
                    }
        ...
        this.f517id = OkDownload.with().breakpointStore().findOrCreateId(this);
    }
    ...
    public BreakpointInfo getInfo() {
        if (this.info == null) {
            this.info = OkDownload.with().breakpointStore().get(this.f517id);
        }
        return this.info;
    }
    ...
    public static class Builder {
        ...
        public Builder(String str, File file) {
            ...
            this.syncBufferIntervalMillis = DEFAULT_SYNC_BUFFER_INTERVAL_MILLIS;
    ...
    public boolean equals(Object obj) {
        ...
        if (downloadTask.f517id == this.f517id) {
            return true;
        }
    ...
    public String toString() {
        return super.toString() + "@" + this.f517id + "@" + this.url + "@" + this.directoryFile.toString() + "/" + this.filenameHolder.get();
    }
