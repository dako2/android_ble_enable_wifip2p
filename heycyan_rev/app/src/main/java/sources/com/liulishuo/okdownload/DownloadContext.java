...
public class DownloadContext {
    ...
    public void start(final DownloadListener downloadListener, boolean z) {
        ...
        Util.m583d(TAG, "start finish " + z + HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR + (SystemClock.uptimeMillis() - jUptimeMillis) + "ms");
    }
    ...
    public static class QueueSet {
        ...
        public int getSyncBufferIntervalMillis() {
            ...
            return num == null ? DownloadTask.Builder.DEFAULT_SYNC_BUFFER_INTERVAL_MILLIS : num.intValue();
        }
    ...
    static class QueueAttachListener extends DownloadListener2 {
        ...
        public void taskEnd(DownloadTask downloadTask, EndCause endCause, Exception exc) {
            ...
            if (iDecrementAndGet <= 0) {
                ...
                Util.m583d(DownloadContext.TAG, "taskEnd and remainCount " + iDecrementAndGet);
            }
        }
    }
