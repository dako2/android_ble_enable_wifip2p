...
public abstract class JsonReader implements Closeable {
    ...
    @CheckReturnValue
    /* renamed from: of */
    public static JsonReader m592of(BufferedSource bufferedSource) {
    ...
    public final Object readJsonValue() throws IOException {
        switch (C24121.$SwitchMap$com$squareup$moshi$JsonReader$Token[peek().ordinal()]) {
            case 1:
    ...
    public static final class Options {
        ...
        @CheckReturnValue
        /* renamed from: of */
        public static Options m593of(String... strArr) {
            try {
                ...
                return new Options((String[]) strArr.clone(), okio.Options.m645of(byteStringArr));
            } catch (IOException e) {
