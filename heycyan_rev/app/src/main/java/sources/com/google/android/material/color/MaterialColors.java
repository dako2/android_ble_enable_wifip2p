...
public class MaterialColors {
    ...
    public static int harmonizeWithPrimary(Context context, int i) {
        return harmonize(i, getColor(context, C1174R.attr.colorPrimary, MaterialColors.class.getCanonicalName()));
    }
    ...
    static boolean isLightTheme(Context context) {
        return MaterialAttributes.resolveBoolean(context, C1174R.attr.isLightTheme, true);
    }
