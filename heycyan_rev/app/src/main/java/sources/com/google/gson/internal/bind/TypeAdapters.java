...
public final class TypeAdapters {
    ...
    static {
            ...
            */
            public BitSet read(JsonReader jsonReader) throws IOException {
                ...
                while (jsonTokenPeek != JsonToken.END_ARRAY) {
                    int i2 = C214734.$SwitchMap$com$google$gson$stream$JsonToken[jsonTokenPeek.ordinal()];
        ...
        TypeAdapter<JsonElement> typeAdapter15 = new TypeAdapter<JsonElement>() { // from class: com.google.gson.internal.bind.TypeAdapters.27
            ...
            public JsonElement read(JsonReader jsonReader) throws IOException {
                ...
                switch (C214734.$SwitchMap$com$google$gson$stream$JsonToken[jsonReader.peek().ordinal()]) {
                    case 1:
    ...
    static /* synthetic */ class C214734 {
