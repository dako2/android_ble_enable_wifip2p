...
public final class Ascii {
    ...
    /* renamed from: BS */
    public static final byte f264BS = 8;
    public static final byte CAN = 24;

    /* renamed from: CR */
    public static final byte f265CR = 13;
    ...
    /* renamed from: EM */
    public static final byte f266EM = 25;
    ...
    /* renamed from: FF */
    public static final byte f267FF = 12;

    /* renamed from: FS */
    public static final byte f268FS = 28;

    /* renamed from: GS */
    public static final byte f269GS = 29;

    /* renamed from: HT */
    public static final byte f270HT = 9;

    /* renamed from: LF */
    public static final byte f271LF = 10;
    public static final char MAX = 127;
    public static final char MIN = 0;
    public static final byte NAK = 21;

    /* renamed from: NL */
    public static final byte f272NL = 10;
    public static final byte NUL = 0;

    /* renamed from: RS */
    public static final byte f273RS = 30;

    /* renamed from: SI */
    public static final byte f274SI = 15;

    /* renamed from: SO */
    public static final byte f275SO = 14;
    public static final byte SOH = 1;

    /* renamed from: SP */
    public static final byte f276SP = 32;
    ...
    /* renamed from: US */
    public static final byte f277US = 31;

    /* renamed from: VT */
    public static final byte f278VT = 11;
    public static final byte XOFF = 19;
    public static final byte XON = 17;

    private static int getAlphaIndex(char c) {
        return (char) ((c | TokenParser.f390SP) - 97);
    }
        ...
        while (i < length) {
            if (isUpperCase(str.charAt(i))) {
                ...
                while (i < length) {
                    char c = charArray[i];
                    if (isUpperCase(c)) {
                        charArray[i] = (char) (c ^ TokenParser.f390SP);
                    }
                    i++;
                }
    ...
    public static char toLowerCase(char c) {
        return isUpperCase(c) ? (char) (c ^ TokenParser.f390SP) : c;
    }
