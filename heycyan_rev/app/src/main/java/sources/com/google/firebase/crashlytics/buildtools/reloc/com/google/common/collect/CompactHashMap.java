...
class CompactHashMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    class EntrySetView extends Maps.EntrySet<K, V> {
        ...
        public Spliterator<Map.Entry<K, V>> spliterator() {
            return CollectSpliterators.indexed(CompactHashMap.this.size, 17, new IntFunction() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.CompactHashMap$EntrySetView$$ExternalSyntheticLambda0
                @Override // java.util.function.IntFunction
                public final Object apply(int i) {
                    return this.f$0.m328xcbe4755b(i);
                }
            });
        }

        /* renamed from: lambda$spliterator$0$com-google-firebase-crashlytics-buildtools-reloc-com-google-common-collect-CompactHashMap$EntrySetView */
        /* synthetic */ Map.Entry m328xcbe4755b(int i) {
