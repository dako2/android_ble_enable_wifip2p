...
public final class DefaultHostnameVerifier implements HostnameVerifier {
    ...
    public boolean verify(String str, SSLSession sSLSession) throws CertificateParsingException, UnknownHostException {
        try {
    ...
    public void verify(String str, X509Certificate x509Certificate) throws SSLException, CertificateParsingException, UnknownHostException {
        ...
        if (subjectAltNames != null && !subjectAltNames.isEmpty()) {
            int i = C20321.f370xdc99fdb1[hostNameTypeDetermineHostFormat.ordinal()];
            if (i == 1) {
    ...
    /* renamed from: com.google.firebase.crashlytics.buildtools.reloc.org.apache.http.conn.ssl.DefaultHostnameVerifier$1 */
    static /* synthetic */ class C20321 {

        /* renamed from: $SwitchMap$org$apache$http$conn$ssl$DefaultHostnameVerifier$HostNameType */
        static final /* synthetic */ int[] f370xdc99fdb1;
        ...
        static {
            ...
            try {
                f370xdc99fdb1[HostNameType.IPv6.ordinal()] = 2;
    ...
    static void matchIPv6Address(String str, List<SubjectName> list) throws SSLException, UnknownHostException {
    ...
    static String normaliseAddress(String str) throws UnknownHostException {
        if (str == null) {
            return str;
        }
        try {
