...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    private Iterable<E> getDelegate() {
        return this.iterableDelegate.mo305or((Optional<Iterable<E>>) this);
    }
    ...
    /* renamed from: of */
    public static <E> FluentIterable<E> m329of() {
        return from(ImmutableList.m339of());
    }

    /* renamed from: of */
    public static <E> FluentIterable<E> m330of(@NullableDecl E e, E... eArr) {
    ...
    public final Optional<E> first() {
        ...
        return it.hasNext() ? Optional.m311of(it.next()) : Optional.absent();
    }
    ...
    public final Optional<E> last() {
        ...
        if (delegate instanceof List) {
            ...
            return Optional.m311of(list.get(list.size() - 1));
        }
        ...
        if (delegate instanceof SortedSet) {
            return Optional.m311of(((SortedSet) delegate).last());
        }
        do {
            next = it.next();
        } while (it.hasNext());
        return Optional.m311of(next);
    }
