...
public abstract class ByteSource {
    ...
    private final class SlicedByteSource extends ByteSource {
        ...
        public Optional<Long> sizeIfKnown() {
            ...
            if (optionalSizeIfKnown.isPresent()) {
                ...
                return Optional.m311of(Long.valueOf(Math.min(this.length, jLongValue - Math.min(this.offset, jLongValue))));
            }
            return Optional.absent();
        }
    ...
    private static class ByteArrayByteSource extends ByteSource {
        ...
        @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.p006io.ByteSource
        public Optional<Long> sizeIfKnown() {
            return Optional.m311of(Long.valueOf(this.length));
        }
    ...
    private static final class EmptyByteSource extends ByteArrayByteSource {
        ...
        @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.io.ByteSource.ByteArrayByteSource, com.google.firebase.crashlytics.buildtools.reloc.com.google.common.p006io.ByteSource
        public byte[] read() {
            return this.bytes;
        }
