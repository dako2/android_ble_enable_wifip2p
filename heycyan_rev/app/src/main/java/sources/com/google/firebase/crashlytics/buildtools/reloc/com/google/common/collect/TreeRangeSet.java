...
public class TreeRangeSet<C extends Comparable<?>> extends AbstractRangeSet<C> implements Serializable {
    ...
    static final class RangesByUpperBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        private NavigableMap<Cut<C>, Range<C>> subMap(Range<Cut<C>> range) {
            ...
            return ImmutableSortedMap.m395of();
        }
    ...
    private static final class ComplementRangesByLowerBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        Iterator<Map.Entry<Cut<C>, Range<C>>> entryIterator() {
            ...
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>(cutBelowAll, peekingIterator) { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.TreeRangeSet.ComplementRangesByLowerBound.1
        ...
        Iterator<Map.Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
            ...
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>((Cut) MoreObjects.firstNonNull(cutHigherKey, Cut.aboveAll()), peekingIterator) { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.TreeRangeSet.ComplementRangesByLowerBound.2
