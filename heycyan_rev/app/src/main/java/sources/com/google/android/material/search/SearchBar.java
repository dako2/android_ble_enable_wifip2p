...
public class SearchBar extends Toolbar {
    ...
    private static final int DEF_STYLE_RES = C1174R.style.Widget_Material3_SearchBar;
    ...
    /* synthetic */ void m885lambda$new$0$comgoogleandroidmaterialsearchSearchBar(boolean z) {
    ...
    public SearchBar(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1174R.attr.materialSearchBarStyle);
    }
    ...
    public SearchBar(Context context, AttributeSet attributeSet, int i) {
        ...
        this.touchExplorationStateChangeListener = new AccessibilityManagerCompat.TouchExplorationStateChangeListener() { // from class: com.google.android.material.search.SearchBar$$ExternalSyntheticLambda1
            ...
            public final void onTouchExplorationStateChanged(boolean z) {
                this.f$0.m885lambda$new$0$comgoogleandroidmaterialsearchSearchBar(z);
            }
        };
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C1174R.styleable.SearchBar, i, i2, new int[0]);
        ShapeAppearanceModel shapeAppearanceModelBuild = ShapeAppearanceModel.builder(context2, attributeSet, i, i2).build();
        int color = typedArrayObtainStyledAttributes.getColor(C1174R.styleable.SearchBar_backgroundTint, 0);
        float dimension = typedArrayObtainStyledAttributes.getDimension(C1174R.styleable.SearchBar_elevation, 0.0f);
        this.defaultMarginsEnabled = typedArrayObtainStyledAttributes.getBoolean(C1174R.styleable.SearchBar_defaultMarginsEnabled, true);
        this.defaultScrollFlagsEnabled = typedArrayObtainStyledAttributes.getBoolean(C1174R.styleable.SearchBar_defaultScrollFlagsEnabled, true);
        boolean z = typedArrayObtainStyledAttributes.getBoolean(C1174R.styleable.SearchBar_hideNavigationIcon, false);
        this.forceDefaultNavigationOnClickListener = typedArrayObtainStyledAttributes.getBoolean(C1174R.styleable.SearchBar_forceDefaultNavigationOnClickListener, false);
        this.tintNavigationIcon = typedArrayObtainStyledAttributes.getBoolean(C1174R.styleable.SearchBar_tintNavigationIcon, true);
        if (typedArrayObtainStyledAttributes.hasValue(C1174R.styleable.SearchBar_navigationIconTint)) {
            this.navigationIconTint = Integer.valueOf(typedArrayObtainStyledAttributes.getColor(C1174R.styleable.SearchBar_navigationIconTint, -1));
        }
        int resourceId = typedArrayObtainStyledAttributes.getResourceId(C1174R.styleable.SearchBar_android_textAppearance, -1);
        String string = typedArrayObtainStyledAttributes.getString(C1174R.styleable.SearchBar_android_text);
        String string2 = typedArrayObtainStyledAttributes.getString(C1174R.styleable.SearchBar_android_hint);
        float dimension2 = typedArrayObtainStyledAttributes.getDimension(C1174R.styleable.SearchBar_strokeWidth, -1.0f);
        int color2 = typedArrayObtainStyledAttributes.getColor(C1174R.styleable.SearchBar_strokeColor, 0);
        ...
        setClickable(true);
        setFocusable(true);
        LayoutInflater.from(context2).inflate(C1174R.layout.mtrl_search_bar, this);
        this.layoutInflated = true;
        this.textView = (TextView) findViewById(C1174R.id.open_search_bar_text_view);
    ...
    private void initTextView(int i, String str, String str2) {
        ...
        if (getNavigationIcon() == null) {
            MarginLayoutParamsCompat.setMarginStart((ViewGroup.MarginLayoutParams) this.textView.getLayoutParams(), getResources().getDimensionPixelSize(C1174R.dimen.m3_searchbar_text_margin_start_no_navigation_icon));
        }
    }
    ...
    private void initBackground(ShapeAppearanceModel shapeAppearanceModel, int i, float f, float f2, int i2) {
        ...
        int color = MaterialColors.getColor(this, C1174R.attr.colorControlHighlight);
    ...
    private Drawable maybeTintNavigationIcon(Drawable drawable) {
        ...
        if (num != null) {
            ...
            if (drawable == this.defaultNavigationIcon) {
                i = C1174R.attr.colorOnSurfaceVariant;
            } else {
                i = C1174R.attr.colorOnSurface;
            }
    ...
    private void setDefaultMargins() throws Resources.NotFoundException {
        if (this.defaultMarginsEnabled && (getLayoutParams() instanceof ViewGroup.MarginLayoutParams)) {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C1174R.dimen.m3_searchbar_margin_horizontal);
    ...
    protected int getDefaultMarginVerticalResource() {
        return C1174R.dimen.m3_searchbar_margin_vertical;
    }

    protected int getDefaultNavigationIconResource() {
        return C1174R.drawable.ic_search_black_24;
    }
