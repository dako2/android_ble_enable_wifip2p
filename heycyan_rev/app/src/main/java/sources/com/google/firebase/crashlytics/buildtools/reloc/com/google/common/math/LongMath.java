...
public final class LongMath {
    ...
    static final int[] biggestBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 3810779, 121977, 16175, 4337, 1733, 887, 534, 361, 265, 206, EMachine.EM_MAXQ30, 143, 125, EMachine.EM_EXCESS, 101, 94, 88, 83, 79, 76, 74, 72, 70, 69, 68, 67, 67, 66, 66, 66, 66};
    static final int[] biggestSimpleBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 2642246, 86251, 11724, 3218, 1313, 684, HttpStatus.SC_INSUFFICIENT_SPACE_ON_RESOURCE, 287, 214, EMachine.EM_MAXQ30, EMachine.EM_SE_C17, EMachine.EM_CE, 105, 95, 87, 81, 76, 73, 70, 68, 66, 64, 63, 62, 62, 61, 61, 61};
    ...
    /* renamed from: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.math.LongMath$1 */
    ...
    public static int log2(long j, RoundingMode roundingMode) {
        MathPreconditions.checkPositive("x", j);
        switch (C18821.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
    ...
    */
    ...
    private enum MillerRabinTester {
        ...
        /* synthetic */ MillerRabinTester(C18821 c18821) {
            this();
        }
