...
public final class IntMath {
    ...
    private static final int[] factorials = {1, 1, 2, 6, 24, EMachine.EM_M32C, 720, 5040, 40320, 362880, 3628800, 39916800, 479001600};
    static int[] biggestBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, 65536, 2345, 477, EMachine.EM_COREA_1ST, EMachine.EM_UNICORE, 75, 58, 49, 43, 39, 37, 35, 34, 34, 33};
    ...
    /* renamed from: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.math.IntMath$1 */
    ...
    public static int log2(int i, RoundingMode roundingMode) {
        MathPreconditions.checkPositive("x", i);
        switch (C18801.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
