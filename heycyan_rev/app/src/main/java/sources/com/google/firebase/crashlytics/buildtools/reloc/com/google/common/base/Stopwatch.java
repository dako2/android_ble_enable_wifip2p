...
public final class Stopwatch {
    ...
    public String toString() {
        ...
        return Platform.formatCompact4Digits(jElapsedNanos / TimeUnit.NANOSECONDS.convert(1L, r2)) + HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR + abbreviate(chooseUnit(jElapsedNanos));
    }
    ...
    /* renamed from: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Stopwatch$1 */
    ...
    private static String abbreviate(TimeUnit timeUnit) {
        switch (C15391.$SwitchMap$java$util$concurrent$TimeUnit[timeUnit.ordinal()]) {
            case 1:
                return "ns";
            case 2:
                return "μs";
