...
class StandardTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    Spliterator<Table.Cell<R, C, V>> cellSpliterator() {
        return CollectSpliterators.flatMap(this.backingMap.entrySet().spliterator(), new Function() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.StandardTable$$ExternalSyntheticLambda0
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                Map.Entry entry = (Map.Entry) obj;
                return CollectSpliterators.map(((Map) entry.getValue()).entrySet().spliterator(), new Function() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.StandardTable$$ExternalSyntheticLambda1
                    @Override // java.util.function.Function
    ...
    class Row extends Maps.IteratorBasedAbstractMap<C, V> {
        ...
        Spliterator<Map.Entry<C, V>> entrySpliterator() {
            ...
            return CollectSpliterators.map(mapBackingRowMap.entrySet().spliterator(), new Function() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.StandardTable$Row$$ExternalSyntheticLambda0
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
    ...
    private class Column extends Maps.ViewCachingAbstractMap<R, V> {
        ...
        private class EntrySet extends Sets.ImprovedAbstractSet<Map.Entry<R, V>> {
            ...
            public boolean retainAll(Collection<?> collection) {
                return Column.this.removeFromColumnIf(Predicates.not(Predicates.m312in(collection)));
            }
        }
        ...
        private class KeySet extends Maps.KeySet<R, V> {
            ...
            @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Sets.ImprovedAbstractSet, java.util.AbstractCollection, java.util.Collection, java.util.Set
            public boolean retainAll(Collection<?> collection) {
                return Column.this.removeFromColumnIf(Maps.keyPredicateOnEntries(Predicates.not(Predicates.m312in(collection))));
            }
        }
        ...
        private class Values extends Maps.Values<R, V> {
            ...
            public boolean removeAll(Collection<?> collection) {
                return Column.this.removeFromColumnIf(Maps.valuePredicateOnEntries(Predicates.m312in(collection)));
            }

            @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.Values, java.util.AbstractCollection, java.util.Collection
            public boolean retainAll(Collection<?> collection) {
                return Column.this.removeFromColumnIf(Maps.valuePredicateOnEntries(Predicates.not(Predicates.m312in(collection))));
            }
        }
    }
    ...
    class RowMap extends Maps.ViewCachingAbstractMap<R, Map<C, V>> {
        ...
        class EntrySet extends StandardTable<R, C, V>.TableSet<Map.Entry<R, Map<C, V>>> {
            ...
            public Iterator<Map.Entry<R, Map<C, V>>> iterator() {
                return Maps.asMapEntryIterator(StandardTable.this.backingMap.keySet(), new com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Function<R, Map<C, V>>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.StandardTable.RowMap.EntrySet.1
                    @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Function, java.util.function.Function
                    public /* bridge */ /* synthetic */ Object apply(Object obj) {
                        return apply((C17531) obj);
                    }
    ...
    private class ColumnMap extends Maps.ViewCachingAbstractMap<C, Map<R, V>> {
        ...
        class ColumnMapEntrySet extends StandardTable<R, C, V>.TableSet<Map.Entry<C, Map<R, V>>> {
            ...
            public Iterator<Map.Entry<C, Map<R, V>>> iterator() {
                return Maps.asMapEntryIterator(StandardTable.this.columnKeySet(), new com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Function<C, Map<R, V>>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.StandardTable.ColumnMap.ColumnMapEntrySet.1
                    @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Function, java.util.function.Function
                    public /* bridge */ /* synthetic */ Object apply(Object obj) {
                        return apply((C17501) obj);
                    }
