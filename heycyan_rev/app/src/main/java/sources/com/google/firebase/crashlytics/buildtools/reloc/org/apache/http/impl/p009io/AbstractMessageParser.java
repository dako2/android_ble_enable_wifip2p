...
public abstract class AbstractMessageParser<T extends HttpMessage> implements HttpMessageParser<T> {
    ...
    protected abstract T parseHead(SessionInputBuffer sessionInputBuffer) throws ParseException, HttpException, IOException;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:37:0x008d, code lost:
        ...
        r8 = new com.google.firebase.crashlytics.buildtools.reloc.org.apache.http.Header[r12.size()];
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:45:0x00b2, code lost:
        ...
        throw new com.google.firebase.crashlytics.buildtools.reloc.org.apache.http.ProtocolException(r8.getMessage());
     */
    ...
    */
    public static Header[] parseHeaders(SessionInputBuffer sessionInputBuffer, int i, int i2, LineParser lineParser, List<CharArrayBuffer> list) throws HttpException, IOException {
        ...
        while (true) {
            ...
            if ((charArrayBuffer.charAt(0) == ' ' || charArrayBuffer.charAt(0) == '\t') && charArrayBuffer2 != null) {
                ...
                charArrayBuffer2.append(TokenParser.f390SP);
    ...
    @Override // com.google.firebase.crashlytics.buildtools.reloc.org.apache.http.p010io.HttpMessageParser
