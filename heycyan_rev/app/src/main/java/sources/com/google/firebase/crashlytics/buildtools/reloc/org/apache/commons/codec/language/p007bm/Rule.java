...
public class Rule {
    ...
    private static Scanner createScanner(String str) {
        String str2 = String.format("com/google/firebase/crashlytics/buildtools/reloc/org/apache/commons/codec/language/bm/%s.txt", str);
        ...
        while (scanner.hasNextLine()) {
            ...
            if (i4 != 0) {
                ...
                if (strTrim.length() == 0) {
                    ...
                    if (strTrim2.contains(HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR)) {
                    ...
                    try {
                        ...
                        str2 = "' in ";
                        try {
                            Rule rule = new Rule(strStripQuotes, strStripQuotes2, strStripQuotes3, parsePhonemeExpr(stripQuotes(strArrSplit[3])), i5, str, strStripQuotes, strStripQuotes2, strStripQuotes3) { // from class: com.google.firebase.crashlytics.buildtools.reloc.org.apache.commons.codec.language.bm.Rule.2
