...
public final class Predicates {
    ...
    /* renamed from: or */
    public static <T> Predicate<T> m314or(Iterable<? extends Predicate<? super T>> iterable) {
        return new OrPredicate(defensiveCopy(iterable));
    }

    @SafeVarargs
    /* renamed from: or */
    public static <T> Predicate<T> m315or(Predicate<? super T>... predicateArr) {
        return new OrPredicate(defensiveCopy(predicateArr));
    }

    /* renamed from: or */
    public static <T> Predicate<T> m313or(Predicate<? super T> predicate, Predicate<? super T> predicate2) {
    ...
    /* renamed from: in */
    public static <T> Predicate<T> m312in(Collection<? extends T> collection) {
    ...
    private static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        ...
        /* renamed from: f */
        final Function<A, ? extends B> f281f;

        /* renamed from: p */
        final Predicate<B> f282p;

        private CompositionPredicate(Predicate<B> predicate, Function<A, ? extends B> function) {
            this.f282p = (Predicate) Preconditions.checkNotNull(predicate);
            this.f281f = (Function) Preconditions.checkNotNull(function);
        }

        @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Predicate
        public boolean apply(@NullableDecl A a) {
            return this.f282p.apply(this.f281f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            return this.f281f.equals(compositionPredicate.f281f) && this.f282p.equals(compositionPredicate.f282p);
        }

        public int hashCode() {
            return this.f281f.hashCode() ^ this.f282p.hashCode();
        }

        public String toString() {
            return this.f282p + "(" + this.f281f + ")";
        }
    }
