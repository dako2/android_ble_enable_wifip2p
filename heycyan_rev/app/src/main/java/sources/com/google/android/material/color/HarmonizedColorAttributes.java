...
public final class HarmonizedColorAttributes {
    private static final int[] HARMONIZED_MATERIAL_ATTRIBUTES = {C1174R.attr.colorError, C1174R.attr.colorOnError, C1174R.attr.colorErrorContainer, C1174R.attr.colorOnErrorContainer};
    ...
    public static HarmonizedColorAttributes createMaterialDefaults() {
        return create(HARMONIZED_MATERIAL_ATTRIBUTES, C1174R.style.ThemeOverlay_Material3_HarmonizedColors);
    }
