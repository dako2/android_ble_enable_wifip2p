...
public class MaterialToolbar extends Toolbar {
    private static final int DEF_STYLE_RES = C1174R.style.Widget_MaterialComponents_Toolbar;
    ...
    public MaterialToolbar(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1174R.attr.toolbarStyle);
    }
    ...
    public MaterialToolbar(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C1174R.styleable.MaterialToolbar, i, i2, new int[0]);
        if (typedArrayObtainStyledAttributes.hasValue(C1174R.styleable.MaterialToolbar_navigationIconTint)) {
            setNavigationIconTint(typedArrayObtainStyledAttributes.getColor(C1174R.styleable.MaterialToolbar_navigationIconTint, -1));
        }
        this.titleCentered = typedArrayObtainStyledAttributes.getBoolean(C1174R.styleable.MaterialToolbar_titleCentered, false);
        this.subtitleCentered = typedArrayObtainStyledAttributes.getBoolean(C1174R.styleable.MaterialToolbar_subtitleCentered, false);
        int i3 = typedArrayObtainStyledAttributes.getInt(C1174R.styleable.MaterialToolbar_logoScaleType, -1);
        if (i3 >= 0) {
        ...
        if (typedArrayObtainStyledAttributes.hasValue(C1174R.styleable.MaterialToolbar_logoAdjustViewBounds)) {
            this.logoAdjustViewBounds = Boolean.valueOf(typedArrayObtainStyledAttributes.getBoolean(C1174R.styleable.MaterialToolbar_logoAdjustViewBounds, false));
        }
