...
public abstract class CaseFormat {
    ...
    static {
        CaseFormat caseFormat = new CaseFormat("LOWER_HYPHEN", 0, CharMatcher.m307is('-'), HelpFormatter.DEFAULT_OPT_PREFIX) { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.CaseFormat.1
        ...
        String str = "_";
        CaseFormat caseFormat2 = new CaseFormat("LOWER_UNDERSCORE", 1, CharMatcher.m307is('_'), str) { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.CaseFormat.2
            @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.CaseFormat
        ...
        CaseFormat caseFormat5 = new CaseFormat("UPPER_UNDERSCORE", 4, CharMatcher.m307is('_'), str) { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.CaseFormat.5
            @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.CaseFormat
            String normalizeWord(String str3) {
    ...
    /* renamed from: to */
    public final String m306to(CaseFormat caseFormat, String str) {
    ...
    private static final class StringConverter extends Converter<String, String> implements Serializable {
        ...
        public String doForward(String str) {
            return this.sourceFormat.m306to(this.targetFormat, str);
        }

        /* JADX INFO: Access modifiers changed from: protected */
        @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Converter
        public String doBackward(String str) {
            return this.targetFormat.m306to(this.sourceFormat, str);
        }
