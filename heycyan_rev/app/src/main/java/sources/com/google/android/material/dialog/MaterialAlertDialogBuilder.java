...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    private static final int DEF_STYLE_ATTR = C1174R.attr.alertDialogStyle;
    private static final int DEF_STYLE_RES = C1174R.style.MaterialAlertDialog_MaterialComponents;
    private static final int MATERIAL_ALERT_DIALOG_THEME_OVERLAY = C1174R.attr.materialAlertDialogTheme;
    ...
    public MaterialAlertDialogBuilder(Context context, int i) {
        ...
        int color = MaterialColors.getColor(context2, C1174R.attr.colorSurface, getClass().getCanonicalName());
        TypedArray typedArrayObtainStyledAttributes = context2.obtainStyledAttributes(null, C1174R.styleable.MaterialAlertDialog, i2, i3);
        int color2 = typedArrayObtainStyledAttributes.getColor(C1174R.styleable.MaterialAlertDialog_backgroundTint, color);
