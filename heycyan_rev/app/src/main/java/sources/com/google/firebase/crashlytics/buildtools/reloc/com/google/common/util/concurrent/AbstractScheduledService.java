...
public abstract class AbstractScheduledService implements Service {
    ...
    private final class ServiceDelegate extends AbstractService {
        ...
        protected final void doStart() {
            this.executorService = MoreExecutors.renamingDecorator(AbstractScheduledService.this.executor(), new Supplier<String>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.util.concurrent.AbstractScheduledService.ServiceDelegate.1
                ...
                public String get() {
                    return AbstractScheduledService.this.serviceName() + HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR + ServiceDelegate.this.state();
                }
            });
    ...
    protected ScheduledExecutorService executor() {
        final ScheduledExecutorService scheduledExecutorServiceNewSingleThreadScheduledExecutor = Executors.newSingleThreadScheduledExecutor(new ThreadFactory() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.util.concurrent.AbstractScheduledService.1ThreadFactoryImpl
