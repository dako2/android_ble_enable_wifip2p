...
public class HttpServer {
    ...
    public void start() throws IOException {
        if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m47m(this.status, Status.READY, Status.ACTIVE)) {
    ...
    public void stop() {
        if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m47m(this.status, Status.ACTIVE, Status.STOPPING)) {
