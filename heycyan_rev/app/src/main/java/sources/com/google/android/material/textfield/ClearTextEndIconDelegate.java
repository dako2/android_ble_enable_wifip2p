...
class ClearTextEndIconDelegate extends EndIconDelegate {
    ...
    /* synthetic */ void m284xfc81bd94(View view) {
    ...
    /* synthetic */ void m285x7ae2c173(View view, boolean z) {
    ...
    ClearTextEndIconDelegate(EndCompoundLayout endCompoundLayout) {
        ...
        this.onFocusChangeListener = new View.OnFocusChangeListener() { // from class: com.google.android.material.textfield.ClearTextEndIconDelegate$$ExternalSyntheticLambda1
            ...
            public final void onFocusChange(View view, boolean z) {
                this.f$0.m285x7ae2c173(view, z);
            }
        };
        this.animationFadeDuration = MotionUtils.resolveThemeDuration(endCompoundLayout.getContext(), C1174R.attr.motionDurationShort3, 100);
        this.animationScaleDuration = MotionUtils.resolveThemeDuration(endCompoundLayout.getContext(), C1174R.attr.motionDurationShort3, 150);
        ...
        this.animationScaleInterpolator = MotionUtils.resolveThemeInterpolator(endCompoundLayout.getContext(), C1174R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR);
    }
    ...
    /* synthetic */ void m286x26d8c5f4() {
        animateIcon(true);
    }

    @Override // com.google.android.material.textfield.EndIconDelegate
    int getIconDrawableResId() {
        return C1174R.drawable.mtrl_ic_cancel;
    }

    @Override // com.google.android.material.textfield.EndIconDelegate
    int getIconContentDescriptionResId() {
        return C1174R.string.clear_text_end_icon_content_description;
    }
    ...
    private ValueAnimator getAlphaAnimator(float... fArr) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.textfield.ClearTextEndIconDelegate$$ExternalSyntheticLambda2
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m282xa5c23ba8(valueAnimator);
            }
        });
    ...
    /* synthetic */ void m282xa5c23ba8(ValueAnimator valueAnimator) {
    ...
    private ValueAnimator getScaleAnimator() {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.textfield.ClearTextEndIconDelegate$$ExternalSyntheticLambda4
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m283x3819711b(valueAnimator);
            }
        });
        return valueAnimatorOfFloat;
    }
    ...
    /* synthetic */ void m283x3819711b(ValueAnimator valueAnimator) {
