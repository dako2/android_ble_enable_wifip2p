...
public final class Multimaps {
    ...
    public static <T, K, V, M extends Multimap<K, V>> Collector<T, ?, M> toMultimap(final Function<? super T, ? extends K> function, final Function<? super T, ? extends V> function2, Supplier<M> supplier) {
        ...
        return Collector.of(supplier, new BiConsumer() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Multimaps$$ExternalSyntheticLambda1
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
                ((Multimap) obj).put(function.apply(obj2), function2.apply(obj2));
            }
        }, new BinaryOperator() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Multimaps$$ExternalSyntheticLambda2
    ...
    public static <T, K, V, M extends Multimap<K, V>> Collector<T, ?, M> flatteningToMultimap(final Function<? super T, ? extends K> function, final Function<? super T, ? extends Stream<? extends V>> function2, Supplier<M> supplier) {
        ...
        Preconditions.checkNotNull(function2);
        Preconditions.checkNotNull(supplier);
        return Collector.of(supplier, new BiConsumer() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Multimaps$$ExternalSyntheticLambda3
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
                Multimaps.lambda$flatteningToMultimap$2(function, function2, (Multimap) obj, obj2);
            }
        }, new BinaryOperator() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Multimaps$$ExternalSyntheticLambda4
            @Override // java.util.function.BiFunction
            public final Object apply(Object obj, Object obj2) {
    ...
    static /* synthetic */ void lambda$flatteningToMultimap$2(Function function, Function function2, Multimap multimap, Object obj) {
        ...
        collection.getClass();
        stream.forEachOrdered(new Consumer() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Multimaps$$ExternalSyntheticLambda0
    ...
    public static <K, V> Multimap<K, V> newMultimap(Map<K, Collection<V>> map, com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Supplier<? extends Collection<V>> supplier) {
        return new CustomMultimap(map, supplier);
    }

    private static class CustomMultimap<K, V> extends AbstractMapBasedMultimap<K, V> {
        private static final long serialVersionUID = 0;
        transient com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Supplier<? extends Collection<V>> factory;

        CustomMultimap(Map<K, Collection<V>> map, com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Supplier<? extends Collection<V>> supplier) {
            super(map);
            this.factory = (com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Supplier) Preconditions.checkNotNull(supplier);
        }
        ...
        private void readObject(ObjectInputStream objectInputStream) throws ClassNotFoundException, IOException {
            ...
            this.factory = (com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Supplier) objectInputStream.readObject();
            setMap((Map) objectInputStream.readObject());
        }
    }

    public static <K, V> ListMultimap<K, V> newListMultimap(Map<K, Collection<V>> map, com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Supplier<? extends List<V>> supplier) {
        return new CustomListMultimap(map, supplier);
    }

    private static class CustomListMultimap<K, V> extends AbstractListMultimap<K, V> {
        private static final long serialVersionUID = 0;
        transient com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Supplier<? extends List<V>> factory;

        CustomListMultimap(Map<K, Collection<V>> map, com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Supplier<? extends List<V>> supplier) {
            super(map);
            this.factory = (com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Supplier) Preconditions.checkNotNull(supplier);
        }
    ...
    public static <K, V> SetMultimap<K, V> newSetMultimap(Map<K, Collection<V>> map, com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Supplier<? extends Set<V>> supplier) {
        return new CustomSetMultimap(map, supplier);
    }

    private static class CustomSetMultimap<K, V> extends AbstractSetMultimap<K, V> {
        private static final long serialVersionUID = 0;
        transient com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Supplier<? extends Set<V>> factory;

        CustomSetMultimap(Map<K, Collection<V>> map, com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Supplier<? extends Set<V>> supplier) {
            super(map);
            this.factory = (com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Supplier) Preconditions.checkNotNull(supplier);
        }
    ...
    public static <K, V> SortedSetMultimap<K, V> newSortedSetMultimap(Map<K, Collection<V>> map, com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Supplier<? extends SortedSet<V>> supplier) {
        return new CustomSortedSetMultimap(map, supplier);
    }

    private static class CustomSortedSetMultimap<K, V> extends AbstractSortedSetMultimap<K, V> {
        private static final long serialVersionUID = 0;
        transient com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Supplier<? extends SortedSet<V>> factory;
        transient Comparator<? super V> valueComparator;

        CustomSortedSetMultimap(Map<K, Collection<V>> map, com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Supplier<? extends SortedSet<V>> supplier) {
            super(map);
            this.factory = (com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Supplier) Preconditions.checkNotNull(supplier);
        ...
        private void readObject(ObjectInputStream objectInputStream) throws ClassNotFoundException, IOException {
            objectInputStream.defaultReadObject();
            com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Supplier<? extends SortedSet<V>> supplier = (com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Supplier) objectInputStream.readObject();
    ...
    private static class UnmodifiableMultimap<K, V> extends ForwardingMultimap<K, V> implements Serializable {
        ...
        public Map<K, Collection<V>> asMap() {
            ...
            Map<K, Collection<V>> mapUnmodifiableMap = Collections.unmodifiableMap(Maps.transformValues(this.delegate.asMap(), new com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Function<Collection<V>, Collection<V>>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Multimaps.UnmodifiableMultimap.1
                ...
                public Iterator<V> iterator() {
                    return new Iterator<V>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Multimaps.MapMultimap.1.1
                        ...
                        public boolean hasNext() {
                            return this.f305i == 0 && MapMultimap.this.map.containsKey(k);
                        }
                        ...
                        @Override // java.util.Iterator
                        public void remove() {
                            CollectPreconditions.checkRemove(this.f305i == 1);
                            this.f305i = -1;
    ...
    public static <K, V1, V2> Multimap<K, V2> transformValues(Multimap<K, V1> multimap, com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Function<? super V1, V2> function) {
        Preconditions.checkNotNull(function);
        return transformEntries(multimap, Maps.asEntryTransformer(function));
    }

    public static <K, V1, V2> ListMultimap<K, V2> transformValues(ListMultimap<K, V1> listMultimap, com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Function<? super V1, V2> function) {
        Preconditions.checkNotNull(function);
    ...
    private static class TransformedEntriesMultimap<K, V1, V2> extends AbstractMultimap<K, V2> {
        ...
        Collection<V2> transform(K k, Collection<V1> collection) {
            com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Function functionAsValueToValueFunction = Maps.asValueToValueFunction(this.transformer, k);
            if (collection instanceof List) {
        ...
        Map<K, Collection<V2>> createAsMap() {
            return Maps.transformEntries(this.fromMultimap.asMap(), new Maps.EntryTransformer<K, Collection<V1>, Collection<V2>>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Multimaps.TransformedEntriesMultimap.1
                ...
                public /* bridge */ /* synthetic */ Object transformEntry(Object obj, Object obj2) {
                    return transformEntry((C17131) obj, (Collection) obj2);
                }
    ...
    public static <K, V> ImmutableListMultimap<K, V> index(Iterable<V> iterable, com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Function<? super V, K> function) {
        return index(iterable.iterator(), function);
    }

    public static <K, V> ImmutableListMultimap<K, V> index(Iterator<V> it, com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Function<? super V, K> function) {
        Preconditions.checkNotNull(function);
    ...
    static class Keys<K, V> extends AbstractMultiset<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            this.multimap.entries().forEach(new Consumer() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Multimaps$Keys$$ExternalSyntheticLambda0
                @Override // java.util.function.Consumer
    ...
    static final class AsMap<K, V> extends Maps.ViewCachingAbstractMap<K, Collection<V>> {
        ...
        class EntrySet extends Maps.EntrySet<K, Collection<V>> {
            ...
            public Iterator<Map.Entry<K, Collection<V>>> iterator() {
                return Maps.asMapEntryIterator(AsMap.this.multimap.keySet(), new com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Function<K, Collection<V>>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Multimaps.AsMap.EntrySet.1
                    @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Function, java.util.function.Function
                    public /* bridge */ /* synthetic */ Object apply(Object obj) {
                        return apply((C17101) obj);
                    }
