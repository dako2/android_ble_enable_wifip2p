...
import com.google.firebase.crashlytics.buildtools.reloc.org.apache.http.client.methods.AbortableHttpRequest;
...
import com.google.firebase.crashlytics.buildtools.reloc.org.apache.http.conn.BasicManagedEntity;
                        ...
                        if (zKeepAlive) {
                            ...
                            if (this.log.isDebugEnabled()) {
                                if (keepAliveDuration > 0) {
                                    str = "for " + keepAliveDuration + HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR + TimeUnit.MILLISECONDS;
                                } else {
                                    str = "indefinitely";
                                }
