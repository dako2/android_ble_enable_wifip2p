...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    static class Segment<K, V> extends ReentrantLock {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:28:0x00a2, code lost:
            ...
            r15 = new com.google.firebase.crashlytics.buildtools.reloc.com.google.common.cache.LocalCache.LoadingValueReference<>();
         */
        ...
        */
        ...
        ListenableFuture<V> loadAsync(final K k, final int i, final LoadingValueReference<K, V> loadingValueReference, CacheLoader<? super K, V> cacheLoader) {
            ...
            listenableFutureLoadFuture.addListener(new Runnable() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.cache.LocalCache.Segment.1
                /* JADX WARN: Multi-variable type inference failed */
        ...
        */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:19:0x006d, code lost:
            ...
            if (r13 != com.google.firebase.crashlytics.buildtools.reloc.com.google.common.cache.RemovalCause.EXPLICIT) goto L21;
         */
    ...
    static class LoadingValueReference<K, V> implements ValueReference<K, V> {
        ...
        public ListenableFuture<V> loadFuture(K k, CacheLoader<? super K, V> cacheLoader) {
            try {
                ...
                return Futures.transform(listenableFutureReload, new Function<V, V>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.cache.LocalCache.LoadingValueReference.1
        ...
        public V compute(K k, BiFunction<? super K, ? super V, ? extends V> biFunction) {
            Manifest.permission permissionVarWaitForValue;
            this.stopwatch.start();
            try {
                permissionVarWaitForValue = this.oldValue.waitForValue();
            } catch (ExecutionException unused) {
                permissionVarWaitForValue = null;
            }
            V vApply = biFunction.apply(k, permissionVarWaitForValue);
            set(vApply);
            return vApply;
        }
    ...
    */
    ...
    public V computeIfAbsent(final K k, final java.util.function.Function<? super K, ? extends V> function) {
        ...
        return compute(k, new BiFunction() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.cache.LocalCache$$ExternalSyntheticLambda0
    ...
    public V computeIfPresent(K k, final BiFunction<? super K, ? super V, ? extends V> biFunction) {
        Preconditions.checkNotNull(k);
        Preconditions.checkNotNull(biFunction);
        return compute(k, new BiFunction() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.cache.LocalCache$$ExternalSyntheticLambda2
            @Override // java.util.function.BiFunction
            public final Object apply(Object obj, Object obj2) {
    ...
    public V merge(K k, final V v, final BiFunction<? super V, ? super V, ? extends V> biFunction) {
        ...
        Preconditions.checkNotNull(v);
        Preconditions.checkNotNull(biFunction);
        return compute(k, new BiFunction() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.cache.LocalCache$$ExternalSyntheticLambda1
            @Override // java.util.function.BiFunction
            public final Object apply(Object obj, Object obj2) {
    ...
    final class Values extends AbstractCollection<V> {
        ...
        public boolean removeIf(final Predicate<? super V> predicate) {
            ...
            return LocalCache.this.removeIf(new BiPredicate() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.cache.LocalCache$Values$$ExternalSyntheticLambda0
    ...
    final class EntrySet extends LocalCache<K, V>.AbstractCacheSet<Map.Entry<K, V>> {
        ...
        public boolean removeIf(final Predicate<? super Map.Entry<K, V>> predicate) {
            Preconditions.checkNotNull(predicate);
            return LocalCache.this.removeIf(new BiPredicate() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.cache.LocalCache$EntrySet$$ExternalSyntheticLambda0
                @Override // java.util.function.BiPredicate
                public final boolean test(Object obj, Object obj2) {
