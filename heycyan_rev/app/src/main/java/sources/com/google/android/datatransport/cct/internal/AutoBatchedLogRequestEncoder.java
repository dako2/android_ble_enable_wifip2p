...
public final class AutoBatchedLogRequestEncoder implements Configurator {
    ...
    private static final class BatchedLogRequestEncoder implements ObjectEncoder<BatchedLogRequest> {
        ...
        private static final FieldDescriptor LOGREQUEST_DESCRIPTOR = FieldDescriptor.m495of("logRequest");
    ...
    private static final class LogRequestEncoder implements ObjectEncoder<LogRequest> {
        ...
        private static final FieldDescriptor REQUESTTIMEMS_DESCRIPTOR = FieldDescriptor.m495of("requestTimeMs");
        private static final FieldDescriptor REQUESTUPTIMEMS_DESCRIPTOR = FieldDescriptor.m495of("requestUptimeMs");
        private static final FieldDescriptor CLIENTINFO_DESCRIPTOR = FieldDescriptor.m495of("clientInfo");
        private static final FieldDescriptor LOGSOURCE_DESCRIPTOR = FieldDescriptor.m495of("logSource");
        private static final FieldDescriptor LOGSOURCENAME_DESCRIPTOR = FieldDescriptor.m495of("logSourceName");
        private static final FieldDescriptor LOGEVENT_DESCRIPTOR = FieldDescriptor.m495of("logEvent");
        private static final FieldDescriptor QOSTIER_DESCRIPTOR = FieldDescriptor.m495of("qosTier");
    ...
    private static final class ClientInfoEncoder implements ObjectEncoder<ClientInfo> {
        ...
        private static final FieldDescriptor CLIENTTYPE_DESCRIPTOR = FieldDescriptor.m495of("clientType");
        private static final FieldDescriptor ANDROIDCLIENTINFO_DESCRIPTOR = FieldDescriptor.m495of("androidClientInfo");
    ...
    private static final class AndroidClientInfoEncoder implements ObjectEncoder<AndroidClientInfo> {
        ...
        private static final FieldDescriptor SDKVERSION_DESCRIPTOR = FieldDescriptor.m495of("sdkVersion");
        private static final FieldDescriptor MODEL_DESCRIPTOR = FieldDescriptor.m495of("model");
        private static final FieldDescriptor HARDWARE_DESCRIPTOR = FieldDescriptor.m495of("hardware");
        private static final FieldDescriptor DEVICE_DESCRIPTOR = FieldDescriptor.m495of("device");
        private static final FieldDescriptor PRODUCT_DESCRIPTOR = FieldDescriptor.m495of("product");
        private static final FieldDescriptor OSBUILD_DESCRIPTOR = FieldDescriptor.m495of("osBuild");
        private static final FieldDescriptor MANUFACTURER_DESCRIPTOR = FieldDescriptor.m495of("manufacturer");
        private static final FieldDescriptor FINGERPRINT_DESCRIPTOR = FieldDescriptor.m495of("fingerprint");
        private static final FieldDescriptor LOCALE_DESCRIPTOR = FieldDescriptor.m495of("locale");
        private static final FieldDescriptor COUNTRY_DESCRIPTOR = FieldDescriptor.m495of("country");
        private static final FieldDescriptor MCCMNC_DESCRIPTOR = FieldDescriptor.m495of("mccMnc");
        private static final FieldDescriptor APPLICATIONBUILD_DESCRIPTOR = FieldDescriptor.m495of("applicationBuild");
    ...
    private static final class LogEventEncoder implements ObjectEncoder<LogEvent> {
        ...
        private static final FieldDescriptor EVENTTIMEMS_DESCRIPTOR = FieldDescriptor.m495of("eventTimeMs");
        private static final FieldDescriptor EVENTCODE_DESCRIPTOR = FieldDescriptor.m495of("eventCode");
        private static final FieldDescriptor EVENTUPTIMEMS_DESCRIPTOR = FieldDescriptor.m495of("eventUptimeMs");
        private static final FieldDescriptor SOURCEEXTENSION_DESCRIPTOR = FieldDescriptor.m495of("sourceExtension");
        private static final FieldDescriptor SOURCEEXTENSIONJSONPROTO3_DESCRIPTOR = FieldDescriptor.m495of("sourceExtensionJsonProto3");
        private static final FieldDescriptor TIMEZONEOFFSETSECONDS_DESCRIPTOR = FieldDescriptor.m495of("timezoneOffsetSeconds");
        private static final FieldDescriptor NETWORKCONNECTIONINFO_DESCRIPTOR = FieldDescriptor.m495of("networkConnectionInfo");
    ...
    private static final class NetworkConnectionInfoEncoder implements ObjectEncoder<NetworkConnectionInfo> {
        ...
        private static final FieldDescriptor NETWORKTYPE_DESCRIPTOR = FieldDescriptor.m495of("networkType");
        private static final FieldDescriptor MOBILESUBTYPE_DESCRIPTOR = FieldDescriptor.m495of("mobileSubtype");
