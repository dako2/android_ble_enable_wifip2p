...
final class SubscriberRegistry {
    ...
    private static final LoadingCache<Class<?>, ImmutableSet<Class<?>>> flattenHierarchyCache = CacheBuilder.newBuilder().weakKeys().build(new CacheLoader<Class<?>, ImmutableSet<Class<?>>>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.eventbus.SubscriberRegistry.2
        ...
        public ImmutableSet<Class<?>> load(Class<?> cls) {
            return ImmutableSet.copyOf((Collection) TypeToken.m486of((Class) cls).getTypes().rawTypes());
        }
    });
    ...
    Set<Subscriber> getSubscribersForTesting(Class<?> cls) {
        return (Set) MoreObjects.firstNonNull(this.subscribers.get(cls), ImmutableSet.m382of());
    }
    ...
    public static ImmutableList<Method> getAnnotatedMethodsNotCached(Class<?> cls) throws SecurityException {
        Set setRawTypes = TypeToken.m486of((Class) cls).getTypes().rawTypes();
