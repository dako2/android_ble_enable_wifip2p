...
public final class BloomFilter<T> implements Predicate<T>, Serializable {
    ...
    public static <T> Collector<T, ?, BloomFilter<T>> toBloomFilter(final Funnel<? super T> funnel, final long j, final double d) {
        ...
        return Collector.of(new Supplier() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.hash.BloomFilter$$ExternalSyntheticLambda0
