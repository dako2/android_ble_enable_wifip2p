...
public class MlKitContext {
    ...
    public static MlKitContext initialize(Context context, List<ComponentRegistrar> list) {
        ...
        synchronized (zza) {
            ...
            zzb = mlKitContext2;
            ComponentRuntime componentRuntime = new ComponentRuntime(TaskExecutors.MAIN_THREAD, list, (Component<?>[]) new Component[]{Component.m301of(zzb(context), Context.class, new Class[0]), Component.m301of(mlKitContext2, MlKitContext.class, new Class[0])});
    ...
    public static MlKitContext zza(Context context) {
        ...
        synchronized (zza) {
            ...
            ComponentRuntime componentRuntimeBuild = ComponentRuntime.builder(TaskExecutors.MAIN_THREAD).addLazyComponentRegistrars(ComponentDiscovery.forContext(contextZzb, MlKitComponentDiscoveryService.class).discoverLazy()).addComponent(Component.m301of(contextZzb, Context.class, new Class[0])).addComponent(Component.m301of(mlKitContext2, MlKitContext.class, new Class[0])).build();
