...
public final class GmsLogger {
    ...
    /* renamed from: d */
    public void m187d(String str, String str2) {
        if (canLog(3)) {
            Log.d(str, zza(str2));
        }
    }
    ...
    /* renamed from: e */
    public void m189e(String str, String str2) {
        if (canLog(6)) {
            Log.e(str, zza(str2));
        }
    }
    ...
    /* renamed from: i */
    public void m191i(String str, String str2) {
        if (canLog(4)) {
            Log.i(str, zza(str2));
        }
    }
    ...
    /* renamed from: v */
    public void m193v(String str, String str2) {
        if (canLog(2)) {
            Log.v(str, zza(str2));
        }
    }
    ...
    /* renamed from: w */
    public void m195w(String str, String str2) {
        if (canLog(5)) {
            Log.w(str, zza(str2));
        }
    }
    ...
    /* renamed from: d */
    public void m188d(String str, String str2, Throwable th) {
        if (canLog(3)) {
    ...
    /* renamed from: e */
    public void m190e(String str, String str2, Throwable th) {
        if (canLog(6)) {
            Log.e(str, zza(str2), th);
        }
    }
    ...
    /* renamed from: i */
    public void m192i(String str, String str2, Throwable th) {
        if (canLog(4)) {
    ...
    /* renamed from: v */
    public void m194v(String str, String str2, Throwable th) {
        if (canLog(2)) {
    ...
    /* renamed from: w */
    public void m196w(String str, String str2, Throwable th) {
        if (canLog(5)) {
