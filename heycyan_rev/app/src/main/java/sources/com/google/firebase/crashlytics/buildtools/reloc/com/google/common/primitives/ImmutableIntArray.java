...
public final class ImmutableIntArray implements Serializable {
    ...
    /* renamed from: of */
    public static ImmutableIntArray m467of() {
        return EMPTY;
    }

    /* renamed from: of */
    public static ImmutableIntArray m468of(int i) {
        return new ImmutableIntArray(new int[]{i});
    }

    /* renamed from: of */
    public static ImmutableIntArray m469of(int i, int i2) {
        return new ImmutableIntArray(new int[]{i, i2});
    }

    /* renamed from: of */
    public static ImmutableIntArray m470of(int i, int i2, int i3) {
        return new ImmutableIntArray(new int[]{i, i2, i3});
    }

    /* renamed from: of */
    public static ImmutableIntArray m471of(int i, int i2, int i3, int i4) {
        return new ImmutableIntArray(new int[]{i, i2, i3, i4});
    }

    /* renamed from: of */
    public static ImmutableIntArray m472of(int i, int i2, int i3, int i4, int i5) {
        return new ImmutableIntArray(new int[]{i, i2, i3, i4, i5});
    }

    /* renamed from: of */
    public static ImmutableIntArray m473of(int i, int i2, int i3, int i4, int i5, int i6) {
        return new ImmutableIntArray(new int[]{i, i2, i3, i4, i5, i6});
    }

    /* renamed from: of */
    public static ImmutableIntArray m474of(int i, int... iArr) {
    ...
    public static final class Builder {
        ...
        public Builder addAll(IntStream intStream) {
            ...
            Spliterator.forEachRemaining(new IntConsumer() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.primitives.ImmutableIntArray$Builder$$ExternalSyntheticLambda0
