...
public final class ArrayTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    static abstract class ArrayMap<K, V> extends Maps.IteratorBasedAbstractMap<K, V> {
        ...
        Spliterator<Map.Entry<K, V>> entrySpliterator() {
            return CollectSpliterators.indexed(size(), 16, new IntFunction() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.ArrayTable$ArrayMap$$ExternalSyntheticLambda0
        ...
        public V put(K k, V v) {
            ...
            if (num == null) {
                throw new IllegalArgumentException(getKeyRole() + HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR + k + " not in " + this.keyIndex.keySet());
            }
    ...
    public V get(@NullableDecl Object obj, @NullableDecl Object obj2) {
        ...
        return m322at(num.intValue(), num2.intValue());
    }
    ...
    Spliterator<Table.Cell<R, C, V>> cellSpliterator() {
        return CollectSpliterators.indexed(size(), 273, new IntFunction() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.ArrayTable$$ExternalSyntheticLambda0
            @Override // java.util.function.IntFunction
            public final Object apply(int i) {
    ...
    public Table.Cell<R, C, V> getCell(int i) {
        return new Tables.AbstractCell<R, C, V>(i) { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.ArrayTable.2
            ...
            @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Table.Cell
            public V getValue() {
                return (V) ArrayTable.this.m322at(this.rowIndex, this.columnIndex);
            }
        };
    }
    ...
    public V getValue(int i) {
        return m322at(i / this.columnList.size(), i % this.columnList.size());
    }
    ...
    public Map<R, V> column(C c) {
        ...
        return num == null ? ImmutableMap.m358of() : new Column(num.intValue());
    }
    ...
    private class Column extends ArrayMap<R, V> {
        ...
        @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.ArrayTable.ArrayMap
        V getValue(int i) {
            return (V) ArrayTable.this.m322at(i, this.columnIndex);
        }
    ...
    public Map<C, V> row(R r) {
        Preconditions.checkNotNull(r);
        Integer num = this.rowKeyToIndex.get(r);
        return num == null ? ImmutableMap.m358of() : new Row(num.intValue());
    }
    ...
    private class Row extends ArrayMap<C, V> {
        ...
        @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.ArrayTable.ArrayMap
        V getValue(int i) {
            return (V) ArrayTable.this.m322at(this.rowIndex, i);
        }
    ...
    Spliterator<V> valuesSpliterator() {
        return CollectSpliterators.indexed(size(), 16, new IntFunction() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.ArrayTable$$ExternalSyntheticLambda1
            @Override // java.util.function.IntFunction
            public final Object apply(int i) {
