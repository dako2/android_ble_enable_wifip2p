...
public abstract class AbstractIterator<T> extends UnmodifiableIterator<T> {
    ...
    /* renamed from: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.AbstractIterator$1 */
    ...
    public final boolean hasNext() {
        ...
        int i = C15771.$SwitchMap$com$google$common$collect$AbstractIterator$State[this.state.ordinal()];
        if (i == 1) {
            return false;
        }
        if (i != 2) {
