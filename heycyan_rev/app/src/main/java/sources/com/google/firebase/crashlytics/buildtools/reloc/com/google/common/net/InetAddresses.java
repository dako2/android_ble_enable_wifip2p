...
import com.google.firebase.crashlytics.buildtools.reloc.com.google.common.p006io.ByteStreams;
...
public final class InetAddresses {
    ...
    private static final Splitter IPV4_SPLITTER = Splitter.m316on(FilenameUtils.EXTENSION_SEPARATOR).limit(4);
    ...
    private static byte[] textToNumericFormatV6(String str) {
        ...
        if (i2 >= 0) {
            ...
            if (strArrSplit[strArrSplit.length - 1].length() == 0 && length2 - 2 != 0) {
                return null;
            }
        } else {
