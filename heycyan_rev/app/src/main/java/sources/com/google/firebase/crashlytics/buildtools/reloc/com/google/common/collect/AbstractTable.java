...
abstract class AbstractTable<R, C, V> implements Table<R, C, V> {
    ...
    Spliterator<V> valuesSpliterator() {
        return CollectSpliterators.map(cellSpliterator(), new Function() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.AbstractTable$$ExternalSyntheticLambda0
