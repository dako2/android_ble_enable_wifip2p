...
public class LogSource {
    ...
    static {
        ...
        try {
            if (Class.forName("java.util.logging.Logger") == null || Class.forName("com.google.firebase.crashlytics.buildtools.reloc.org.apache.commons.logging.impl.Jdk14Logger") == null) {
                z = false;
            }
            jdk14IsAvailable = z;
        ...
        try {
            property = System.getProperty("com.google.firebase.crashlytics.buildtools.reloc.org.apache.commons.logging.log");
            if (property == null) {
