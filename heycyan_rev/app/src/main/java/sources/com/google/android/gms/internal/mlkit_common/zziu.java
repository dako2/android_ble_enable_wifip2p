...
public enum zziu implements zzbh {
    UNKNOWN_EVENT(0),
    ...
    ON_DEVICE_IMAGE_LABEL_DETECT(EMachine.EM_TI_C2000),
    ON_DEVICE_IMAGE_LABEL_CREATE(EMachine.EM_TI_C5500),
    ...
    ON_DEVICE_LANGUAGE_IDENTIFICATION_DETECT(EMachine.EM_CYPRESS_M8C),
    ON_DEVICE_LANGUAGE_IDENTIFICATION_CREATE(EMachine.EM_R32C),
    ON_DEVICE_LANGUAGE_IDENTIFICATION_LOAD(EMachine.EM_HEXAGON),
    ON_DEVICE_LANGUAGE_IDENTIFICATION_CLOSE(EMachine.EM_TRIMEDIA),
    ON_DEVICE_TRANSLATOR_TRANSLATE(EMachine.EM_MANIK),
    ON_DEVICE_TRANSLATOR_CREATE(EMachine.EM_CRAYNV2),
    ON_DEVICE_TRANSLATOR_LOAD(EMachine.EM_RX),
    ON_DEVICE_TRANSLATOR_CLOSE(EMachine.EM_METAG),
    ON_DEVICE_TRANSLATOR_DOWNLOAD(EMachine.EM_MCST_ELBRUS),
    ...
    ON_DEVICE_OBJECT_CREATE(EMachine.EM_TILEGX),
    ON_DEVICE_OBJECT_LOAD(EMachine.EM_CLOUDSHIELD),
    ON_DEVICE_OBJECT_INFERENCE(EMachine.EM_COREA_1ST),
    ON_DEVICE_OBJECT_CLOSE(EMachine.EM_COREA_2ND),
    ...
    CLOUD_LOGO_CLOSE(93),
    CLOUD_SAFE_SEARCH_CREATE(EMachine.EM_EXCESS),
    CLOUD_SAFE_SEARCH_DETECT(EMachine.EM_DXP),
    CLOUD_SAFE_SEARCH_CLOSE(EMachine.EM_ALTERA_NIOS2),
    CLOUD_TEXT_CREATE(121),
    CLOUD_TEXT_DETECT(122),
    CLOUD_TEXT_CLOSE(123),
    CLOUD_WEB_SEARCH_CREATE(EMachine.EM_TSK3000),
    CLOUD_WEB_SEARCH_DETECT(EMachine.EM_RS08),
    CLOUD_WEB_SEARCH_CLOSE(EMachine.EM_SHARC),
    CUSTOM_MODEL_RUN(102),
    CUSTOM_MODEL_CREATE(EMachine.EM_CR),
    CUSTOM_MODEL_CLOSE(104),
    CUSTOM_MODEL_LOAD(105),
    AUTOML_IMAGE_LABELING_RUN(EMachine.EM_K10M),
    AUTOML_IMAGE_LABELING_CREATE(182),
    AUTOML_IMAGE_LABELING_CLOSE(EMachine.EM_AARCH64),
