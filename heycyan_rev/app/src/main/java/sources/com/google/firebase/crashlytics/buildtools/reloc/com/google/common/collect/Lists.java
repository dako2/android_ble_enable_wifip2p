...
public final class Lists {
    ...
    static class TransformingSequentialList<F, T> extends AbstractSequentialList<T> implements Serializable {
        ...
        public boolean removeIf(final Predicate<? super T> predicate) {
            ...
            return this.fromList.removeIf(new Predicate() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Lists$TransformingSequentialList$$ExternalSyntheticLambda0
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
                    return this.f$0.m436x1be9c593(predicate, obj);
                }
            });
        }

        /* renamed from: lambda$removeIf$0$com-google-firebase-crashlytics-buildtools-reloc-com-google-common-collect-Lists$TransformingSequentialList */
        /* synthetic */ boolean m436x1be9c593(Predicate predicate, Object obj) {
    ...
    static class TransformingRandomAccessList<F, T> extends AbstractList<T> implements RandomAccess, Serializable {
        ...
        public boolean removeIf(final Predicate<? super T> predicate) {
            Preconditions.checkNotNull(predicate);
            return this.fromList.removeIf(new Predicate() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Lists$TransformingRandomAccessList$$ExternalSyntheticLambda0
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
                    return this.f$0.m435x3790cb1b(predicate, obj);
                }
            });
        }

        /* renamed from: lambda$removeIf$0$com-google-firebase-crashlytics-buildtools-reloc-com-google-common-collect-Lists$TransformingRandomAccessList */
        /* synthetic */ boolean m435x3790cb1b(Predicate predicate, Object obj) {
            return predicate.test(this.function.apply(obj));
        }
