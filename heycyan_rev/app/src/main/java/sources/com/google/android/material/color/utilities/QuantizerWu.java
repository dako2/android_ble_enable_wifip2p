...
public final class QuantizerWu implements Quantizer {
    ...
    double variance(Box box) {
        ...
        return (((((((this.moments[getIndex(box.f224r1, box.f222g1, box.f220b1)] - this.moments[getIndex(box.f224r1, box.f222g1, box.f219b0)]) - this.moments[getIndex(box.f224r1, box.f221g0, box.f220b1)]) + this.moments[getIndex(box.f224r1, box.f221g0, box.f219b0)]) - this.moments[getIndex(box.f223r0, box.f222g1, box.f220b1)]) + this.moments[getIndex(box.f223r0, box.f222g1, box.f219b0)]) + this.moments[getIndex(box.f223r0, box.f221g0, box.f220b1)]) - this.moments[getIndex(box.f223r0, box.f221g0, box.f219b0)]) - ((((iVolume * iVolume) + (iVolume2 * iVolume2)) + (iVolume3 * iVolume3)) / volume(box, this.weights));
    }
    ...
    Boolean cut(Box box, Box box2) {
        ...
        MaximizeResult maximizeResultMaximize = maximize(box, Direction.RED, box.f223r0 + 1, box.f224r1, iVolume, iVolume2, iVolume3, iVolume4);
        MaximizeResult maximizeResultMaximize2 = maximize(box, Direction.GREEN, box.f221g0 + 1, box.f222g1, iVolume, iVolume2, iVolume3, iVolume4);
        MaximizeResult maximizeResultMaximize3 = maximize(box, Direction.BLUE, box.f219b0 + 1, box.f220b1, iVolume, iVolume2, iVolume3, iVolume4);
        ...
        box2.f224r1 = box.f224r1;
        box2.f222g1 = box.f222g1;
        box2.f220b1 = box.f220b1;
        int i = C12441.f218x8739cebf[direction.ordinal()];
        if (i == 1) {
            box.f224r1 = maximizeResultMaximize.cutLocation;
            box2.f223r0 = box.f224r1;
            box2.f221g0 = box.f221g0;
            box2.f219b0 = box.f219b0;
        } else if (i == 2) {
            box.f222g1 = maximizeResultMaximize2.cutLocation;
            box2.f223r0 = box.f223r0;
            box2.f221g0 = box.f222g1;
            box2.f219b0 = box.f219b0;
        } else if (i == 3) {
            box.f220b1 = maximizeResultMaximize3.cutLocation;
            box2.f223r0 = box.f223r0;
            box2.f221g0 = box.f221g0;
            box2.f219b0 = box.f220b1;
        }
        box.vol = (box.f224r1 - box.f223r0) * (box.f222g1 - box.f221g0) * (box.f220b1 - box.f219b0);
        box2.vol = (box2.f224r1 - box2.f223r0) * (box2.f222g1 - box2.f221g0) * (box2.f220b1 - box2.f219b0);
        return true;
    }
    ...
    static /* synthetic */ class C12441 {
        ...
        static final /* synthetic */ int[] f218x8739cebf;
        ...
        static {
            ...
            try {
                f218x8739cebf[Direction.GREEN.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f218x8739cebf[Direction.BLUE.ordinal()] = 3;
    ...
    static int volume(Box box, int[] iArr) {
        return ((((((iArr[getIndex(box.f224r1, box.f222g1, box.f220b1)] - iArr[getIndex(box.f224r1, box.f222g1, box.f219b0)]) - iArr[getIndex(box.f224r1, box.f221g0, box.f220b1)]) + iArr[getIndex(box.f224r1, box.f221g0, box.f219b0)]) - iArr[getIndex(box.f223r0, box.f222g1, box.f220b1)]) + iArr[getIndex(box.f223r0, box.f222g1, box.f219b0)]) + iArr[getIndex(box.f223r0, box.f221g0, box.f220b1)]) - iArr[getIndex(box.f223r0, box.f221g0, box.f219b0)];
    }

    static int bottom(Box box, Direction direction, int[] iArr) {
        int i;
        int i2;
        int i3 = C12441.f218x8739cebf[direction.ordinal()];
        if (i3 == 1) {
            i = (-iArr[getIndex(box.f223r0, box.f222g1, box.f220b1)]) + iArr[getIndex(box.f223r0, box.f222g1, box.f219b0)] + iArr[getIndex(box.f223r0, box.f221g0, box.f220b1)];
            i2 = iArr[getIndex(box.f223r0, box.f221g0, box.f219b0)];
        } else if (i3 == 2) {
            i = (-iArr[getIndex(box.f224r1, box.f221g0, box.f220b1)]) + iArr[getIndex(box.f224r1, box.f221g0, box.f219b0)] + iArr[getIndex(box.f223r0, box.f221g0, box.f220b1)];
            i2 = iArr[getIndex(box.f223r0, box.f221g0, box.f219b0)];
        } else if (i3 == 3) {
            i = (-iArr[getIndex(box.f224r1, box.f222g1, box.f219b0)]) + iArr[getIndex(box.f224r1, box.f221g0, box.f219b0)] + iArr[getIndex(box.f223r0, box.f222g1, box.f219b0)];
            i2 = iArr[getIndex(box.f223r0, box.f221g0, box.f219b0)];
        } else {
    ...
    static int top(Box box, Direction direction, int i, int[] iArr) {
        int i2;
        int i3;
        int i4 = C12441.f218x8739cebf[direction.ordinal()];
        if (i4 == 1) {
            i2 = (iArr[getIndex(i, box.f222g1, box.f220b1)] - iArr[getIndex(i, box.f222g1, box.f219b0)]) - iArr[getIndex(i, box.f221g0, box.f220b1)];
            i3 = iArr[getIndex(i, box.f221g0, box.f219b0)];
        } else if (i4 == 2) {
            i2 = (iArr[getIndex(box.f224r1, i, box.f220b1)] - iArr[getIndex(box.f224r1, i, box.f219b0)]) - iArr[getIndex(box.f223r0, i, box.f220b1)];
            i3 = iArr[getIndex(box.f223r0, i, box.f219b0)];
        } else if (i4 == 3) {
            i2 = (iArr[getIndex(box.f224r1, box.f222g1, i)] - iArr[getIndex(box.f224r1, box.f221g0, i)]) - iArr[getIndex(box.f223r0, box.f222g1, i)];
            i3 = iArr[getIndex(box.f223r0, box.f221g0, i)];
        } else {
            throw new IllegalArgumentException("unexpected direction " + direction);
        }
        return i2 + i3;
