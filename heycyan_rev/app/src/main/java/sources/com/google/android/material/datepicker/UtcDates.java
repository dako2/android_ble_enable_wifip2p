...
class UtcDates {
    ...
    static String getDefaultTextInputHint(Resources resources, SimpleDateFormat simpleDateFormat) throws Resources.NotFoundException {
        ...
        String string = resources.getString(C1174R.string.mtrl_picker_text_input_year_abbr);
        String string2 = resources.getString(C1174R.string.mtrl_picker_text_input_month_abbr);
        String string3 = resources.getString(C1174R.string.mtrl_picker_text_input_day_abbr);
    ...
    private static String removeYearFromDateFormatPattern(String str) {
        ...
        return str.replace(str.substring(findCharactersInDateFormatPattern(str, str2, -1, iFindCharactersInDateFormatPattern) + 1, iFindCharactersInDateFormatPattern2), HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR).trim();
    }
