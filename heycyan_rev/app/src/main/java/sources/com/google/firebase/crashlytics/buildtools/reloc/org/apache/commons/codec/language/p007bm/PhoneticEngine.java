...
import com.google.firebase.crashlytics.buildtools.reloc.org.apache.commons.codec.language.p007bm.Rule;
...
public class PhoneticEngine {
    ...
    static final class PhonemeBuilder {
        ...
        /* synthetic */ PhonemeBuilder(Set set, C19981 c19981) {
        ...
        public RulesApplication invoke() {
            ...
            if (list != null) {
                ...
                while (true) {
                    ...
                    if (next.patternAndContextMatches(this.input, this.f354i)) {
    ...
    public String encode(String str, Languages.LanguageSet languageSet) {
        ...
        String strTrim = str.toLowerCase(Locale.ENGLISH).replace('-', TokenParser.f390SP).trim();
        if (this.nameType == NameType.GENERIC) {
            ...
            for (String str2 : NAME_PREFIXES.get(this.nameType)) {
                if (strTrim.startsWith(str2 + HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR)) {
        ...
        int i = C19981.$SwitchMap$org$apache$commons$codec$language$bm$NameType[this.nameType.ordinal()];
        if (i == 1) {
        ...
        if (this.concat) {
            strJoin = join(arrayList, HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR);
            ...
            while (it2.hasNext()) {
                sb.append(HelpFormatter.DEFAULT_OPT_PREFIX).append(encode((String) it2.next()));
            }
    ...
    /* renamed from: com.google.firebase.crashlytics.buildtools.reloc.org.apache.commons.codec.language.bm.PhoneticEngine$1 */
