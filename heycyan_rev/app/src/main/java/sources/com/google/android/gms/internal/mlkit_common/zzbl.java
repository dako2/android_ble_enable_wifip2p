...
final class zzbl implements ObjectEncoderContext {
    ...
    zzbl(OutputStream outputStream, Map map, Map map2, ObjectEncoder objectEncoder) {
    ...
    final zzbl zzd(FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (z && i == 0) {
            return this;
        }
    ...
    final zzbl zze(FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (z && j == 0) {
            return this;
        }
        zzbj zzbjVarZzj = zzj(fieldDescriptor);
    ...
    final zzbl zzf(Object obj) throws IOException {
        if (obj == null) {
            return this;
        }
        ObjectEncoder objectEncoder = (ObjectEncoder) this.zzf.get(obj.getClass());
    ...
    public final ObjectEncoderContext nested(String str) throws IOException {
        return nested(FieldDescriptor.m495of(str));
    }
    ...
    public final ObjectEncoderContext add(String str, Object obj) throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
        zzc(FieldDescriptor.m495of(str), obj, true);
        return this;
    }

    @Override // com.google.firebase.encoders.ObjectEncoderContext
    public final ObjectEncoderContext add(String str, boolean z) throws IOException {
        zzd(FieldDescriptor.m495of(str), z ? 1 : 0, true);
        return this;
    }
}
