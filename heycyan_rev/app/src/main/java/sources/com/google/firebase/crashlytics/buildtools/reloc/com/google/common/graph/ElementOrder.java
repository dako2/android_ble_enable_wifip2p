...
public final class ElementOrder<T> {
    ...
    /* renamed from: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.graph.ElementOrder$1 */
    ...
    <K extends T, V> Map<K, V> createMap(int i) {
        int i2 = C18201.$SwitchMap$com$google$common$graph$ElementOrder$Type[this.type.ordinal()];
        if (i2 == 1) {
