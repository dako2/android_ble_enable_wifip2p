...
import com.google.firebase.crashlytics.buildtools.reloc.com.google.common.p006io.CharSource;
import com.google.firebase.crashlytics.buildtools.reloc.com.google.common.p006io.Resources;
...
public final class ClassPath {
    ...
    private static final Splitter CLASS_PATH_ATTRIBUTE_SEPARATOR = Splitter.m319on(HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR).omitEmptyStrings();
    ...
    public static class ResourceInfo {
        ...
        /* renamed from: of */
        static ResourceInfo m483of(String str, ClassLoader classLoader) {
    ...
    static abstract class Scanner {
        ...
        static ImmutableList<URL> parseJavaClassPath() {
            ...
            for (String str : Splitter.m319on(StandardSystemProperty.PATH_SEPARATOR.value()).split(StandardSystemProperty.JAVA_CLASS_PATH.value())) {
                try {
                    try {
    ...
    static final class DefaultScanner extends Scanner {
        ...
        ImmutableSet<ResourceInfo> getResources() {
            ...
            for (Map.Entry<ClassLoader, String> entry : this.resources.entries()) {
                builder.add((ImmutableSet.Builder) ResourceInfo.m483of(entry.getValue(), entry.getKey()));
            }
            return builder.build();
        }
