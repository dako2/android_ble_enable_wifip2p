...
public final class ServiceManager {
    ...
    public ServiceManager(Iterable<? extends Service> iterable) {
        ...
        if (immutableListCopyOf.isEmpty()) {
            ...
            immutableListCopyOf = ImmutableList.m340of(new NoOpService());
        }
    ...
    private static final class ServiceManagerState {
        ...
        void awaitHealthy(long j, TimeUnit timeUnit) throws TimeoutException {
            ...
            try {
                if (!this.monitor.waitForUninterruptibly(this.awaitHealthGuard, j, timeUnit)) {
                    throw new TimeoutException("Timeout waiting for the services to become healthy. The following services have not started: " + Multimaps.filterKeys((SetMultimap) this.servicesByState, Predicates.m312in(ImmutableSet.m384of(Service.State.NEW, Service.State.STARTING))));
                }
                checkHealthy();
            } finally {
                this.monitor.leave();
        ...
        void awaitStopped(long j, TimeUnit timeUnit) throws TimeoutException {
            ...
            try {
                if (this.monitor.waitForUninterruptibly(this.stoppedGuard, j, timeUnit)) {
                    ...
                    throw new TimeoutException("Timeout waiting for the services to stop. The following services have not stopped: " + Multimaps.filterKeys((SetMultimap) this.servicesByState, Predicates.not(Predicates.m312in(EnumSet.of(Service.State.TERMINATED, Service.State.FAILED)))));
                }
            } finally {
                this.monitor.leave();
            }
        ...
        ImmutableMap<Service, Long> startupTimes() {
            ...
            try {
                ...
                this.monitor.leave();
                Collections.sort(arrayListNewArrayListWithCapacity, Ordering.natural().onResultOf(new Function<Map.Entry<Service, Long>, Long>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.util.concurrent.ServiceManager.ServiceManagerState.1
