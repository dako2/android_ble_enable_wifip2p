...
public final class Maps {
    ...
    static class Accumulator<K extends Enum<K>, V> {
        ...
        Accumulator<K, V> combine(Accumulator<K, V> accumulator) {
            ...
            enumMap.forEach(new BiConsumer() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps$Accumulator$$ExternalSyntheticLambda0
        ...
        ImmutableMap<K, V> toImmutableMap() {
            ...
            return enumMap == null ? ImmutableMap.m358of() : ImmutableEnumMap.asImmutable(enumMap);
        }
    }
    ...
    public static <T, K extends Enum<K>, V> Collector<T, ?, ImmutableMap<K, V>> toImmutableEnumMap(final java.util.function.Function<? super T, ? extends K> function, final java.util.function.Function<? super T, ? extends V> function2) {
        ...
        return Collector.of(new Supplier() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps$$ExternalSyntheticLambda1
            @Override // java.util.function.Supplier
            public final Object get() {
                return Maps.lambda$toImmutableEnumMap$1();
            }
        }, new BiConsumer() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps$$ExternalSyntheticLambda2
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
        ...
        }, new Maps$$ExternalSyntheticLambda3(), new Maps$$ExternalSyntheticLambda4(), Collector.Characteristics.UNORDERED);
    }

    static /* synthetic */ Accumulator lambda$toImmutableEnumMap$1() {
        return new Accumulator(new BinaryOperator() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps$$ExternalSyntheticLambda0
    ...
    public static <T, K extends Enum<K>, V> Collector<T, ?, ImmutableMap<K, V>> toImmutableEnumMap(final java.util.function.Function<? super T, ? extends K> function, final java.util.function.Function<? super T, ? extends V> function2, final BinaryOperator<V> binaryOperator) {
        ...
        return Collector.of(new Supplier() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps$$ExternalSyntheticLambda5
            @Override // java.util.function.Supplier
            public final Object get() {
                return Maps.lambda$toImmutableEnumMap$3(binaryOperator);
            }
        }, new BiConsumer() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps$$ExternalSyntheticLambda6
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
                ((Maps.Accumulator) obj).put((Enum) Preconditions.checkNotNull(function.apply(obj2), "Null key for input %s", obj2), Preconditions.checkNotNull(function2.apply(obj2), "Null value for input %s", obj2));
            }
        }, new Maps$$ExternalSyntheticLambda3(), new Maps$$ExternalSyntheticLambda4(), new Collector.Characteristics[0]);
    }
    ...
    static class AsMapView<K, V> extends ViewCachingAbstractMap<K, V> {
        ...
        public void forEach(final BiConsumer<? super K, ? super V> biConsumer) {
            ...
            backingSet().forEach(new Consumer() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps$AsMapView$$ExternalSyntheticLambda0
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    this.f$0.m437x47bfe122(biConsumer, obj);
                }
            });
        }

        /* renamed from: lambda$forEach$0$com-google-firebase-crashlytics-buildtools-reloc-com-google-common-collect-Maps$AsMapView */
        /* synthetic */ void m437x47bfe122(BiConsumer biConsumer, Object obj) {
    ...
    static <K, V> Iterator<Map.Entry<K, V>> asMapEntryIterator(Set<K> set, final Function<? super K, V> function) {
        return new TransformedIterator<K, Map.Entry<K, V>>(set.iterator()) { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps.3
            ...
            /* bridge */ /* synthetic */ Object transform(Object obj) {
                return transform((C16863<K, V>) obj);
            }
    ...
    static final class NavigableAsMapView<K, V> extends AbstractNavigableMap<K, V> {
        ...
        Spliterator<Map.Entry<K, V>> entrySpliterator() {
            return CollectSpliterators.map(this.set.spliterator(), new java.util.function.Function() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps$NavigableAsMapView$$ExternalSyntheticLambda1
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
                    return this.f$0.m439x94386426(obj);
                }
            });
        }

        /* renamed from: lambda$entrySpliterator$0$com-google-firebase-crashlytics-buildtools-reloc-com-google-common-collect-Maps$NavigableAsMapView */
        /* synthetic */ Map.Entry m439x94386426(Object obj) {
            return Maps.immutableEntry(obj, this.function.apply(obj));
        }

        @Override // java.util.Map
        public void forEach(final BiConsumer<? super K, ? super V> biConsumer) {
            this.set.forEach(new Consumer() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps$NavigableAsMapView$$ExternalSyntheticLambda0
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    this.f$0.m440xd73a8fa0(biConsumer, obj);
                }
            });
        }

        /* renamed from: lambda$forEach$1$com-google-firebase-crashlytics-buildtools-reloc-com-google-common-collect-Maps$NavigableAsMapView */
        /* synthetic */ void m440xd73a8fa0(BiConsumer biConsumer, Object obj) {
            biConsumer.accept(obj, this.function.apply(obj));
        }
    ...
    static class TransformedEntriesMap<K, V1, V2> extends IteratorBasedAbstractMap<K, V2> {
        ...
        public void forEach(final BiConsumer<? super K, ? super V2> biConsumer) {
            Preconditions.checkNotNull(biConsumer);
            this.fromMap.forEach(new BiConsumer() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps$TransformedEntriesMap$$ExternalSyntheticLambda0
                @Override // java.util.function.BiConsumer
                public final void accept(Object obj, Object obj2) {
                    this.f$0.m441xf2523d2a(biConsumer, obj, obj2);
                }
            });
        }

        /* renamed from: lambda$forEach$0$com-google-firebase-crashlytics-buildtools-reloc-com-google-common-collect-Maps$TransformedEntriesMap */
        /* synthetic */ void m441xf2523d2a(BiConsumer biConsumer, Object obj, Object obj2) {
    ...
    static final class FilteredEntryBiMap<K, V> extends FilteredEntryMap<K, V> implements BiMap<K, V> {
        ...
        public void replaceAll(final BiFunction<? super K, ? super V, ? extends V> biFunction) {
            unfiltered().replaceAll(new BiFunction() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps$FilteredEntryBiMap$$ExternalSyntheticLambda0
                @Override // java.util.function.BiFunction
                public final Object apply(Object obj, Object obj2) {
                    return this.f$0.m438xb1e922ea(biFunction, obj, obj2);
                }
            });
        }

        /* renamed from: lambda$replaceAll$0$com-google-firebase-crashlytics-buildtools-reloc-com-google-common-collect-Maps$FilteredEntryBiMap */
        /* synthetic */ Object m438xb1e922ea(BiFunction biFunction, Object obj, Object obj2) {
    ...
    static class KeySet<K, V> extends Sets.ImprovedAbstractSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            this.map.forEach(new BiConsumer() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps$KeySet$$ExternalSyntheticLambda0
                @Override // java.util.function.BiConsumer
                public final void accept(Object obj, Object obj2) {
                    consumer.accept(obj);
                }
    ...
    static class Values<K, V> extends AbstractCollection<V> {
        ...
        public void forEach(final Consumer<? super V> consumer) {
            Preconditions.checkNotNull(consumer);
            this.map.forEach(new BiConsumer() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.Maps$Values$$ExternalSyntheticLambda0
                @Override // java.util.function.BiConsumer
                public final void accept(Object obj, Object obj2) {
