...
final class zzfc implements ObjectEncoder {
    ...
    public final /* bridge */ /* synthetic */ void encode(Object obj, ObjectEncoderContext objectEncoderContext) throws IOException {
        ...
        objectEncoderContext2.add(zzb, zzjbVar.zzc());
        objectEncoderContext2.add(zzc, zzjbVar.zzf());
        objectEncoderContext2.add(zzd, zzjbVar.zza());
        objectEncoderContext2.add(zze, zzjbVar.zze());
        objectEncoderContext2.add(zzf, zzjbVar.zzb());
        objectEncoderContext2.add(zzg, zzjbVar.zzd());
