...
public final class MaterialSharedAxis extends MaterialVisibility<VisibilityAnimatorProvider> {
    private static final int DEFAULT_THEMED_DURATION_ATTR = C1174R.attr.motionDurationLong1;
    private static final int DEFAULT_THEMED_EASING_ATTR = C1174R.attr.motionEasingEmphasizedInterpolator;

    /* renamed from: X */
    public static final int f238X = 0;

    /* renamed from: Y */
    public static final int f239Y = 1;

    /* renamed from: Z */
    public static final int f240Z = 2;
