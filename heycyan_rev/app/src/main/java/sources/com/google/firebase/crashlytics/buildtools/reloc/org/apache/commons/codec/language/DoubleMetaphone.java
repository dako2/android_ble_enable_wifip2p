...
public class DoubleMetaphone implements StringEncoder {
    ...
    private static final String[] L_R_N_M_B_H_F_V_W_SPACE = {"L", "R", "N", "M", "B", "H", "F", ExifInterface.GPS_MEASUREMENT_INTERRUPTED, ExifInterface.LONGITUDE_WEST, HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR};
    ...
    private int handleJ(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i, boolean z) {
        ...
        if (i == 0 && !contains(str, i, 4, "JOSE")) {
            ...
            if (isVowel(charAt(str, i2)) && !z) {
                ...
                doubleMetaphoneResult.append('J', TokenParser.f390SP);
