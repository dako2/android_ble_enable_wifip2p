...
public final class InternetDomainName {
    ...
    private static final Splitter DOT_SPLITTER = Splitter.m316on(FilenameUtils.EXTENSION_SEPARATOR);
    private static final Joiner DOT_JOINER = Joiner.m309on(FilenameUtils.EXTENSION_SEPARATOR);

    static {
        CharMatcher charMatcherAnyOf = CharMatcher.anyOf("-_");
        DASH_MATCHER = charMatcherAnyOf;
        PART_CHAR_MATCHER = CharMatcher.javaLetterOrDigit().mo308or(charMatcherAnyOf);
    }
    ...
    InternetDomainName(String str) {
        ...
        this.registrySuffixIndex = findSuffixOfType(Optional.m311of(PublicSuffixType.REGISTRY));
    }
