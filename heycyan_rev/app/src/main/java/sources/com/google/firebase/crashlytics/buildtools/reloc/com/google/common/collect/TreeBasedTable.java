...
public class TreeBasedTable<R, C, V> extends StandardRowSortedTable<R, C, V> {
    ...
    Iterator<C> createColumnKeyIterator() {
        ...
        final UnmodifiableIterator unmodifiableIteratorMergeSorted = Iterators.mergeSorted(Iterables.transform(this.backingMap.values(), new Function<Map<C, V>, Iterator<C>>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.TreeBasedTable.1
