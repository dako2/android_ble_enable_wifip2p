...
public class ImmutableRangeMap<K extends Comparable<?>, V> implements RangeMap<K, V>, Serializable {
    private static final ImmutableRangeMap<Comparable<?>, Object> EMPTY = new ImmutableRangeMap<>(ImmutableList.m339of(), ImmutableList.m339of());
    ...
    /* renamed from: of */
    public static <K extends Comparable<?>, V> ImmutableRangeMap<K, V> m378of() {
        return (ImmutableRangeMap<K, V>) EMPTY;
    }

    /* renamed from: of */
    public static <K extends Comparable<?>, V> ImmutableRangeMap<K, V> m379of(Range<K> range, V v) {
        return new ImmutableRangeMap<>(ImmutableList.m340of(range), ImmutableList.m340of(v));
    }
    ...
    @NullableDecl
    public V get(K k) {
        int iBinarySearch = SortedLists.binarySearch(this.ranges, (com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Function<? super E, Cut>) Range.lowerBoundFn(), Cut.belowValue(k), SortedLists.KeyPresentBehavior.ANY_PRESENT, SortedLists.KeyAbsentBehavior.NEXT_LOWER);
    ...
    public ImmutableRangeMap<K, V> subRangeMap(final Range<K> range) {
        ...
        final int iBinarySearch = SortedLists.binarySearch(this.ranges, (com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Function<? super E, Comparable>) Range.upperBoundFn(), range.lowerBound, SortedLists.KeyPresentBehavior.FIRST_AFTER, SortedLists.KeyAbsentBehavior.NEXT_HIGHER);
        int iBinarySearch2 = SortedLists.binarySearch(this.ranges, (com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.Function<? super E, Comparable>) Range.lowerBoundFn(), range.upperBound, SortedLists.KeyPresentBehavior.ANY_PRESENT, SortedLists.KeyAbsentBehavior.NEXT_HIGHER);
        ...
        return (ImmutableRangeMap<K, V>) new ImmutableRangeMap<K, V>(new ImmutableList<Range<K>>() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.ImmutableRangeMap.1
        ...
        }, this.values.subList(iBinarySearch, iBinarySearch2)) { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.collect.ImmutableRangeMap.2
            ...
            public ImmutableRangeMap<K, V> subRangeMap(Range<K> range2) {
                ...
                return ImmutableRangeMap.m378of();
            }
        };
    }
