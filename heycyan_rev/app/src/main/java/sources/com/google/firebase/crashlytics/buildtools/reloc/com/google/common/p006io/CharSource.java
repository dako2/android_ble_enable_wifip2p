...
public abstract class CharSource {
    ...
    public Stream<String> lines() throws IOException {
        ...
        return (Stream) bufferedReaderOpenBufferedStream.lines().onClose(new Runnable() { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.io.CharSource$$ExternalSyntheticLambda0
    ...
    private static class CharSequenceCharSource extends CharSource {
        ...
        @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.p006io.CharSource
        public Optional<Long> lengthIfKnown() {
            return Optional.m311of(Long.valueOf(this.seq.length()));
        }
    ...
    private static class StringCharSource extends CharSequenceCharSource {
        ...
        @Override // com.google.firebase.crashlytics.buildtools.reloc.com.google.common.io.CharSource.CharSequenceCharSource, com.google.firebase.crashlytics.buildtools.reloc.com.google.common.p006io.CharSource
        public Reader openStream() {
    ...
    private static final class ConcatenatedCharSource extends CharSource {
        ...
        public Optional<Long> lengthIfKnown() {
            ...
            return Optional.m311of(Long.valueOf(jLongValue));
        }
