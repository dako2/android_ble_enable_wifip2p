...
public final class CacheBuilderSpec {
    private static final Splitter KEYS_SPLITTER = Splitter.m316on(',').trimResults();
    private static final Splitter KEY_VALUE_SPLITTER = Splitter.m316on('=').trimResults();
    ...
    CacheBuilder<Object, Object> toCacheBuilder() {
        ...
        if (this.keyStrength != null) {
            if (C15451.$SwitchMap$com$google$common$cache$LocalCache$Strength[this.keyStrength.ordinal()] == 1) {
        ...
        if (this.valueStrength != null) {
            int i = C15451.$SwitchMap$com$google$common$cache$LocalCache$Strength[this.valueStrength.ordinal()];
            if (i == 1) {
    ...
    /* renamed from: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.cache.CacheBuilderSpec$1 */
