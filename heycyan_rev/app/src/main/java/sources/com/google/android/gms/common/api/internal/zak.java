...
public final class zak extends zap {
    ...
    public final void onStart() {
        super.onStart();
        SparseArray sparseArray = this.zad;
        Log.d("AutoManageHelper", "onStart " + this.zaa + HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR + String.valueOf(sparseArray));
    ...
    public final void zad(int i, GoogleApiClient googleApiClient, GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
        ...
        Log.d("AutoManageHelper", "starting AutoManage for client " + i + HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR + this.zaa + HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR + String.valueOf(zamVar));
