...
final class NTLMEngineImpl implements NTLMEngine {
    ...
    /* renamed from: F */
    static int m492F(int i, int i2, int i3) {
        return ((~i) & i3) | (i2 & i);
    }

    /* renamed from: G */
    static int m493G(int i, int i2, int i3) {
        return (i & (i2 | i3)) | (i2 & i3);
    }

    /* renamed from: H */
    static int m494H(int i, int i2, int i3) {
        return (i ^ i2) ^ i3;
    }
    ...
    protected static class CipherGen {
        ...
        public byte[] getTimestamp() {
            if (this.timestamp == null) {
                long j = (this.currentTime + 11644473600000L) * DeviceOrientationRequest.OUTPUT_PERIOD_MEDIUM;
    ...
    static class Handle {
        ...
        public byte[] signAndEncryptMessage(byte[] bArr) throws NoSuchPaddingException, NoSuchAlgorithmException, NTLMEngineException, InvalidKeyException {
    ...
    static class MD4 {
        ...
        /* renamed from: A */
        protected int f375A = 1732584193;

        /* renamed from: B */
        protected int f376B = -271733879;

        /* renamed from: C */
        protected int f377C = -1732584194;

        /* renamed from: D */
        protected int f378D = 271733878;
        ...
        byte[] getOutput() {
            ...
            update(bArr);
            byte[] bArr2 = new byte[16];
            NTLMEngineImpl.writeULong(bArr2, this.f375A, 0);
            NTLMEngineImpl.writeULong(bArr2, this.f376B, 4);
            NTLMEngineImpl.writeULong(bArr2, this.f377C, 8);
            NTLMEngineImpl.writeULong(bArr2, this.f378D, 12);
            return bArr2;
        }
        ...
        protected void round1(int[] iArr) {
            int iRotintlft = NTLMEngineImpl.rotintlft(this.f375A + NTLMEngineImpl.m492F(this.f376B, this.f377C, this.f378D) + iArr[0], 3);
            this.f375A = iRotintlft;
            int iRotintlft2 = NTLMEngineImpl.rotintlft(this.f378D + NTLMEngineImpl.m492F(iRotintlft, this.f376B, this.f377C) + iArr[1], 7);
            this.f378D = iRotintlft2;
            int iRotintlft3 = NTLMEngineImpl.rotintlft(this.f377C + NTLMEngineImpl.m492F(iRotintlft2, this.f375A, this.f376B) + iArr[2], 11);
            this.f377C = iRotintlft3;
            int iRotintlft4 = NTLMEngineImpl.rotintlft(this.f376B + NTLMEngineImpl.m492F(iRotintlft3, this.f378D, this.f375A) + iArr[3], 19);
            this.f376B = iRotintlft4;
            int iRotintlft5 = NTLMEngineImpl.rotintlft(this.f375A + NTLMEngineImpl.m492F(iRotintlft4, this.f377C, this.f378D) + iArr[4], 3);
            this.f375A = iRotintlft5;
            int iRotintlft6 = NTLMEngineImpl.rotintlft(this.f378D + NTLMEngineImpl.m492F(iRotintlft5, this.f376B, this.f377C) + iArr[5], 7);
            this.f378D = iRotintlft6;
            int iRotintlft7 = NTLMEngineImpl.rotintlft(this.f377C + NTLMEngineImpl.m492F(iRotintlft6, this.f375A, this.f376B) + iArr[6], 11);
            this.f377C = iRotintlft7;
            int iRotintlft8 = NTLMEngineImpl.rotintlft(this.f376B + NTLMEngineImpl.m492F(iRotintlft7, this.f378D, this.f375A) + iArr[7], 19);
            this.f376B = iRotintlft8;
            int iRotintlft9 = NTLMEngineImpl.rotintlft(this.f375A + NTLMEngineImpl.m492F(iRotintlft8, this.f377C, this.f378D) + iArr[8], 3);
            this.f375A = iRotintlft9;
            int iRotintlft10 = NTLMEngineImpl.rotintlft(this.f378D + NTLMEngineImpl.m492F(iRotintlft9, this.f376B, this.f377C) + iArr[9], 7);
            this.f378D = iRotintlft10;
            int iRotintlft11 = NTLMEngineImpl.rotintlft(this.f377C + NTLMEngineImpl.m492F(iRotintlft10, this.f375A, this.f376B) + iArr[10], 11);
            this.f377C = iRotintlft11;
            int iRotintlft12 = NTLMEngineImpl.rotintlft(this.f376B + NTLMEngineImpl.m492F(iRotintlft11, this.f378D, this.f375A) + iArr[11], 19);
            this.f376B = iRotintlft12;
            int iRotintlft13 = NTLMEngineImpl.rotintlft(this.f375A + NTLMEngineImpl.m492F(iRotintlft12, this.f377C, this.f378D) + iArr[12], 3);
            this.f375A = iRotintlft13;
            int iRotintlft14 = NTLMEngineImpl.rotintlft(this.f378D + NTLMEngineImpl.m492F(iRotintlft13, this.f376B, this.f377C) + iArr[13], 7);
            this.f378D = iRotintlft14;
            int iRotintlft15 = NTLMEngineImpl.rotintlft(this.f377C + NTLMEngineImpl.m492F(iRotintlft14, this.f375A, this.f376B) + iArr[14], 11);
            this.f377C = iRotintlft15;
            this.f376B = NTLMEngineImpl.rotintlft(this.f376B + NTLMEngineImpl.m492F(iRotintlft15, this.f378D, this.f375A) + iArr[15], 19);
        }

        protected void round2(int[] iArr) {
            int iRotintlft = NTLMEngineImpl.rotintlft(this.f375A + NTLMEngineImpl.m493G(this.f376B, this.f377C, this.f378D) + iArr[0] + 1518500249, 3);
            this.f375A = iRotintlft;
            int iRotintlft2 = NTLMEngineImpl.rotintlft(this.f378D + NTLMEngineImpl.m493G(iRotintlft, this.f376B, this.f377C) + iArr[4] + 1518500249, 5);
            this.f378D = iRotintlft2;
            int iRotintlft3 = NTLMEngineImpl.rotintlft(this.f377C + NTLMEngineImpl.m493G(iRotintlft2, this.f375A, this.f376B) + iArr[8] + 1518500249, 9);
            this.f377C = iRotintlft3;
            int iRotintlft4 = NTLMEngineImpl.rotintlft(this.f376B + NTLMEngineImpl.m493G(iRotintlft3, this.f378D, this.f375A) + iArr[12] + 1518500249, 13);
            this.f376B = iRotintlft4;
            int iRotintlft5 = NTLMEngineImpl.rotintlft(this.f375A + NTLMEngineImpl.m493G(iRotintlft4, this.f377C, this.f378D) + iArr[1] + 1518500249, 3);
            this.f375A = iRotintlft5;
            int iRotintlft6 = NTLMEngineImpl.rotintlft(this.f378D + NTLMEngineImpl.m493G(iRotintlft5, this.f376B, this.f377C) + iArr[5] + 1518500249, 5);
            this.f378D = iRotintlft6;
            int iRotintlft7 = NTLMEngineImpl.rotintlft(this.f377C + NTLMEngineImpl.m493G(iRotintlft6, this.f375A, this.f376B) + iArr[9] + 1518500249, 9);
            this.f377C = iRotintlft7;
            int iRotintlft8 = NTLMEngineImpl.rotintlft(this.f376B + NTLMEngineImpl.m493G(iRotintlft7, this.f378D, this.f375A) + iArr[13] + 1518500249, 13);
            this.f376B = iRotintlft8;
            int iRotintlft9 = NTLMEngineImpl.rotintlft(this.f375A + NTLMEngineImpl.m493G(iRotintlft8, this.f377C, this.f378D) + iArr[2] + 1518500249, 3);
            this.f375A = iRotintlft9;
            int iRotintlft10 = NTLMEngineImpl.rotintlft(this.f378D + NTLMEngineImpl.m493G(iRotintlft9, this.f376B, this.f377C) + iArr[6] + 1518500249, 5);
            this.f378D = iRotintlft10;
            int iRotintlft11 = NTLMEngineImpl.rotintlft(this.f377C + NTLMEngineImpl.m493G(iRotintlft10, this.f375A, this.f376B) + iArr[10] + 1518500249, 9);
            this.f377C = iRotintlft11;
            int iRotintlft12 = NTLMEngineImpl.rotintlft(this.f376B + NTLMEngineImpl.m493G(iRotintlft11, this.f378D, this.f375A) + iArr[14] + 1518500249, 13);
            this.f376B = iRotintlft12;
            int iRotintlft13 = NTLMEngineImpl.rotintlft(this.f375A + NTLMEngineImpl.m493G(iRotintlft12, this.f377C, this.f378D) + iArr[3] + 1518500249, 3);
            this.f375A = iRotintlft13;
            int iRotintlft14 = NTLMEngineImpl.rotintlft(this.f378D + NTLMEngineImpl.m493G(iRotintlft13, this.f376B, this.f377C) + iArr[7] + 1518500249, 5);
            this.f378D = iRotintlft14;
            int iRotintlft15 = NTLMEngineImpl.rotintlft(this.f377C + NTLMEngineImpl.m493G(iRotintlft14, this.f375A, this.f376B) + iArr[11] + 1518500249, 9);
            this.f377C = iRotintlft15;
            this.f376B = NTLMEngineImpl.rotintlft(this.f376B + NTLMEngineImpl.m493G(iRotintlft15, this.f378D, this.f375A) + iArr[15] + 1518500249, 13);
        }

        protected void round3(int[] iArr) {
            int iRotintlft = NTLMEngineImpl.rotintlft(this.f375A + NTLMEngineImpl.m494H(this.f376B, this.f377C, this.f378D) + iArr[0] + 1859775393, 3);
            this.f375A = iRotintlft;
            int iRotintlft2 = NTLMEngineImpl.rotintlft(this.f378D + NTLMEngineImpl.m494H(iRotintlft, this.f376B, this.f377C) + iArr[8] + 1859775393, 9);
            this.f378D = iRotintlft2;
            int iRotintlft3 = NTLMEngineImpl.rotintlft(this.f377C + NTLMEngineImpl.m494H(iRotintlft2, this.f375A, this.f376B) + iArr[4] + 1859775393, 11);
            this.f377C = iRotintlft3;
            int iRotintlft4 = NTLMEngineImpl.rotintlft(this.f376B + NTLMEngineImpl.m494H(iRotintlft3, this.f378D, this.f375A) + iArr[12] + 1859775393, 15);
            this.f376B = iRotintlft4;
            int iRotintlft5 = NTLMEngineImpl.rotintlft(this.f375A + NTLMEngineImpl.m494H(iRotintlft4, this.f377C, this.f378D) + iArr[2] + 1859775393, 3);
            this.f375A = iRotintlft5;
            int iRotintlft6 = NTLMEngineImpl.rotintlft(this.f378D + NTLMEngineImpl.m494H(iRotintlft5, this.f376B, this.f377C) + iArr[10] + 1859775393, 9);
            this.f378D = iRotintlft6;
            int iRotintlft7 = NTLMEngineImpl.rotintlft(this.f377C + NTLMEngineImpl.m494H(iRotintlft6, this.f375A, this.f376B) + iArr[6] + 1859775393, 11);
            this.f377C = iRotintlft7;
            int iRotintlft8 = NTLMEngineImpl.rotintlft(this.f376B + NTLMEngineImpl.m494H(iRotintlft7, this.f378D, this.f375A) + iArr[14] + 1859775393, 15);
            this.f376B = iRotintlft8;
            int iRotintlft9 = NTLMEngineImpl.rotintlft(this.f375A + NTLMEngineImpl.m494H(iRotintlft8, this.f377C, this.f378D) + iArr[1] + 1859775393, 3);
            this.f375A = iRotintlft9;
            int iRotintlft10 = NTLMEngineImpl.rotintlft(this.f378D + NTLMEngineImpl.m494H(iRotintlft9, this.f376B, this.f377C) + iArr[9] + 1859775393, 9);
            this.f378D = iRotintlft10;
            int iRotintlft11 = NTLMEngineImpl.rotintlft(this.f377C + NTLMEngineImpl.m494H(iRotintlft10, this.f375A, this.f376B) + iArr[5] + 1859775393, 11);
            this.f377C = iRotintlft11;
            int iRotintlft12 = NTLMEngineImpl.rotintlft(this.f376B + NTLMEngineImpl.m494H(iRotintlft11, this.f378D, this.f375A) + iArr[13] + 1859775393, 15);
            this.f376B = iRotintlft12;
            int iRotintlft13 = NTLMEngineImpl.rotintlft(this.f375A + NTLMEngineImpl.m494H(iRotintlft12, this.f377C, this.f378D) + iArr[3] + 1859775393, 3);
            this.f375A = iRotintlft13;
            int iRotintlft14 = NTLMEngineImpl.rotintlft(this.f378D + NTLMEngineImpl.m494H(iRotintlft13, this.f376B, this.f377C) + iArr[11] + 1859775393, 9);
            this.f378D = iRotintlft14;
            int iRotintlft15 = NTLMEngineImpl.rotintlft(this.f377C + NTLMEngineImpl.m494H(iRotintlft14, this.f375A, this.f376B) + iArr[7] + 1859775393, 11);
            this.f377C = iRotintlft15;
            this.f376B = NTLMEngineImpl.rotintlft(this.f376B + NTLMEngineImpl.m494H(iRotintlft15, this.f378D, this.f375A) + iArr[15] + 1859775393, 15);
        }
    }
    ...
    static class HMACMD5 {
        ...
        HMACMD5(byte[] bArr) {
            ...
            while (i < 64) {
                this.ipad[i] = Constants.CMD_PRESSURE_SETTING;
                this.opad[i] = 92;
                i++;
            }
            this.md5.reset();
