...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    /* renamed from: is */
    public static CharMatcher m307is(char c) {
        return new C1518Is(c);
    }
    ...
    public static CharMatcher anyOf(CharSequence charSequence) {
        ...
        if (length == 1) {
            return m307is(charSequence.charAt(0));
        }
        if (length == 2) {
    ...
    /* renamed from: or */
    public CharMatcher mo308or(CharMatcher charMatcher) {
        return new C1519Or(this, charMatcher);
    }
    ...
    CharMatcher precomputedInternal() {
        ...
        return new NegatedFastMatcher(precomputedPositive(i, bitSet, string.endsWith(".negate()") ? string.substring(0, string.length() - ".negate()".length()) : string + ".negate()")) { // from class: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.CharMatcher.1
    ...
    private static CharMatcher precomputedPositive(int i, BitSet bitSet, String str) {
        ...
        if (i == 1) {
            return m307is((char) bitSet.nextSetBit(0));
        }
        if (i != 2) {
    ...
    /* renamed from: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.CharMatcher$Or */
    private static final class C1519Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C1519Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
            this.first = (CharMatcher) Preconditions.checkNotNull(charMatcher);
            this.second = (CharMatcher) Preconditions.checkNotNull(charMatcher2);
        }
    ...
    /* renamed from: com.google.firebase.crashlytics.buildtools.reloc.com.google.common.base.CharMatcher$Is */
    private static final class C1518Is extends FastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo308or(CharMatcher charMatcher) {
            return charMatcher.matches(this.match) ? charMatcher : super.mo308or(charMatcher);
        }
