...
public final class ClientIdentity extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getUid", m197id = 1)
    private final int zzb;

    @SafeParcelable.Field(getter = "getPackageName", m197id = 3)
    private final String zzc;

    @SafeParcelable.Field(getter = "getAttributionTag", m197id = 4)
    private final String zzd;

    @SafeParcelable.Field(getter = "getListenerId", m197id = 6)
    private final String zze;

    @SafeParcelable.Field(getter = "getClientFeatures", m197id = 8)
    private final List zzf;

    @SafeParcelable.Field(getter = "getImpersonator", m197id = 7)
    ...
    public ClientIdentity(@SafeParcelable.Param(m198id = 1) int i, @SafeParcelable.Param(m198id = 3) String packageName, @SafeParcelable.Param(m198id = 4) String str, @SafeParcelable.Param(m198id = 6) String str2, @SafeParcelable.Param(m198id = 8) List list, @SafeParcelable.Param(m198id = 7) ClientIdentity clientIdentity) {
