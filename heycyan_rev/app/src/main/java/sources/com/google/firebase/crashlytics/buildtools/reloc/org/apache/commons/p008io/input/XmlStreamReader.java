...
import com.google.firebase.crashlytics.buildtools.reloc.org.apache.commons.p008io.ByteOrderMark;
...
public class XmlStreamReader extends Reader {
    ...
    private static final ByteOrderMark[] XML_GUESS_BYTES = {new ByteOrderMark("UTF-8", 60, 63, EMachine.EM_M32C, 109), new ByteOrderMark("UTF-16BE", 0, 60, 0, 63), new ByteOrderMark("UTF-16LE", 60, 0, 63, 0), new ByteOrderMark(UTF_32BE, 0, 0, 0, 60, 0, 0, 0, 63, 0, 0, 0, EMachine.EM_M32C, 0, 0, 0, 109), new ByteOrderMark(UTF_32LE, 60, 0, 0, 0, 63, 0, 0, 0, EMachine.EM_M32C, 0, 0, 0, 109, 0, 0, 0), new ByteOrderMark(EBCDIC, 76, EMachine.EM_EXCESS, EMachine.EM_NDS32, 148)};
