...
public class RemoteModelFileManager {
    ...
    public synchronized File moveModelToPrivateFolder(ParcelFileDescriptor parcelFileDescriptor, String str, RemoteModel remoteModel) throws MlKitException {
        ...
        try {
                ...
                try {
                    ...
                    if (zZza && (modelValidator = this.zze) != null) {
                        ...
                        if (validationResultValidateModel.getErrorCode().equals(ModelValidator.ValidationResult.ErrorCode.TFLITE_VERSION_INCOMPATIBLE)) {
                            ...
                            gmsLogger.m187d("RemoteModelFileManager", "Model is not compatible. Model hash: ".concat(String.valueOf(str)));
                            gmsLogger.m187d("RemoteModelFileManager", "The current app version is: ".concat(String.valueOf(appVersion)));
                        }
                    }
                    ...
                    if (zZza) {
                        ...
                        zza.m187d("RemoteModelFileManager", "Hash does not match with expected: ".concat(String.valueOf(str)));
                        zzmt.zzb("common").zzf(zzml.zzg(), remoteModel, zzit.MODEL_HASH_MISMATCH, true, this.zzd, zziz.SUCCEEDED);
                        mlKitException = new MlKitException("Hash does not match with expected", 102);
                    }
                    if (file.delete()) {
                        throw mlKitException;
                    }
                    zza.m187d("RemoteModelFileManager", "Failed to delete the temp file: ".concat(String.valueOf(file.getAbsolutePath())));
                    throw mlKitException;
                } finally {
                }
            } catch (Throwable th) {
            ...
            zza.m189e("RemoteModelFileManager", "Failed to copy downloaded model file to private folder: ".concat(e.toString()));
            return null;
        }
