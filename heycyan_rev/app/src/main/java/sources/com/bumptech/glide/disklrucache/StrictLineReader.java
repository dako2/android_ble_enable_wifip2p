...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f102CR = 13;

    /* renamed from: LF */
    private static final byte f103LF = 10;
    private byte[] buf;
    private final Charset charset;
    private int end;

    /* renamed from: in */
    private final InputStream f104in;
    private int pos;
    ...
    */
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f104in;
        byte[] bArr = this.buf;
