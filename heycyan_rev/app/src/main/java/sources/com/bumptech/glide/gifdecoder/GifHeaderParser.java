...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f107ix = readShort();
        this.header.currentFrame.f108iy = readShort();
        this.header.currentFrame.f106iw = readShort();
        this.header.currentFrame.f105ih = readShort();
        int i = read();
        boolean z = (i & 128) != 0;
