...
public final class ExifOrientationStream extends FilterInputStream {
    ...
    static {
        byte[] bArr = {-1, -31, 0, 28, LargeDataHandler.ACTION_DEVICE_HEART_BEAT, Constants.CMD_PHONE_SPORT_N0TIFY, Constants.CMD_START_HEART_RATE, 102, 0, 0, 77, 77, 0, 0, 0, 0, 0, 8, 0, 1, 1, 18, 0, 2, 0, 0, 0, 1, 0};
        EXIF_SEGMENT = bArr;
