...
import com.chad.library.C0758R;
...
public class BaseDraggableModule implements DraggableListenerImp {
    ...
    public final void initView$com_github_CymChad_brvah(BaseViewHolder holder) {
        ...
        if (this.isDragEnabled && hasToggleView() && (viewFindViewById = holder.itemView.findViewById(this.toggleViewId)) != null) {
            viewFindViewById.setTag(C0758R.id.BaseQuickAdapter_viewholder_support, holder);
        ...
        if (z) {
            ...
            this.mOnToggleViewLongClickListener = new View.OnLongClickListener() { // from class: com.chad.library.adapter.base.module.BaseDraggableModule$$ExternalSyntheticLambda0
                ...
                public final boolean onLongClick(View view) {
                    return BaseDraggableModule.m742_set_isDragOnLongPressEnabled_$lambda0(this.f$0, view);
                }
            };
        } else {
            this.mOnToggleViewTouchListener = new View.OnTouchListener() { // from class: com.chad.library.adapter.base.module.BaseDraggableModule$$ExternalSyntheticLambda1
                ...
                public final boolean onTouch(View view, MotionEvent motionEvent) {
                    return BaseDraggableModule.m743_set_isDragOnLongPressEnabled_$lambda1(this.f$0, view, motionEvent);
                }
            };
    ...
    public static final boolean m742_set_isDragOnLongPressEnabled_$lambda0(BaseDraggableModule this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        if (!this$0.isDragEnabled) {
            return true;
        }
        ItemTouchHelper itemTouchHelper = this$0.getItemTouchHelper();
        Object tag = view.getTag(C0758R.id.BaseQuickAdapter_viewholder_support);
        if (tag == null) {
    ...
    public static final boolean m743_set_isDragOnLongPressEnabled_$lambda1(BaseDraggableModule this$0, View view, MotionEvent motionEvent) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
