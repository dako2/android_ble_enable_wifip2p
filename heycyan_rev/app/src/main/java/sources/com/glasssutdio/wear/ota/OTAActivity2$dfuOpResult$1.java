...
@Metadata(m606d1 = {"\u0000\u0019\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0004*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0018\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0005H\u0016J\u0010\u0010\u0007\u001a\u00020\u00032\u0006\u0010\b\u001a\u00020\u0005H\u0016¨\u0006\t"}, m607d2 = {"com/glasssutdio/wear/ota/OTAActivity2$dfuOpResult$1", "Lcom/oudmon/ble/base/communication/DfuHandle$IOpResult;", "onActionResult", "", "type", "", "errCode", "onProgress", "percent", "app_release"}, m608k = 1, m609mv = {1, 9, 0}, m611xi = 48)
/* loaded from: classes.dex */
public final class OTAActivity2$dfuOpResult$1 implements DfuHandle.IOpResult {
    final /* synthetic */ OTAActivity2 this$0;

    OTAActivity2$dfuOpResult$1(OTAActivity2 oTAActivity2) {
        this.this$0 = oTAActivity2;
    }

    @Override // com.oudmon.ble.base.communication.DfuHandle.IOpResult
    public void onActionResult(int type, int errCode) {
        if (errCode != 0) {
            XLog.m137i("------+errCode:" + errCode);
            final OTAActivity2 oTAActivity2 = this.this$0;
            ThreadExtKt.ktxRunOnUi(this, new Function1<OTAActivity2$dfuOpResult$1, Unit>() { // from class: com.glasssutdio.wear.ota.OTAActivity2$dfuOpResult$1$onActionResult$3
                {
                    super(1);
                }

                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ Unit invoke(OTAActivity2$dfuOpResult$1 oTAActivity2$dfuOpResult$1) {
                    invoke2(oTAActivity2$dfuOpResult$1);
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2(OTAActivity2$dfuOpResult$1 ktxRunOnUi) {
                    Intrinsics.checkNotNullParameter(ktxRunOnUi, "$this$ktxRunOnUi");
                    String string = oTAActivity2.getString(C0775R.string.ble_glass_13);
        ...
        final OTAActivity2 oTAActivity22 = this.this$0;
        oTAActivity22.runOnUiThread(new Runnable() { // from class: com.glasssutdio.wear.ota.OTAActivity2$dfuOpResult$1$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                OTAActivity2$dfuOpResult$1.onActionResult$lambda$0(oTAActivity22);
            }
        });
        UserConfig.INSTANCE.getInstance().setFmVersion("");
        Handler handler = this.this$0.handler;
        final OTAActivity2 oTAActivity23 = this.this$0;
        handler.postDelayed(new Runnable() { // from class: com.glasssutdio.wear.ota.OTAActivity2$dfuOpResult$1$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                OTAActivity2$dfuOpResult$1.onActionResult$lambda$1(oTAActivity23);
            }
        }, 1000L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void onActionResult$lambda$0(OTAActivity2 this$0) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void onActionResult$lambda$1(OTAActivity2 this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public void onProgress(final int percent) {
        final OTAActivity2 oTAActivity2 = this.this$0;
        oTAActivity2.runOnUiThread(new Runnable() { // from class: com.glasssutdio.wear.ota.OTAActivity2$dfuOpResult$1$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                OTAActivity2$dfuOpResult$1.onProgress$lambda$2(percent, oTAActivity2);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void onProgress$lambda$2(int i, OTAActivity2 this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
