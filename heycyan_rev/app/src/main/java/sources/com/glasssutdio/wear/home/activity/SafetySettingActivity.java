...
import com.glasssutdio.wear.databinding.ActivitySafetySettingBinding;
...
@Metadata(m606d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0005\u001a\u00020\u0006H\u0002J\u0012\u0010\u0007\u001a\u00020\u00062\b\u0010\b\u001a\u0004\u0018\u00010\tH\u0014R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082.¢\u0006\u0002\n\u0000¨\u0006\n"}, m607d2 = {"Lcom/glasssutdio/wear/home/activity/SafetySettingActivity;", "Lcom/glasssutdio/wear/manager/BaseSettingActivity;", "()V", "binding", "Lcom/glasssutdio/wear/databinding/ActivitySafetySettingBinding;", "initView", "", "onCreate", "savedInstanceState", "Landroid/os/Bundle;", "app_release"}, m608k = 1, m609mv = {1, 9, 0}, m611xi = 48)
/* loaded from: classes.dex */
public final class SafetySettingActivity extends BaseSettingActivity {
    private ActivitySafetySettingBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) throws SecurityException {
        ...
        ActivitySafetySettingBinding activitySafetySettingBindingInflate = ActivitySafetySettingBinding.inflate(getLayoutInflater());
        Intrinsics.checkNotNullExpressionValue(activitySafetySettingBindingInflate, "inflate(...)");
        this.binding = activitySafetySettingBindingInflate;
        if (activitySafetySettingBindingInflate == null) {
            Intrinsics.throwUninitializedPropertyAccessException("binding");
            activitySafetySettingBindingInflate = null;
        }
        setContentView(activitySafetySettingBindingInflate.getRoot());
        initView();
    }

    private final void initView() {
        ActivitySafetySettingBinding activitySafetySettingBinding = this.binding;
        if (activitySafetySettingBinding == null) {
            Intrinsics.throwUninitializedPropertyAccessException("binding");
            activitySafetySettingBinding = null;
        }
        activitySafetySettingBinding.title.tvTitle.setText(getString(C0775R.string.h_glass_239));
        activitySafetySettingBinding.title.appBack.setOnClickListener(new View.OnClickListener() { // from class: com.glasssutdio.wear.home.activity.SafetySettingActivity$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SafetySettingActivity.initView$lambda$2$lambda$0(this.f$0, view);
            }
        });
        activitySafetySettingBinding.clsLogoff.setOnClickListener(new View.OnClickListener() { // from class: com.glasssutdio.wear.home.activity.SafetySettingActivity$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SafetySettingActivity.initView$lambda$2$lambda$1(this.f$0, view);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void initView$lambda$2$lambda$0(SafetySettingActivity this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.finish();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void initView$lambda$2$lambda$1(SafetySettingActivity this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        SafetySettingActivity safetySettingActivity = this$0;
        ArrayList<Pair> arrayList = new ArrayList();
        Intent intent = new Intent(safetySettingActivity, (Class<?>) AccountLogoffActivity.class);
