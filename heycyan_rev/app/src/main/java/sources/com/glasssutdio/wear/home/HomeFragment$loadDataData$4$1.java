...
final class HomeFragment$loadDataData$4$1 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ HomeFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    HomeFragment$loadDataData$4$1(HomeFragment homeFragment) {
        super(1);
    ...
    public final void invoke2(View it) {
        ...
        LargeDataHandler.getInstance().glassesControl(new byte[]{2, 1, 1}, new ILargeDataResponse() { // from class: com.glasssutdio.wear.home.HomeFragment$loadDataData$4$1$$ExternalSyntheticLambda0
            @Override // com.oudmon.ble.base.communication.ILargeDataResponse
            public final void parseData(int i, BaseResponse baseResponse) {
                HomeFragment$loadDataData$4$1.invoke$lambda$0(homeFragment, i, (GlassModelControlResponse) baseResponse);
            }
        });
    }
    ...
    public static final void invoke$lambda$0(HomeFragment this$0, int i, GlassModelControlResponse glassModelControlResponse) {
        ...
        if (glassModelControlResponse.getDataType() == 1 && glassModelControlResponse.getErrorCode() == 0) {
        ...
        String string7 = this$0.getString(C0775R.string.g_fire_27);
