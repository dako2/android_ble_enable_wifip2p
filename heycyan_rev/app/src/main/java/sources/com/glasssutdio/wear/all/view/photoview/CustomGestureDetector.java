...
class CustomGestureDetector {
    ...
    CustomGestureDetector(Context context, OnGestureListener listener) {
        ...
        this.mDetector = new ScaleGestureDetector(context, new ScaleGestureDetector.OnScaleGestureListener() { // from class: com.glasssutdio.wear.all.view.photoview.CustomGestureDetector.1
