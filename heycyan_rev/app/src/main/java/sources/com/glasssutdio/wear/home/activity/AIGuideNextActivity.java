...
import com.glasssutdio.wear.databinding.ActivityAiGuideNextBinding;
...
/* compiled from: AIGuideNextActivity.kt */
@Metadata(m606d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0005\u001a\u00020\u0006H\u0002J\u0012\u0010\u0007\u001a\u00020\u00062\b\u0010\b\u001a\u0004\u0018\u00010\tH\u0014J\b\u0010\n\u001a\u00020\u0006H\u0014R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082.¢\u0006\u0002\n\u0000¨\u0006\u000b"}, m607d2 = {"Lcom/glasssutdio/wear/home/activity/AIGuideNextActivity;", "Lcom/glasssutdio/wear/manager/BaseSettingActivity;", "()V", "binding", "Lcom/glasssutdio/wear/databinding/ActivityAiGuideNextBinding;", "initView", "", "onCreate", "savedInstanceState", "Landroid/os/Bundle;", "onDestroy", "app_release"}, m608k = 1, m609mv = {1, 9, 0}, m611xi = 48)
/* loaded from: classes.dex */
public final class AIGuideNextActivity extends BaseSettingActivity {
    private ActivityAiGuideNextBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) throws SecurityException {
        ...
        ActivityAiGuideNextBinding activityAiGuideNextBindingInflate = ActivityAiGuideNextBinding.inflate(getLayoutInflater());
        Intrinsics.checkNotNullExpressionValue(activityAiGuideNextBindingInflate, "inflate(...)");
        this.binding = activityAiGuideNextBindingInflate;
        if (activityAiGuideNextBindingInflate == null) {
            Intrinsics.throwUninitializedPropertyAccessException("binding");
            activityAiGuideNextBindingInflate = null;
        }
        setContentView(activityAiGuideNextBindingInflate.getRoot());
        initView();
    }

    private final void initView() {
        ActivityAiGuideNextBinding activityAiGuideNextBinding = this.binding;
        if (activityAiGuideNextBinding == null) {
            Intrinsics.throwUninitializedPropertyAccessException("binding");
            activityAiGuideNextBinding = null;
        }
        ImageView ivPlay = activityAiGuideNextBinding.ivPlay;
        Intrinsics.checkNotNullExpressionValue(ivPlay, "ivPlay");
        ViewKt.click$default(ivPlay, 0L, new Function1<View, Unit>() { // from class: com.glasssutdio.wear.home.activity.AIGuideNextActivity$initView$1$1
            {
                super(1);
            }
        ...
        ImageView ivPlay2 = activityAiGuideNextBinding.ivPlay;
        Intrinsics.checkNotNullExpressionValue(ivPlay2, "ivPlay");
        ViewKt.addClickAnimation$default(ivPlay2, activityAiGuideNextBinding.ivPlay, null, null, 6, null);
        switch (WhenMappings.$EnumSwitchMapping$0[CommonUtils.INSTANCE.getCurrentGlassTypeByHw().ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
                activityAiGuideNextBinding.tv4.setText(getString(C0775R.string.h_glass_163_a03));
                activityAiGuideNextBinding.tv5.setText(getString(C0775R.string.h_glass_164_a03));
                break;
            case 5:
            case 6:
            case 7:
            case 8:
                activityAiGuideNextBinding.tv4.setText(getString(C0775R.string.h_glass_163_am01));
                activityAiGuideNextBinding.tv5.setText(getString(C0775R.string.h_glass_164_am01));
                break;
            case 9:
                activityAiGuideNextBinding.tv4.setText(getString(C0775R.string.g_guide_28));
                activityAiGuideNextBinding.tv5.setText(getString(C0775R.string.g_guide_29));
                break;
            case 10:
                activityAiGuideNextBinding.tv4.setText(getString(C0775R.string.h_glass_163_v23));
                activityAiGuideNextBinding.tv5.setText(getString(C0775R.string.h_glass_164_v23));
                break;
        }
        activityAiGuideNextBinding.ivClose.setOnClickListener(new View.OnClickListener() { // from class: com.glasssutdio.wear.home.activity.AIGuideNextActivity$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                AIGuideNextActivity.initView$lambda$2$lambda$0(this.f$0, view);
            }
        });
        activityAiGuideNextBinding.ivSkip.setOnClickListener(new View.OnClickListener() { // from class: com.glasssutdio.wear.home.activity.AIGuideNextActivity$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                AIGuideNextActivity.initView$lambda$2$lambda$1(this.f$0, view);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void initView$lambda$2$lambda$0(AIGuideNextActivity this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        ActivityHelper.INSTANCE.finish(AIGuideActivity.class);
        AIGuideNextActivity aIGuideNextActivity = this$0;
        ArrayList<Pair> arrayList = new ArrayList();
        Intent intent = new Intent(aIGuideNextActivity, (Class<?>) AIHelperActivity.class);
        ...
        aIGuideNextActivity.startActivity(intent);
        this$0.finish();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void initView$lambda$2$lambda$1(AIGuideNextActivity this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        ActivityHelper.INSTANCE.finish(AIGuideActivity.class);
        AIGuideNextActivity aIGuideNextActivity = this$0;
        ArrayList<Pair> arrayList = new ArrayList();
