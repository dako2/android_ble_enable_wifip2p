...
final class RecordSettingActivity$initView$1$3$1 extends Lambda implements Function2<Integer, CommonSelectModel, Unit> {
    final /* synthetic */ List<CommonSelectModel> $durationData;
    final /* synthetic */ ActivityRecordSettingBinding $this_run;
    final /* synthetic */ RecordSettingActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    RecordSettingActivity$initView$1$3$1(RecordSettingActivity recordSettingActivity, List<CommonSelectModel> list, ActivityRecordSettingBinding activityRecordSettingBinding) {
        super(2);
    ...
    public final void invoke(int i, CommonSelectModel model) {
        ...
        this.this$0.durationIndex = i;
        UserConfig.INSTANCE.getInstance().setRecordVideoDuration(this.$durationData.get(i).getValue());
        this.$this_run.tv6.setText(model.getName());
        int value = this.$durationData.get(i).getValue();
        LargeDataHandler.getInstance().glassesControl(new byte[]{2, 2, 0, (byte) ByteUtil.loword(value), (byte) ByteUtil.hiword(value)}, new ILargeDataResponse() { // from class: com.glasssutdio.wear.setting.RecordSettingActivity$initView$1$3$1$$ExternalSyntheticLambda0
            ...
            public final void parseData(int i2, BaseResponse baseResponse) {
                RecordSettingActivity$initView$1$3$1.invoke$lambda$0(i2, (GlassModelControlResponse) baseResponse);
            }
        });
    }
}
