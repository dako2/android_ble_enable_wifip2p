...
final class HomeFragment$loadDataData$4$3 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ Ref.BooleanRef $recordStart;
    final /* synthetic */ HomeFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    HomeFragment$loadDataData$4$3(Ref.BooleanRef booleanRef, HomeFragment homeFragment) {
        super(1);
        this.$recordStart = booleanRef;
    ...
    public final void invoke2(View it) {
        ...
        int i = this.$recordStart.element ? 8 : 12;
        LargeDataHandler largeDataHandler = LargeDataHandler.getInstance();
        byte[] bArr = {2, 1, (byte) i};
        final HomeFragment homeFragment = this.this$0;
        final Ref.BooleanRef booleanRef = this.$recordStart;
        largeDataHandler.glassesControl(bArr, new ILargeDataResponse() { // from class: com.glasssutdio.wear.home.HomeFragment$loadDataData$4$3$$ExternalSyntheticLambda0
            ...
            public final void parseData(int i2, BaseResponse baseResponse) {
                HomeFragment$loadDataData$4$3.invoke$lambda$0(homeFragment, booleanRef, i2, (GlassModelControlResponse) baseResponse);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void invoke$lambda$0(HomeFragment this$0, Ref.BooleanRef recordStart, int i, GlassModelControlResponse glassModelControlResponse) {
        ...
        if (glassModelControlResponse.getDataType() == 1) {
            ...
            if (recordStart.element) {
                String string7 = this$0.getString(C0775R.string.g_fire_30);
                Intrinsics.checkNotNullExpressionValue(string7, "getString(...)");
                GlobalKt.showToast$default(string7, 0, 1, null);
            } else {
                String string8 = this$0.getString(C0775R.string.g_fire_31);
                Intrinsics.checkNotNullExpressionValue(string8, "getString(...)");
                GlobalKt.showToast$default(string8, 0, 1, null);
            }
            recordStart.element = !recordStart.element;
        }
    }
}
