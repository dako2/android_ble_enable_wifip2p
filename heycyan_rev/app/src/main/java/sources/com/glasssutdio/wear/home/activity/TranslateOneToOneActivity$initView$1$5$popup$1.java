...
final class TranslateOneToOneActivity$initView$1$5$popup$1 extends Lambda implements Function2<PopupSelectLanguageBinding, PopupWindow, Unit> {
    final /* synthetic */ ActivityTranslateOneToOneBinding $this_run;
    final /* synthetic */ TranslateOneToOneActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    TranslateOneToOneActivity$initView$1$5$popup$1(TranslateOneToOneActivity translateOneToOneActivity, ActivityTranslateOneToOneBinding activityTranslateOneToOneBinding) {
        super(2);
    ...
    public final void invoke2(final PopupSelectLanguageBinding view, final PopupWindow window) {
        ...
        for (Object obj : languageData) {
            ...
            selectLanguageModel.setChecked(selectLanguageModel.getLanguage() == translateOneToOneActivity.defaultLanguageTop);
            i = i2;
        }
        ...
        selectLanguageAdapter.setOnItemClickListener(new OnItemClickListener() { // from class: com.glasssutdio.wear.home.activity.TranslateOneToOneActivity$initView$1$5$popup$1$$ExternalSyntheticLambda0
            @Override // com.chad.library.adapter.base.listener.OnItemClickListener
            public final void onItemClick(BaseQuickAdapter baseQuickAdapter, View view2, int i3) {
                TranslateOneToOneActivity$initView$1$5$popup$1.invoke$lambda$2(selectLanguageAdapter, activityTranslateOneToOneBinding, translateOneToOneActivity2, window, baseQuickAdapter, view2, i3);
            }
        });
        EditText etSearch = view.etSearch;
        Intrinsics.checkNotNullExpressionValue(etSearch, "etSearch");
        final TranslateOneToOneActivity translateOneToOneActivity3 = this.this$0;
        etSearch.addTextChangedListener(new TextWatcher() { // from class: com.glasssutdio.wear.home.activity.TranslateOneToOneActivity$initView$1$5$popup$1$invoke$$inlined$doAfterTextChanged$1
    ...
    public static final void invoke$lambda$2(SelectLanguageAdapter mAdapter, ActivityTranslateOneToOneBinding this_run, TranslateOneToOneActivity this$0, PopupWindow window, BaseQuickAdapter adapter, View view, int i) {
        ...
        if (languageJson.length() <= 0) {
            ...
            selectLanguageBean.setOneTop(language);
            UserConfig.INSTANCE.getInstance().setLanguageJson(MoshiUtilsKt.toJson(selectLanguageBean));
        } else {
            JsonAdapter jsonAdapterAdapter = MoshiUtils.INSTANCE.getMoshiBuild().adapter(new TypeToken<SelectLanguageBean>() { // from class: com.glasssutdio.wear.home.activity.TranslateOneToOneActivity$initView$1$5$popup$1$invoke$lambda$2$$inlined$fromJson$1
            }.getType());
            ...
            if (selectLanguageBean2 != null) {
                selectLanguageBean2.setOneTop(language);
