...
final class TranslateListenerActivity$initView$1$7$popup$1 extends Lambda implements Function2<PopupSelectLanguageBinding, PopupWindow, Unit> {
    final /* synthetic */ ActivityTranslateListenerBinding $this_run;
    final /* synthetic */ TranslateListenerActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    TranslateListenerActivity$initView$1$7$popup$1(TranslateListenerActivity translateListenerActivity, ActivityTranslateListenerBinding activityTranslateListenerBinding) {
        super(2);
    ...
    public final void invoke2(PopupSelectLanguageBinding view, final PopupWindow window) {
        ...
        selectLanguageAdapter.setList(translateListenerActivity.getLanguageData(false));
        ...
        selectLanguageAdapter.setOnItemClickListener(new OnItemClickListener() { // from class: com.glasssutdio.wear.home.activity.TranslateListenerActivity$initView$1$7$popup$1$$ExternalSyntheticLambda0
            @Override // com.chad.library.adapter.base.listener.OnItemClickListener
            public final void onItemClick(BaseQuickAdapter baseQuickAdapter, View view2, int i) {
                TranslateListenerActivity$initView$1$7$popup$1.invoke$lambda$1(selectLanguageAdapter, activityTranslateListenerBinding, translateListenerActivity2, window, baseQuickAdapter, view2, i);
            }
        });
    }
    ...
    public static final void invoke$lambda$1(SelectLanguageAdapter mAdapter, ActivityTranslateListenerBinding this_run, TranslateListenerActivity this$0, PopupWindow window, BaseQuickAdapter adapter, View view, int i) {
        ...
        UserConfig.INSTANCE.getInstance().setTranslateToDefault(language.getCode());
