...
import com.glasssutdio.wear.ota.OTAViewModel2;
...
/* compiled from: OTAViewModel2.kt */
@Metadata(m606d1 = {"\u0000@\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\n\u0018\u00002\u00020\u0001:\u0001\"B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u001e\u0010\u0016\u001a\u00020\u00172\u0006\u0010\u0018\u001a\u00020\u00192\u0006\u0010\u001a\u001a\u00020\u00192\u0006\u0010\u0010\u001a\u00020\u0011J\u0006\u0010\u001b\u001a\u00020\u0017J\u001e\u0010\u001c\u001a\u00020\u00172\u0006\u0010\u0018\u001a\u00020\u00192\u0006\u0010\u001a\u001a\u00020\u00192\u0006\u0010\u0010\u001a\u00020\u0011J\u0018\u0010\u001d\u001a\u00020\u00172\u0006\u0010\u001e\u001a\u00020\u00192\u0006\u0010\u001f\u001a\u00020\u0019H\u0002J\u0016\u0010 \u001a\u00020\u00172\u0006\u0010!\u001a\u00020\t2\u0006\u0010\u0010\u001a\u00020\u0011R\u0014\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00070\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\b\u001a\b\u0012\u0004\u0012\u00020\t0\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u0017\u0010\n\u001a\b\u0012\u0004\u0012\u00020\u00070\u000b8F¢\u0006\u0006\u001a\u0004\b\f\u0010\rR\u0017\u0010\u000e\u001a\b\u0012\u0004\u0012\u00020\t0\u000b8F¢\u0006\u0006\u001a\u0004\b\u000f\u0010\rR\u001a\u0010\u0010\u001a\u00020\u0011X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0012\u0010\u0013\"\u0004\b\u0014\u0010\u0015¨\u0006#"}, m607d2 = {"Lcom/glasssutdio/wear/ota/OTAViewModel2;", "Landroidx/lifecycle/ViewModel;", "otaRepository", "Lcom/glasssutdio/wear/depository/OTADepository;", "(Lcom/glasssutdio/wear/depository/OTADepository;)V", "_uiState", "Landroidx/lifecycle/MutableLiveData;", "Lcom/glasssutdio/wear/ota/OTAViewModel2$FirmwareUI;", "_updateUiInfo", "Lcom/glasssutdio/wear/api/response/FirmwareOtaResp;", "uiState", "Landroidx/lifecycle/LiveData;", "getUiState", "()Landroidx/lifecycle/LiveData;", "updateUiInfo", "getUpdateUiInfo", "wifiNotBle", "", "getWifiNotBle", "()Z", "setWifiNotBle", "(Z)V", "checkOta", "", "hwName", "", "fmVersion", "checkOtaChina", "checkOtaDown", "downloadOtaBin", "url", "fileName", "saveDeviceDfuInformation", "firmwareOtaResp", "FirmwareUI", "app_release"}, m608k = 1, m609mv = {1, 9, 0}, m611xi = 48)
/* loaded from: classes.dex */
public final class OTAViewModel2 extends ViewModel {
    ...
    public OTAViewModel2(OTADepository otaRepository) {
    ...
    @DebugMetadata(m619c = "com.glasssutdio.wear.ota.OTAViewModel2$checkOta$1", m620f = "OTAViewModel2.kt", m621i = {}, m622l = {39, 42}, m623m = "invokeSuspend", m624n = {}, m625s = {})
    /* renamed from: com.glasssutdio.wear.ota.OTAViewModel2$checkOta$1 */
    static final class C11241 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C11241(String str, String str2, boolean z, Continuation<? super C11241> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return OTAViewModel2.this.new C11241(this.$hwName, this.$fmVersion, this.$wifiNotBle, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            final OTAViewModel2 oTAViewModel2;
            final boolean z;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.label;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                OTADepository oTADepository = OTAViewModel2.this.otaRepository;
                String str = this.$hwName;
                String str2 = this.$fmVersion;
                OTAViewModel2 oTAViewModel22 = OTAViewModel2.this;
                boolean z2 = this.$wifiNotBle;
                this.L$0 = oTAViewModel22;
                this.Z$0 = z2;
                this.label = 1;
                ...
                z = this.Z$0;
                oTAViewModel2 = (OTAViewModel2) this.L$0;
                ResultKt.throwOnFailure(obj);
            }
            FlowCollector flowCollector = new FlowCollector() { // from class: com.glasssutdio.wear.ota.OTAViewModel2$checkOta$1$1$1
                ...
                public final Object emit(NetState<FirmwareOtaResp> netState, Continuation<? super Unit> continuation) {
                    if (netState.getRetCode() == 0) {
                        ...
                        if (firmwareOtaRespIsSuccess != null) {
                            oTAViewModel2.saveDeviceDfuInformation(firmwareOtaRespIsSuccess, z);
                        }
                        MutableLiveData mutableLiveData = oTAViewModel2._updateUiInfo;
                        ...
                        oTAViewModel2.checkOta(UserConfig.INSTANCE.getInstance().getHwVersionWifi(), UserConfig.INSTANCE.getInstance().getFmVersionWifi(), true);
                    } else {
                        oTAViewModel2._uiState.postValue(new OTAViewModel2.FirmwareUI(netState.getRetCode(), 0L, "", false, 8, null));
                    }
                    return Unit.INSTANCE;
                }
            };
    ...
    public final void checkOta(String hwName, String fmVersion, boolean wifiNotBle) {
        ...
        BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, null, null, new C11241(hwName, fmVersion, wifiNotBle, null), 3, null);
    }
    ...
    /* compiled from: OTAViewModel2.kt */
    @Metadata(m606d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, m607d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m608k = 3, m609mv = {1, 9, 0}, m611xi = 48)
    @DebugMetadata(m619c = "com.glasssutdio.wear.ota.OTAViewModel2$checkOtaChina$1", m620f = "OTAViewModel2.kt", m621i = {}, m622l = {EMachine.EM_OPENRISC, EMachine.EM_VIDEOCORE}, m623m = "invokeSuspend", m624n = {}, m625s = {})
    /* renamed from: com.glasssutdio.wear.ota.OTAViewModel2$checkOtaChina$1 */
    static final class C11251 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return OTAViewModel2.this.new C11251(continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                OTADepository oTADepository = OTAViewModel2.this.otaRepository;
                oTAViewModel2 = OTAViewModel2.this;
            ...
            FlowCollector flowCollector = new FlowCollector() { // from class: com.glasssutdio.wear.ota.OTAViewModel2$checkOtaChina$1$1$1
                @Override // kotlinx.coroutines.flow.FlowCollector
                public /* bridge */ /* synthetic */ Object emit(Object obj2, Continuation continuation) {
                    return emit((NetState<FirmwareOtaResp>) obj2, (Continuation<? super Unit>) continuation);
                }
    ...
    public final void checkOtaChina() {
        BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, null, null, new C11251(null), 3, null);
    }
    ...
    private final void downloadOtaBin(String url, final String fileName) {
        ...
        intRef.element = -1;
        AndroidNetworking.download(url, binDirFile.getAbsolutePath(), fileName).setTag((Object) fileName).setPriority(Priority.MEDIUM).build().setDownloadProgressListener(new DownloadProgressListener() { // from class: com.glasssutdio.wear.ota.OTAViewModel2$$ExternalSyntheticLambda0
            @Override // com.androidnetworking.interfaces.DownloadProgressListener
            public final void onProgress(long j, long j2) {
                OTAViewModel2.downloadOtaBin$lambda$0(intRef, this, fileName, j, j2);
            }
        }).startDownload(new DownloadListener() { // from class: com.glasssutdio.wear.ota.OTAViewModel2.downloadOtaBin.2
            @Override // com.androidnetworking.interfaces.DownloadListener
            public void onDownloadComplete() {
                XLog.m137i("download dfu bin success");
                OTAViewModel2.this._uiState.postValue(new FirmwareUI(0, 100L, fileName, true));
    ...
    public static final void downloadOtaBin$lambda$0(Ref.IntRef lastProgress, OTAViewModel2 this$0, String fileName, long j, long j2) {
    ...
    /* compiled from: OTAViewModel2.kt */
    @Metadata(m606d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u001b\b\u0086\b\u0018\u00002\u00020\u0001B-\u0012\b\b\u0002\u0010\u0002\u001a\u00020\u0003\u0012\b\b\u0002\u0010\u0004\u001a\u00020\u0005\u0012\b\b\u0002\u0010\u0006\u001a\u00020\u0007\u0012\b\b\u0002\u0010\b\u001a\u00020\t¢\u0006\u0002\u0010\nJ\t\u0010\u001b\u001a\u00020\u0003HÆ\u0003J\t\u0010\u001c\u001a\u00020\u0005HÆ\u0003J\t\u0010\u001d\u001a\u00020\u0007HÆ\u0003J\t\u0010\u001e\u001a\u00020\tHÆ\u0003J1\u0010\u001f\u001a\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u00052\b\b\u0002\u0010\u0006\u001a\u00020\u00072\b\b\u0002\u0010\b\u001a\u00020\tHÆ\u0001J\u0013\u0010 \u001a\u00020\t2\b\u0010!\u001a\u0004\u0018\u00010\u0001HÖ\u0003J\t\u0010\"\u001a\u00020\u0003HÖ\u0001J\t\u0010#\u001a\u00020\u0007HÖ\u0001R\u001a\u0010\u0006\u001a\u00020\u0007X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u000b\u0010\f\"\u0004\b\r\u0010\u000eR\u001a\u0010\u0004\u001a\u00020\u0005X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u000f\u0010\u0010\"\u0004\b\u0011\u0010\u0012R\u001a\u0010\u0002\u001a\u00020\u0003X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0013\u0010\u0014\"\u0004\b\u0015\u0010\u0016R\u001a\u0010\b\u001a\u00020\tX\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0017\u0010\u0018\"\u0004\b\u0019\u0010\u001a¨\u0006$"}, m607d2 = {"Lcom/glasssutdio/wear/ota/OTAViewModel2$FirmwareUI;", "", "retCode", "", "progressBar", "", "fileName", "", ANConstants.SUCCESS, "", "(IJLjava/lang/String;Z)V", "getFileName", "()Ljava/lang/String;", "setFileName", "(Ljava/lang/String;)V", "getProgressBar", "()J", "setProgressBar", "(J)V", "getRetCode", "()I", "setRetCode", "(I)V", "getSuccess", "()Z", "setSuccess", "(Z)V", "component1", "component2", "component3", "component4", "copy", "equals", "other", "hashCode", "toString", "app_release"}, m608k = 1, m609mv = {1, 9, 0}, m611xi = 48)
