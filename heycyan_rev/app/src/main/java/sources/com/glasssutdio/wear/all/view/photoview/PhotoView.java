...
public class PhotoView extends AppCompatImageView {
    ...
    public void loadImageWithGlide(String url) {
        Glide.with(this).load(url).listener(new RequestListener<Drawable>() { // from class: com.glasssutdio.wear.all.view.photoview.PhotoView.1
            ...
            public boolean onResourceReady(Drawable resource, Object model, Target<Drawable> target, DataSource dataSource, boolean isFirstResource) {
                if (PhotoView.this.attacher == null) {
                    return false;
                }
                PhotoView.this.attacher.update();
                return false;
            }
        }).into(this);
    }
