...
public class BleMusicHandle {
    ...
    private SerialListener serialListener = new SerialListener() { // from class: com.oudmon.ble.base.bluetooth.spp.jieli.BleMusicHandle.1
        ...
        @Override // com.oudmon.ble.base.bluetooth.spp.SerialListener
        public void onSerialRead(byte[] bArr) throws NumberFormatException {
            if (bArr != null) {
                ...
                if ((b & 255) == 188 && bArr[1] == 50) {
                    if (BleMusicHandle.this.readNextBigPocket()) {
                        ...
                        XLog.m137i("向手环发送数据进度: " + f + ", 包序: " + ((int) BleMusicHandle.this.mPocketIndex) + "总包:" + BleMusicHandle.this.totalSize);
                        BleMusicHandle.this.mCallback.onProgress(Math.min(f, 100.0f));
                        return;
                    }
                    XLog.m137i("向手环发送数据完毕, 包序: " + ((int) BleMusicHandle.this.mPocketIndex));
            ...
            if (bArr != null) {
                ...
                if ((b & 255) != 188 || bArr[1] != Byte.MIN_VALUE) {
                    if (BleMusicHandle.this.mReceiving) {
                        ...
                        XLog.m137i("文件：->3 mTotalCount: " + BleMusicHandle.this.mTotalCount + ", mReceivedCount: " + BleMusicHandle.this.mReceivedCount + ", mReceiving: " + BleMusicHandle.this.mReceiving);
                        if (BleMusicHandle.this.mReceiving) {
                            return;
                        }
                        XLog.m137i("文件：->4 ->" + DataTransferUtils.getHexString(BleMusicHandle.this.mReceivedData));
                ...
                XLog.m137i("文件：-> 1mTotalCount: " + BleMusicHandle.this.mTotalCount + ", mReceivedCount: " + BleMusicHandle.this.mReceivedCount + ", mReceiving: " + BleMusicHandle.this.mReceiving);
                if (BleMusicHandle.this.mReceiving) {
                    return;
                }
                XLog.m137i("文件：->2->" + DataTransferUtils.getHexString(BleMusicHandle.this.mReceivedData));
