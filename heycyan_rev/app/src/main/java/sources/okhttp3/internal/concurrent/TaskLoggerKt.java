...
public final class TaskLoggerKt {
    ...
    public static final void log(Task task, TaskQueue taskQueue, String str) {
        ...
        StringBuilder sbAppend = new StringBuilder().append(taskQueue.getName()).append(TokenParser.f390SP);
    ...
    public static final String formatDuration(long j) {
        ...
        if (j <= -999500000) {
            ...
            str = j <= 0 ? ((j - HttpStatus.SC_INTERNAL_SERVER_ERROR) / 1000) + " µs" : j < ((long) 999500) ? ((j + HttpStatus.SC_INTERNAL_SERVER_ERROR) / 1000) + " µs" : j < ((long) 999500000) ? ((j + 500000) / DurationKt.NANOS_IN_MILLIS) + " ms" : ((j + 500000000) / Http2Connection.DEGRADED_PONG_TIMEOUT_NS) + " s ";
        }
        StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
