...
public final class Response implements Closeable {
    ...
    public final CacheControl m2592deprecated_cacheControl() {
        return cacheControl();
    }
