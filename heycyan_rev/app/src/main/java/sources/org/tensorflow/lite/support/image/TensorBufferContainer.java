...
final class TensorBufferContainer implements ImageContainer {
    ...
    static TensorBufferContainer create(TensorBuffer tensorBuffer, ColorSpaceType colorSpaceType) {
    ...
    static TensorBufferContainer create(TensorBuffer tensorBuffer, ImageProperties imageProperties) {
