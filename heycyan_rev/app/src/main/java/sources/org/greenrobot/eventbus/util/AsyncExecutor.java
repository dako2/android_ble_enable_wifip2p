    ...
    public void execute(final RunnableEx runnableEx) {
        this.threadPool.execute(new Runnable() { // from class: org.greenrobot.eventbus.util.AsyncExecutor$$ExternalSyntheticLambda0
            ...
            public final void run() throws IllegalAccessException, InstantiationException, IllegalArgumentException, InvocationTargetException {
                this.f$0.m2633lambda$execute$0$orggreenroboteventbusutilAsyncExecutor(runnableEx);
            }
        });
    }

    /* renamed from: lambda$execute$0$org-greenrobot-eventbus-util-AsyncExecutor, reason: not valid java name */
    /* synthetic */ void m2633lambda$execute$0$orggreenroboteventbusutilAsyncExecutor(RunnableEx runnableEx) throws IllegalAccessException, InstantiationException, IllegalArgumentException, InvocationTargetException {
        try {
            runnableEx.run();
        } catch (Exception e) {
            try {
