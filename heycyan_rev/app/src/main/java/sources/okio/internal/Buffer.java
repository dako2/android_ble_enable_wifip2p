...
public final class Buffer {
    ...
    */
    ...
    public static final okio.Buffer commonWriteDecimalLong(okio.Buffer buffer, long j) {
        ...
        if (z) {
            bArr[i2 - 1] = Constants.CMD_BlackList_LOCATION;
        }
    ...
    */
        ...
        while (i < i2) {
            ...
            if (cCharAt2 < 128) {
                ...
                if (cCharAt2 < 2048) {
                    ...
                    segmentWritableSegment$okio2.data[segmentWritableSegment$okio2.limit] = (byte) ((cCharAt2 >> 6) | EMachine.EM_CLOUDSHIELD);
    ...
    public static final okio.Buffer commonWriteUtf8CodePoint(okio.Buffer buffer, int i) {
        ...
        if (i < 128) {
            ...
            segmentWritableSegment$okio.data[segmentWritableSegment$okio.limit] = (byte) ((i >> 6) | EMachine.EM_CLOUDSHIELD);
