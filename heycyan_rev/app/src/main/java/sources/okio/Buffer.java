...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public final byte m2609deprecated_getByte(long index) {
    ...
    */
    ...
    public Buffer writeUtf8CodePoint(int codePoint) {
        if (codePoint < 128) {
            ...
            segmentWritableSegment$okio.data[segmentWritableSegment$okio.limit] = (byte) ((codePoint >> 6) | EMachine.EM_CLOUDSHIELD);
