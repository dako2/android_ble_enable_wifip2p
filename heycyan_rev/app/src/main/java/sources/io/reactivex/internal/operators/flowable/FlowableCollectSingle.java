...
public final class FlowableCollectSingle<T, U> extends Single<U> implements FuseToFlowable<U> {
    ...
    static final class CollectSubscriber<T, U> implements Subscriber<T>, Disposable {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f607s, subscription)) {
                this.f607s = subscription;
        ...
        public void onNext(T t) {
            ...
            try {
                this.collector.accept(this.f608u, t);
            } catch (Throwable th) {
        ...
        public void onError(Throwable th) {
            ...
            this.done = true;
            this.f607s = SubscriptionHelper.CANCELLED;
        ...
        public void onComplete() {
            ...
            this.done = true;
            this.f607s = SubscriptionHelper.CANCELLED;
            this.actual.onSuccess(this.f608u);
        }
        ...
        public boolean isDisposed() {
            return this.f607s == SubscriptionHelper.CANCELLED;
        }
    }
}
