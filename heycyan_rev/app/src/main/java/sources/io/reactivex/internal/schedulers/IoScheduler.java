...
public final class IoScheduler extends Scheduler {
    ...
    static final class CachedWorkerPool implements Runnable {
        ...
        ThreadWorker get() {
            ...
            ThreadWorker threadWorker = new ThreadWorker(IoScheduler.WORKER_THREAD_FACTORY);
    ...
    public void start() {
        ...
        if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m47m(this.pool, NONE, cachedWorkerPool)) {
            return;
        }
        cachedWorkerPool.shutdown();
    }
    ...
    public void shutdown() {
        ...
        } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m47m(this.pool, cachedWorkerPool, cachedWorkerPool2));
        cachedWorkerPool.shutdown();
    }
