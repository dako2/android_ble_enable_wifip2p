...
public final class ObservableWindowBoundarySupplier<T, B> extends AbstractObservableWithUpstream<T, Observable<T>> {
    ...
    static final class WindowBoundaryMainObserver<T, B> extends QueueDrainObserver<T, Object, Observable<T>> implements Disposable {
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f839s, disposable)) {
                this.f839s = disposable;
                ...
                try {
                    ...
                    if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m47m(this.boundary, null, windowBoundaryInnerObserver)) {
                    ...
                    if (objPoll == NEXT) {
                        ...
                        if (this.cancelled) {
                            ...
                            try {
                                ...
                                if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m47m(atomicReference, atomicReference.get(), windowBoundaryInnerObserver)) {
                                    observableSource.subscribe(windowBoundaryInnerObserver);
                                }
