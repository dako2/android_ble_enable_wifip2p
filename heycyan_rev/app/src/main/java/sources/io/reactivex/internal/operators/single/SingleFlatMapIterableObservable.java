...
public final class SingleFlatMapIterableObservable<T, R> extends Observable<R> {
    ...
    static final class FlatMapIterableObserver<T, R> extends BasicIntQueueDisposable<R> implements SingleObserver<T> {
        ...
        /* renamed from: it */
        volatile Iterator<? extends R> f854it;
        final Function<? super T, ? extends Iterable<? extends R>> mapper;
        boolean outputFused;
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f853d, disposable)) {
                this.f853d = disposable;
        ...
        public void onError(Throwable th) {
            this.f853d = DisposableHelper.DISPOSED;
        ...
        public boolean isEmpty() {
            return this.f854it == null;
        }

        @Override // io.reactivex.internal.fuseable.SimpleQueue
        public R poll() throws Exception {
            Iterator<? extends R> it = this.f854it;
            if (it == null) {
                return null;
            }
