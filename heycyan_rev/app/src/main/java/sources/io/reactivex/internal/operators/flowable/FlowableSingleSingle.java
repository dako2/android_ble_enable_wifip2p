...
public final class FlowableSingleSingle<T> extends Single<T> implements FuseToFlowable<T> {
    ...
    static final class SingleElementSubscriber<T> implements Subscriber<T>, Disposable {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f664s, subscription)) {
                this.f664s = subscription;
        ...
        public void onNext(T t) {
            ...
            if (this.value != null) {
                this.done = true;
                this.f664s.cancel();
                this.f664s = SubscriptionHelper.CANCELLED;
        ...
        public boolean isDisposed() {
            return this.f664s == SubscriptionHelper.CANCELLED;
        }
    }
}
