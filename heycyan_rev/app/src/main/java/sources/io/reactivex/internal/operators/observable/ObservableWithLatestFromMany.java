...
public final class ObservableWithLatestFromMany<T, R> extends AbstractObservableWithUpstream<T, R> {
    ...
    static final class WithLatestFromObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        /* renamed from: d */
        final AtomicReference<Disposable> f845d;
        ...
        void subscribe(ObservableSource<?>[] observableSourceArr, int i) {
            ...
            AtomicReference<Disposable> atomicReference = this.f845d;
        ...
        public void onSubscribe(Disposable disposable) {
            DisposableHelper.setOnce(this.f845d, disposable);
        }
        ...
        public boolean isDisposed() {
            return DisposableHelper.isDisposed(this.f845d.get());
        }

        @Override // io.reactivex.disposables.Disposable
        public void dispose() {
            DisposableHelper.dispose(this.f845d);
