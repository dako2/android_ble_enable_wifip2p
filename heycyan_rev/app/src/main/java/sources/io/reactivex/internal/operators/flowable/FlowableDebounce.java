...
public final class FlowableDebounce<T, U> extends AbstractFlowableWithUpstream<T, T> {
    ...
    static final class DebounceSubscriber<T, U> extends AtomicLong implements Subscriber<T>, Subscription {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f613s, subscription)) {
                this.f613s = subscription;
        ...
        public void onNext(T t) {
            ...
            try {
                ...
                if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m47m(this.debouncer, disposable, debounceInnerSubscriber)) {
