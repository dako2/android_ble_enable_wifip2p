...
public class TestSubscriber<T> extends BaseTestConsumer<T, TestSubscriber<T>> implements Subscriber<T>, Subscription, Disposable {
    ...
    /* renamed from: qs */
    private QueueSubscription<T> f910qs;
    ...
    public void onSubscribe(Subscription subscription) {
        ...
        if (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m47m(this.subscription, null, subscription)) {
            subscription.cancel();
