...
public final class ObservablePublish<T> extends ConnectableObservable<T> implements HasUpstreamObservableSource<T> {
            ...
            public void subscribe(Observer<? super T> observer) {
                ...
                while (true) {
                    ...
                    if (publishObserver == null || publishObserver.isDisposed()) {
                        ...
                        if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m47m(atomicReference, publishObserver, publishObserver2)) {
    ...
    public void connect(Consumer<? super Disposable> consumer) {
        ...
        while (true) {
            ...
            if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m47m(this.current, publishObserver, publishObserver2)) {
                publishObserver = publishObserver2;
                break;
            }
        }
    ...
    static final class PublishObserver<T> implements Observer<T>, Disposable {
        ...
        /* renamed from: s */
        final AtomicReference<Disposable> f791s = new AtomicReference<>();
        ...
        public void dispose() {
            ...
            DisposableHelper.dispose(this.f791s);
        }
        ...
        public void onSubscribe(Disposable disposable) {
            DisposableHelper.setOnce(this.f791s, disposable);
        }
