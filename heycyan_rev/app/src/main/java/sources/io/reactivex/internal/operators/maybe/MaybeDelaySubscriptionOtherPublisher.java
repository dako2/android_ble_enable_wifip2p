...
public final class MaybeDelaySubscriptionOtherPublisher<T, U> extends AbstractMaybeWithUpstream<T, T> {
    ...
    static final class OtherSubscriber<T> implements Subscriber<Object>, Disposable {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f708s, subscription)) {
                this.f708s = subscription;
        ...
        public void onNext(Object obj) {
            if (this.f708s != SubscriptionHelper.CANCELLED) {
                this.f708s.cancel();
                this.f708s = SubscriptionHelper.CANCELLED;
                subscribeNext();
            }
        }
