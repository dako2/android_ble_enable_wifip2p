...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    public final <R> Single<R> reduce(R r, BiFunction<R, ? super T, R> biFunction) {
        return RxJavaPlugins.onAssembly(new ObservableSingleSingle(scan(r, biFunction).takeLast(1), null));
    }

    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> Single<R> reduceWith(Callable<R> callable, BiFunction<R, ? super T, R> biFunction) {
        return RxJavaPlugins.onAssembly(new ObservableSingleSingle(scanWith(callable, biFunction).takeLast(1), null));
    }
    ...
    public final Observable<T> repeatWhen(Function<? super Observable<Object>, ? extends ObservableSource<?>> function) {
        ...
        return RxJavaPlugins.onAssembly(new ObservableRedo(this, ObservableInternalHelper.repeatWhenHandler(function)));
    }
    ...
    public final Observable<T> retryWhen(Function<? super Observable<Throwable>, ? extends ObservableSource<?>> function) {
        ObjectHelper.requireNonNull(function, "handler is null");
        return RxJavaPlugins.onAssembly(new ObservableRedo(this, ObservableInternalHelper.retryWhenHandler(function)));
    }
    ...
    public final Observable<T> sample(long j, TimeUnit timeUnit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new ObservableSampleTimed(this, j, timeUnit, scheduler));
    }
    ...
    public final <U> Observable<T> sample(ObservableSource<U> observableSource) {
        ...
        return RxJavaPlugins.onAssembly(new ObservableSampleWithObservable(this, observableSource));
    }
    ...
    @SchedulerSupport(SchedulerSupport.NONE)
    /* renamed from: to */
    public final <R> R m602to(Function<? super Observable<T>, R> function) {
        try {
    ...
    public final Flowable<T> toFlowable(BackpressureStrategy backpressureStrategy) {
        ...
        int i = C24441.$SwitchMap$io$reactivex$BackpressureStrategy[backpressureStrategy.ordinal()];
        if (i == 1) {
